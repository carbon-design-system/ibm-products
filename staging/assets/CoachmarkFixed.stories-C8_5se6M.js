import{p as N,j as e}from"./settings-DEdZ0TrD.js";import{c as j}from"./floating-ui.core.mjs-LzsX8FoD.js";import{L as E}from"./Link-Dcx-j9tl.js";import{g as z}from"./story-helper-CtkteSRf.js";import{useMDXComponents as _}from"./index-DlpNa54Y.js";import"./chunk-HLWAVYOI-ppvdP2zW.js";import{e as Y,i as G,C as J}from"./index-DUEQWFC3.js";import{R as Q,r as o}from"./index-BwDkhjyp.js";import{a as Z,b as ee,C as te,c as oe,d as O}from"./CoachmarkOverlayElements-aabMPK1J.js";import{C as ne}from"./CoachmarkTagline-BlAx27bF.js";import{P as l}from"./index-Dk74W0Oi.js";import{r as ae}from"./index-BONylQH5.js";import{g as re}from"./devtools-BMJcATO0.js";import{u as se}from"./use-reduced-motion-BisnjenD.js";import{u as ie}from"./useIsomorphicEffect-D7JMtAof.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-BwXSUnsA.js";import"./index-CtP8jiW9.js";import"./tslib.es6-B4_xh3D5.js";import"./iframe-CsPi-Tl1.js";import"../sb-preview/runtime.js";import"./react-18-Dd3bHtks.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./uuidv4-BQrI85uz.js";import"./bucket-5-CnrlLpeo.js";import"./lodash-C6Eq4oiK.js";import"./SteppedAnimatedMedia-a8KJ2nZi.js";import"./lottie-D0UQuq7-.js";import"./clamp-Bg2yowlN.js";import"./toNumber-DVQITUtX.js";import"./Carousel-ivRYnOkT.js";import"./bucket-8-C1BVEtfd.js";const P=`${N.prefix}--coachmark`,L=`${P}-fixed`,T=`${P}-overlay`,g="CoachmarkFixed",f={onClose:()=>{},theme:"light",tagline:""};let i=Q.forwardRef(({children:n,className:t,onClose:x=f.onClose,portalTarget:h,tagline:q=f.tagline,theme:b=f.theme,...A},M)=>{const V=o.useRef(null),a=o.useRef(null),[c,m]=o.useState(!1),[y,k]=o.useState(!1),[W,$]=o.useState(),[H,X]=o.useState({x:0,y:0}),[p,C]=o.useState(!1),v=se();ie(()=>{a.current=h?(document==null?void 0:document.querySelector(h))??(document==null?void 0:document.querySelector("body")):document==null?void 0:document.querySelector("body")},[h]);const d=o.useCallback(()=>{v?m(!1):C(!1)},[v]),U=r=>{r.propertyName==="transform"&&!p&&(m(!1),x())},w=r=>{$(r.target.getBoundingClientRect()),X({x:r.target.offsetLeft,y:r.target.offsetTop}),m(!1),k(!0)},u=o.useCallback(r=>{r.key==="Escape"&&d()},[d]);o.useEffect(()=>(document.addEventListener("keydown",u,!1),()=>{document.removeEventListener("keydown",u,!1)}),[u]);const K={buttonProps:{"aria-expanded":c,tabIndex:0,onClick:w,onDoubleClick:w},closeButtonProps:{onClick:d},targetRect:W,targetOffset:H,isOpen:c,tacos:"tacos"};return o.useEffect(()=>{y&&(k(!1),m(!0))},[y]),o.useEffect(()=>{C(c)},[c]),o.useEffect(()=>()=>m(!1),[]),e.jsx(Z.Provider,{value:K,children:e.jsxs("div",{...A,className:j(L,`${L}__${b}`,t),ref:M,...re(g),children:[e.jsx(ne,{title:q,onClose:x}),c&&(a==null?void 0:a.current)&&ae.createPortal(e.jsx(ee,{ref:V,fixedIsVisible:p,kind:te.FIXED,onClose:d,onTransitionEnd:U,theme:b,className:j(p&&`${T}--is-visible`,T),children:n}),a==null?void 0:a.current)]})})});i=N.checkComponentEnabled(i,g);i.displayName=g;i.propTypes={children:l.node.isRequired,className:l.string,onClose:l.func,portalTarget:l.string,tagline:l.string.isRequired,theme:l.oneOf(["light","dark"])};i.__docgenInfo={description:`Fixed coachmarks are used to call out specific functionality or concepts
...
element is hidden or component is unmounted, the Coachmark will disappear.`,type:{name:"string"},required:!1}}};function F(n){const t={a:"a",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",..._(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"coachmarkfixed",children:"CoachmarkFixed"}),`
