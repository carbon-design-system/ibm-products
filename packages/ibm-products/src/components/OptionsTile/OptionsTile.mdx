  ...
  additionalActions={[
      {
        ...
        onClick: () => stackblitzPrefillConfig(stories.optionsTile, stories.optionsTile.args),
      },
    ]}>
</Canvas>
...
<Canvas
  ...
  additionalActions={[
      {
        title: 'Open in Stackblitz',
        onClick: () => stackblitzPrefillConfig(stories.staticOptionsTile, stories.staticOptionsTile.args),
      },
    ]}>
</Canvas>
