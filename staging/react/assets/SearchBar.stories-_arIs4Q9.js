import{j as e,aB as i,aS as g,aC as j,e as x}from"./iframe-BM8UuOT_.js";import{useMDXComponents as S}from"./index-pemEQtZ4.js";import{S as d}from"./SearchBar-BWDFN3AW.js";import"./MultiSelect-B6haW9Ug.js";import"./index-DlLSDJCX.js";import"./inheritsLoose-DHKJTbHM.js";import"./FormContext-BxAlDPBq.js";import"./mergeRefs-BZpmU3mx.js";import"./Checkbox-taXQVqsi.js";import"./Text-Bp2pW92U.js";import"./index-B2-UkdcH.js";import"./bucket-18-BWfaT1BD.js";import"./utils-DEU5vRWz.js";import"./bucket-19-C2Jy_3fG.js";import"./defaultItemToString-zSItMTD_.js";import"./Search-DvUYMInW.js";import"./bucket-15-CI4BnjUX.js";import"./devtools-fbh1mIbq.js";function u(r){const s={a:"a",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...S(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h1,{id:"searchbar",children:"SearchBar"}),`
...
`,e.jsx(j,{})]})}function f(r={}){const{wrapper:s}={...S(),...r.components};return s?e.jsx(s,{...r,children:e.jsx(u,{...r})}):u(r)}const C="",{action:h}=__STORYBOOK_MODULE_ACTIONS__,R={title:"Preview Candidate/SearchBar",component:d,tags:["autodocs"],argTypes:{value:{control:{disable:!0}},onChange:{control:{disable:!0}},className:{control:{disable:!0}},hideScopesLabel:{control:{disable:!0}},onSubmit:{control:{disable:!0}},scopeToString:{control:{disable:!0}},scopes:{control:{disable:!0}},scopesTypeLabel:{control:{disable:!0}},selectedScopes:{control:{disable:!0}},sortItems:{control:{disable:!0}},titleText:{control:{disable:!0}},translateWithId:{control:{disable:!0}}},parameters:{styles:C,docs:{page:f}}},p=[{id:"scope-2",text:"Scope 2"},{id:"scope-1",text:"Scope 1"},{id:"scope-3",text:"Scope 3"}],l={clearButtonLabelText:"Clear",placeholderText:"Search...",submitLabel:"Search",labelText:"Label text",onChange:r=>h("onChange")(r),onSubmit:r=>h("onSubmit")(r)},m=({...r})=>x.createElement(d,{...r}),b=({...r})=>x.createElement(d,{...r}),o=m.bind({});o.args={...l};const t=m.bind({});t.args={...l,value:"Initial value"};const a=b.bind({});a.args={...l,scopes:p,scopesTypeLabel:"Scopes",scopeToString:r=>r?r.text:""};const n=b.bind({});n.args={...l,scopes:p,scopesTypeLabel:"Scopes",sortItems:r=>r,scopeToString:r=>r?r.text:""};const c=m.bind({});c.args={...l,scopes:p,scopesTypeLabel:"Scopes",selectedScopes:[p[0]],scopeToString:r=>r?r.text:""};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`({
  ...
  return <SearchBar {...args} />;
}`,...c.parameters?.docs?.source}}};const k=["Default","InitialValue","Scopes","UnsortedScopes","SelectedScopes"];export{o as Default,t as InitialValue,a as Scopes,c as SelectedScopes,n as UnsortedScopes,k as __namedExportsOrder,R as default};
//# sourceMappingURL=SearchBar.stories-_arIs4Q9.js.map
