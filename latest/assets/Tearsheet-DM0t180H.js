import{j as l,p,B as i}from"./settings-DEdZ0TrD.js";import"./floating-ui.core.mjs-LzsX8FoD.js";import{R as d}from"./index-BwDkhjyp.js";import{T as c,t as h,p as m}from"./TearsheetShell-D_WxQLC9.js";import{P as e}from"./index-Dk74W0Oi.js";import{a as u}from"./props-helper-Bq60RLbY.js";import{g as f}from"./devtools-BMJcATO0.js";import{A as y}from"./ActionSet-aBtXfkQ8.js";const o="Tearsheet";let t=d.forwardRef(({influencerPosition:n="left",influencerWidth:a="narrow",...r},s)=>l.jsx(c,{...f(o),...r,influencerPosition:n,influencerWidth:a,ref:s,size:"wide"}));t=p.checkComponentEnabled(t,o);t.displayName=o;const g={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:u([y.validateActions(()=>"2xl"),e.arrayOf(e.shape({...i.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:i.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:n,hasCloseIcon:a})=>h(n,a)),description:e.node,hasCloseIcon:e.bool,influencer:e.element,influencerPosition:e.oneOf(["left","right"]),influencerWidth:e.oneOf(["narrow","wide"]),label:e.node,launcherButtonRef:e.any,navigation:e.element,onClose:e.func,open:e.bool,portalTarget:m,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...g};t.__docgenInfo={description:`A tearsheet is a mostly full-screen type of dialog that keeps users
