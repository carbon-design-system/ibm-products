import{u as X,j as t,M as Z,A as z}from"./blocks-nSDRSHG_.js";import{n as R,r as F,B as u,x as n,c as ee,z as te,E as O,A as J,I as se}from"./iframe-B8AK9roo.js";import{s as H}from"./tearsheet-summary-content-Ci1zcGXs.js";import{r as B}from"./state-Bxcl7owa.js";import{o as ne}from"./index-Bdv_Fhav.js";import{i as c}from"./icon-loader-DCP23Wv4.js";import{_ as m,a as re,b as M}from"./32-gWGFBCOY.js";import"./progress-step-DMMc9tRB.js";import"./text-input-O9RXV0tO.js";import"./text-input-skeleton-BCwJWjc8.js";import"./button-DruO1jNF.js";import"./button-skeleton-CfTK8f1v.js";import{S as ae}from"./step-group-858pHhQV.js";import{e as L,n as N}from"./ref-K3YrDb8j.js";import{_ as I}from"./32-Dvc1-m7_.js";import"./definition-tooltip-BWo7SsVR.js";import"./tab-skeleton-CSqiODxq.js";import"./badge-indicator-BW47IWYo.js";import"./progress-bar-CB5Mtklo.js";import"./textarea-skeleton-B7Yx6ILd.js";import"./slug-action-button-BhLbhd7S.js";import"./dropdown-skeleton-1li1_2fv.js";import"./toast-notification-Cf0PDmm8.js";import"./actionable-notification-button-exBjg0g-.js";import"./callout-notification-hn387k1D.js";var ie=Object.defineProperty,oe=Object.getOwnPropertyDescriptor,K=(s,e,a,o)=>{for(var r=o>1?void 0:o?oe(e,a):e,l=s.length-1,d;l>=0;l--)(d=s[l])&&(r=(o?d(e,a,r):d(r))||r);return o&&r&&ie(e,a,r),r};let P=class extends F{constructor(){super(...arguments),this.stackStepSize="lg",this._isActive=!1}connectedCallback(){super.connectedCallback(),H.setStackStepSize(this.stackStepSize),this._isActive=!0,this.dispatchEvent(new CustomEvent(`${u}-tearsheet-stack-connected`,{bubbles:!0,composed:!0,detail:{stackStepSize:this.stackStepSize}}))}disconnectedCallback(){super.disconnectedCallback(),this._isActive&&(H.reset(),this._isActive=!1)}updated(s){super.updated(s),s.has("stackStepSize")&&(H.setStackStepSize(this.stackStepSize),this.dispatchEvent(new CustomEvent(`${u}-tearsheet-stack-step-size-changed`,{bubbles:!0,composed:!0,detail:{stackStepSize:this.stackStepSize}})))}render(){return n`<slot></slot>`}};P.styles=[];K([R({type:String,attribute:"stack-step-size"})],P.prototype,"stackStepSize",2);P=K([ee(`${u}-tearsheet-stack`)],P);const ce="c4p-tearsheet-influencer,div[slot=main-content],c4p-tearsheet-summary-content{padding-block:2rem}.summaryPanelTrigger{position:absolute;inset-block-start:0;inset-inline-end:0}.influencerPanelTrigger{position:absolute;inset-block-start:0;inset-inline-start:0}@media(min-width:66rem)and (max-width:82rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}@media(min-width:42rem)and (max-width:66rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}@media(min-width:82rem)and (max-width:99rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}@media(min-width:99rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}.summaryPanelHeading{font-size:var(--cds-heading-03-font-size, 1.25rem);font-weight:var(--cds-heading-03-font-weight, 400);line-height:var(--cds-heading-03-line-height, 1.4);letter-spacing:var(--cds-heading-03-letter-spacing, 0)}@media(min-width:20rem)and (max-width:42rem){.stackButtons{display:none}}@media(min-width:66rem)and (max-width:82rem){.smallScreenButton{display:none}}@media(min-width:42rem)and (max-width:66rem){.smallScreenButton{display:none}}@media(min-width:82rem)and (max-width:99rem){.smallScreenButton{display:none}}@media(min-width:99rem){.smallScreenButton{display:none}}.default__action-buttons{display:grid;grid-auto-rows:minmax(auto,auto);grid-template-columns:repeat(6,1fr)}.default__action-buttons>cds-button{inline-size:100%;max-inline-size:none}.default__action-buttons>cds-button:first-child{grid-column:span 4}",p=te(ce);var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,W=(s,e,a,o)=>{for(var r=o>1?void 0:o?de(e,a):e,l=s.length-1,d;l>=0;l--)(d=s[l])&&(r=(o?d(e,a,r):d(r))||r);return o&&r&&le(e,a,r),r};let C=class extends ne(F){constructor(){super(...arguments),this.horizontal=!1,this._open=!1,this._stepInfo=new ae}connectedCallback(){super.connectedCallback(),this._stepInfo.updateTotalStepCount=3}_onButtonClick(){this._open=!0}_handleCancelButton(){this._open=!1,this._stepInfo.reset()}_handleBackButton(){const{currentStep:s}=this._stepInfo.data;if(s!==0)return this._stepInfo.handlePrevious()}_handleNextButton(){const{currentStep:s,totalSteps:e}=this._stepInfo.data;if(s+1===e){console.log("Form submitted:",this._stepInfo.data.formState),this._handleCancelButton();return}return this._stepInfo.handleNext()}_handleEmailInput(s){const e=structuredClone(this._stepInfo.data.formState);e.email=s.target.value,this._stepInfo.updateFormState=e}_handleCityInput(s){const e=structuredClone(this._stepInfo.data.formState);e.city=s.target.value,this._stepInfo.updateFormState=e}_handleStateInput(s){const e=structuredClone(this._stepInfo.data.formState);e.state=s.target.value,this._stepInfo.updateFormState=e}_toggleInfluencerPanel(){const s=this.shadowRoot?.querySelector(`${u}-tearsheet-influencer`);s&&s.toggleAttribute("influencer-panel-open")}_getStepContent(){const{formState:s,currentStep:e}=this._stepInfo.data,a=s;switch(e){case 0:return n`
    ...
    `}};b.styles=p;_([R({type:String,attribute:"tearsheet-type"})],b.prototype,"tearsheetType",2);_([B()],b.prototype,"_open1",2);_([B()],b.prototype,"_open2",2);_([B()],b.prototype,"_open3",2);b=_([J("stacking-tearsheet-demo")],b);const i="tearsheet-preview-stories",E=(s="wide")=>{const e=`(max-width: ${se.md.width})`;return window.matchMedia(e).matches||s==="narrow"?"xl":"2xl"},A=s=>{if(s==="WITH_AI_LABEL")return n`
      ...
      `},h=()=>{document.querySelector(`${u}-preview-tearsheet`)?.toggleAttribute("open")},Q=()=>{const s=document.querySelector(`${u}-tearsheet-influencer`);s&&s.toggleAttribute("influencer-panel-open")},q=()=>{const s=document.querySelector(`${u}-tearsheet-summary-content`);s&&s.toggleAttribute("summary-panel-open")},T=n` <c4p-truncated-text
  slot="description"
  lines="2"
  type="expand"
...
</div>`,G=n`  <div class="rightDetailsBody">
      ...
      >
        ...
        <c4p-tearsheet-body>
          ...
          ${s.showSummaryContent?n`<c4p-tearsheet-summary-content slot="summary-content"
                >${G}</c4p-tearsheet-summary-content
              >`:""}
        </c4p-tearsheet-body>
        <c4p-tearsheet-footer
          variant="${s.variant}"
    ...
    ${T}
      ...
      <c4p-tearsheet-influencer  >${V(!0)}</c4p-tearsheet-influencer>
       ...
       <div  slot="main-content"> 
        ...
        ${D}</div>
       <c4p-tearsheet-summary-content   slot="summary-content">${G}</c4p-tearsheet-summary-content>
        </c4p-tearsheet-body>
        <c4p-tearsheet-footer
         variant="narrow"
         .actions="${[{kind:"ghost",label:"Cancel",onClick:h},{kind:"secondary",label:"Back"},{kind:"primary",label:"Submit"}]}"
