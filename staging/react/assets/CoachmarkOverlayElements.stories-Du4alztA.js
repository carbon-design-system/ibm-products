...
`,`
`,t.jsx(j,{className:"coachmarkExample",withSource:"none",children:t.jsx("div",{className:"CoachmarkBaseExampleUsage",children:t.jsx(B,{of:void 0})})})]})}function N(s={}){const{wrapper:e}={...z(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(_,{...s})}):_(s)}const W=""+new URL("sample-image-Xi2Ah9yk.png",import.meta.url).href,K={title:"Patterns/Coachmark Overlay Elements",component:()=>{},tags:["autodocs"],parameters:{styles:S,docs:{page:N}}};function X(){const[s,e]=o.useState(()=>document.documentElement.getAttribute("data-carbon-theme"));return o.useEffect(()=>{const l=document.documentElement,d=()=>{const c=l.getAttribute("data-carbon-theme");e(a=>a!==c?c:a)},u=new MutationObserver(c=>{for(const a of c)a.type==="attributes"&&a.attributeName==="data-carbon-theme"&&d()});u.observe(l,{attributes:!0,attributeFilter:["data-carbon-theme"]});const y=setInterval(d,200);return()=>{u.disconnect(),clearInterval(y)}},[]),s}const D=s=>{const e=X(),[l,d]=o.useState(!0),[u,y]=o.useState(-1),[c,a]=o.useState(-1),h=o.useRef(null),r=o.useRef(null),g=[{id:1,title:"Example 1",text:"This is an example description."},{id:2,title:"Example 2",text:"This is an example description."}],x=()=>{d(!1),r.current.reset()},w=()=>{d(i=>!i)};o.useEffect(()=>{h&&h.current&&(r.current=O(h.current,{onViewChangeStart:C,onViewChangeEnd:k}))},[r,l]);const C=()=>{},k=i=>{b(i)},b=o.useCallback(({currentIndex:i,lastIndex:v})=>{y(i),a(v)},[]),E=()=>{r.current.next()},I=()=>{r.current.prev()};return n.createElement(V,{theme:e},n.createElement(p,{position:{x:151,y:155},open:l,onClose:x,align:"top",...s},n.createElement(T,{label:"Show information",buttonProps:{onClick:w,id:"CoachmarkBtn"}}),n.createElement(p.Content,{highContrast:!0},n.createElement(p.Content.Header,{closeIconDescription:"Close"}),n.createElement(p.Content.Body,null,n.createElement("div",null,n.createElement("img",{src:W,style:{width:"100%",marginBottom:"1rem"}})),n.createElement("div",{ref:h,className:"exampleCarouselWrapper"},g.map(i=>n.createElement("div",{key:i.id},n.createElement("h2",null,i.title),n.createElement("p",null,i.text)))),n.createElement("div",{className:"carouselControlWrapper__footer"},n.createElement("div",{className:"carouselControlWrapper--controls-progress"},g.map((i,v)=>{if(r.current?.getActiveItem?.()?.index===v)return n.createElement("span",{key:i.id},`${r.current?.getActiveItem?.()?.index+1} / ${g.length}`)})),n.createElement("div",{className:"carouselControlWrapper--buttons"},u!==0&&n.createElement(f,{size:"sm",iconDescription:"Previous",kind:"ghost",onClick:I},"Back"),c!==u?n.createElement(f,{size:"sm",iconDescription:"Next",onClick:E},"Next"):n.createElement(f,{size:"sm",onClick:x},"Done")))))))},m=D.bind({});m.args={};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`args => {
...
}`,...m.parameters?.docs?.source}}};const Q=["CoachmarkOverlay"];export{m as CoachmarkOverlay,Q as __namedExportsOrder,K as default};
