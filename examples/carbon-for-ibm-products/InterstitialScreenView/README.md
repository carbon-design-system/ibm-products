# Carbon for IBM Products `InterstitialScreenView` example
...
5. Review the changes made and restore/rectify the template TAGS typically in capitals. These are replaced as part of the build process. E.g. InterstitialScreenView, 2024, import './config'
