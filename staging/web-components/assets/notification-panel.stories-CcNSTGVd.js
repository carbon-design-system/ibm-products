 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */class O extends T{constructor(){super(...arguments),this.size="lg"}}O.styles=Zt;d([p({type:String,reflect:!0})],O.prototype,"title",void 0);d([p({type:String,reflect:!0})],O.prototype,"subtitle",void 0);d([p({type:String,reflect:!0})],O.prototype,"size",void 0);d([p()],O.prototype,"kind",void 0);d([p({type:String,reflect:!0})],O.prototype,"illustrationTheme",void 0);d([gt()],O.prototype,"hasIllustration",void 0);const s="cds",mt=`
...
}`,...X.parameters?.docs?.source}}};const ve=["Default","EmptyState"],wi=Object.freeze(Object.defineProperty({__proto__:null,Default:Y,EmptyState:X,__namedExportsOrder:ve,default:fe},Symbol.toStringTag,{value:"Module"}));export{wi as N};
