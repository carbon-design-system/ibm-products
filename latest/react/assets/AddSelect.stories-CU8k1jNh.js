...
│   └── Items Container (grid, keyboard navigation)
...
the main content area. Handles global search, navigation, and keyboard
navigation for the items grid.`]}),`
...
`,t.jsx(e.hr,{}),`
`,t.jsx(e.h3,{id:"3-addselectcolumn-optional",children:"3. AddSelect.Column (Optional)"}),`
...
`,t.jsx(e.hr,{}),`
`,t.jsx(e.h3,{id:"4-addselectrow",children:"4. AddSelect.Row"}),`
...
`,t.jsx(e.hr,{}),`
`,t.jsx(e.h3,{id:"5-addselectselectionsummary-optional",children:"5. AddSelect.SelectionSummary (Optional)"}),`
...
`,t.jsx(e.hr,{}),`
`,t.jsx(e.h3,{id:"6-addselectselectionsummaryitem-optional",children:"6. AddSelect.SelectionSummaryItem (Optional)"}),`
...
`,t.jsx(e.hr,{}),`
`,t.jsx(e.h3,{id:"7-addselectitempanel-optional",children:"7. AddSelect.ItemPanel (Optional)"}),`
...
<AddSelect selectedItems={selectedItems} onItemSelect={handleItemSelect}>
  <AddSelect.Body
    itemsLabel="Items"
    itemCount={currentLevel.items.length}
    layout="horizontal"
  >
...
`,t.jsxs(e.p,{children:[`Contains the header section (search, breadcrumbs, item count) and the main
content area. Keyboard navigation across `,t.jsx(e.code,{children:'[role="row"]'}),` elements is handled
internally; the row list is cached after the first key event and invalidated
automatically whenever `,t.jsx(e.code,{children:"children"}),` change, avoiding repeated DOM queries during
rapid navigation.`]}),`
`,t.jsx(e.p,{children:t.jsx(e.strong,{children:"Props:"})}),`
`,t.jsxs(e.ul,{children:[`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"children"}),` (ReactNode, optional) - Child components (typically
AddSelect.Column or AddSelect.Row)`]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"className"})," (string, optional) - Optional CSS class name"]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"layout"}),` ('vertical' | 'horizontal', optional, default: 'vertical') - Layout
direction for the items container`]}),`
...
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"onSearch"}),` (function, optional) - Called when the global search input value
changes. Intended to filter across ALL columns/rows in the Body. Independent
of any per-column search in `,t.jsx(e.code,{children:"AddSelect.Column"}),`
`,t.jsxs(e.ul,{children:[`
...
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"onSearch"}),` (function, optional) - Called when this column's local search
input changes. Scoped to this column only — independent of `,t.jsx(e.code,{children:"AddSelect.Body"}),`'s
global search`,`
`,t.jsxs(e.ul,{children:[`
`,t.jsxs(e.li,{children:["Signature: ",t.jsx(e.code,{children:"(columnSearchTerm: string) => void"})]}),`
`]}),`
`]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"actionsSlot"}),` (ReactNode, optional) - Actions slot - adds custom actions
...
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"navIndicatorLabel"}),` (string, optional) - Accessible label for the navigation
indicator button. Defaults to `,t.jsx(e.code,{children:"Navigate into <title>"}),` when not provided.
Override to localize the label for non-English UIs`]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"className"})," (string, optional) - Optional CSS class name"]}),`
...
`,t.jsxs(e.p,{children:[`Displays a panel of selected items with an optional count badge and edit icon.
The body is entirely composable — pass `,t.jsx(e.code,{children:"AddSelect.SelectionSummaryItem"}),`
components (or any custom content) as `,t.jsx(e.code,{children:"children"}),`. The count badge is shown
automatically when `,t.jsx(e.code,{children:"selectedItemCount"})," is provided; omit ",t.jsx(e.code,{children:"selectedItemCount"}),` to
hide the badge. `,t.jsx(e.code,{children:"emptyState"})," is shown when ",t.jsx(e.code,{children:"selectedItemCount"})," is ",t.jsx(e.code,{children:"0"}),` or not
provided.`]}),`
`,t.jsx(e.p,{children:t.jsx(e.strong,{children:"Props:"})}),`
`,t.jsxs(e.ul,{children:[`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"title"}),' (string, optional, default: "Selected items") - Panel title']}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"selectedItemCount"}),` (number, optional) - Number of selected items shown in
the badge. Omit to hide the badge entirely.`]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"children"}),` (ReactNode, optional) - Custom content or
`,t.jsx(e.code,{children:"AddSelect.SelectionSummaryItem"})," components rendered in the body"]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"emptyState"}),` (ReactNode, optional) - Placeholder shown when
`,t.jsx(e.code,{children:"selectedItemCount"})," is ",t.jsx(e.code,{children:"0"})," or not provided"]}),`
...
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"item"})," (AddSelectItem, optional) - Item data. ",t.jsx(e.code,{children:"defaultContent()"}),` renders
entries when `,t.jsx(e.code,{children:"item.itemDetails"}),` is
`,t.jsx(e.code,{children:"Array<{ label: string; value: string | number }>"}),". Use ",t.jsx(e.code,{children:"children"}),` or
`,t.jsx(e.code,{children:"renderItem"})," for custom layouts"]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.strong,{children:"open"}),` (boolean, optional) - Toggles the
`,t.jsx(e.code,{children:"${blockClass}__item-summary-panel--open"}),` CSS modifier class. Use this instead
of conditional rendering when you need CSS-driven slide-in/out transitions.
When omitted the modifier class is absent.`]}),`
...
close IconButton`]}),`
`]})]})}a(T,"_createMdxContent");function W(o={}){const{wrapper:e}={...E(),...o.components};return e?t.jsx(e,{...o,children:t.jsx(T,{...o})}):T(o)}a(W,"MDXContent");const l="add-select-next-stories",g=[{id:"1",value:"1",title:"Item 1",subtitle:"Item 1 subtitle",itemDetails:[{label:"Description",value:"First item in the list"},{label:"Category",value:"Type A"},{label:"Owner",value:"Team Alpha"}]},{id:"2",value:"2",title:"Item 2",subtitle:"Item 2 subtitle",itemDetails:[{label:"Description",value:"Second item in the list"},{label:"Category",value:"Type B"},{label:"Owner",value:"Team Beta"}]},{id:"3",value:"3",title:"Item 3",subtitle:"Item 3 subtitle",itemDetails:[{label:"Description",value:"Third item in the list"},{label:"Category",value:"Type A"},{label:"Owner",value:"Team Alpha"}]},{id:"4",value:"4",title:"Item 4",subtitle:"Item 4 subtitle",itemDetails:[{label:"Description",value:"Fourth item in the list"},{label:"Category",value:"Type C"},{label:"Owner",value:"Team Gamma"}]},{id:"5",value:"5",title:"Item 5",subtitle:"Item 5 subtitle",itemDetails:[{label:"Description",value:"Fifth item in the list"},{label:"Category",value:"Type B"},{label:"Owner",value:"Team Beta"}]}],R=g.slice(1,4),H=a(({children:o})=>n.createElement("div",{className:`${l}__placeholder-shell`},o),"PlaceholderShell"),M=a(()=>n.createElement("div",{className:`${l}__placeholder-rows`},g.slice(0,3).map(o=>n.createElement("div",{key:o.id,className:`${l}__placeholder-row`},n.createElement("p",null,"AddSelect.Row")))),"PlaceholderRows"),Fe={title:"Preview/Add and select",component:r,tags:["autodocs"],decorators:[o=>n.createElement("div",{className:`${l}__viewport`},o())],subcomponents:{"AddSelect.Body":r.Body,"AddSelect.Column":r.Column,"AddSelect.Row":r.Row,"AddSelect.SelectionSummary":r.SelectionSummary,"AddSelect.SelectionSummaryItem":r.SelectionSummaryItem,"AddSelect.ItemPanel":r.ItemPanel},parameters:{styles:$,docs:{page:W}}},U=a(o=>{const[e,d]=h.useState(""),s=h.useMemo(()=>g.filter(u=>u.title?.toLowerCase().includes(e.toLowerCase())),[e]),i=o.showActionsSlot?n.createElement(n.Fragment,null,n.createElement(p,{label:"Sort",kind:"ghost",size:"lg"},n.createElement(N,null)),n.createElement(p,{label:"Filter",kind:"ghost",size:"lg"},n.createElement(_,null))):void 0,m=o.showSubHeaderActions?n.createElement(O,{id:"body-subheader-toggle",labelA:"Off",labelB:"On",labelText:"Placeholder action",size:"sm",hideLabel:!0}):void 0;return n.createElement(r,{selectedItems:new Set,onItemSelect:a(()=>{},"onItemSelect")},n.createElement(H,null,n.createElement(r.Body,{itemsLabel:o.itemsLabel,globalSearchLabel:o.globalSearchLabel,globalSearchPlaceholder:o.globalSearchPlaceholder,searchResultsTitle:o.searchResultsTitle,itemCount:o.itemCount??s.length,path:o.showPath?o.path:[],onSearch:d,onBreadcrumbClick:a(()=>{},"onBreadcrumbClick"),actionsSlot:i,subHeaderActions:m,hideSearch:o.hideSearch},n.createElement(M,null))))},"AddSelectBodyStory"),j={name:"AddSelect.Body",render:U,args:{itemsLabel:"All items",globalSearchLabel:"Search items",globalSearchPlaceholder:"Search by name",searchResultsTitle:"Search results",itemCount:3,showActionsSlot:!0,showSubHeaderActions:!1,showPath:!1,path:[{id:"root",title:"Category"},{id:"folders",title:"Folders"},{id:"files",title:"Files"}],hideSearch:!1},argTypes:{itemsLabel:{control:"text",description:"Label shown when breadcrumbs are not used"},globalSearchLabel:{control:"text",description:"Accessible label for the global search input"},globalSearchPlaceholder:{control:"text",description:"Placeholder text for the global search input"},searchResultsTitle:{control:"text",description:"Title shown when search returns filtered results"},itemCount:{control:{type:"number",min:0},description:"Item count for display in tag badge"},showActionsSlot:{control:"boolean",description:"Toggle example content for the actionsSlot prop",table:{category:"Story controls"}},showSubHeaderActions:{control:"boolean",description:"Toggle example content for the subHeaderActions prop",table:{category:"Story controls"}},showPath:{control:"boolean",description:"Toggle breadcrumb path usage",table:{category:"Story controls"}},path:{control:"object",description:"Breadcrumb entries used for hierarchical navigation. Array of objects with id and title properties."},children:{control:!1,description:"Child components (typically AddSelect.Column or AddSelect.Row)",table:{disable:!0}},headerContent:{control:!1,description:"Custom header content (slot) - replaces entire header",table:{disable:!0}},actionsSlot:{control:!1,description:"Actions slot - adds custom actions (filter/sort) next to default search",table:{disable:!0}},subHeaderActions:{control:!1,description:"Sub-header actions - custom content/actions rendered after breadcrumbs and item count",table:{disable:!0}},onSearch:{control:!1,description:"Callback when search term changes. Signature: (searchTerm: string) => void",table:{disable:!0}},onBreadcrumbClick:{control:!1,description:"Callback when breadcrumb is clicked. Signature: (index: number) => void",table:{disable:!0}},searchProps:{control:!1,description:"Additional props to pass to the Search component",table:{disable:!0}},tagProps:{control:!1,description:"Additional props to pass to the Tag component (for item count)",table:{disable:!0}},breadcrumbProps:{control:!1,description:"Additional props to pass to the Breadcrumb component",table:{disable:!0}},breadcrumbItemProps:{control:!1,description:"Additional props to pass to BreadcrumbItem components",table:{disable:!0}},linkProps:{control:!1,description:"Additional props to pass to Link components in breadcrumbs",table:{disable:!0}},hideSearch:{control:"boolean",description:"Whether to hide the search input"},className:{control:"text",description:"Optional CSS class name",table:{disable:!0}}}},q=a(o=>{const[e,d]=h.useState(""),[s,i]=h.useState(new Set(["1","4"])),m=h.useMemo(()=>g.filter(c=>c.title?.toLowerCase().includes(e.toLowerCase())),[e]),u=a((c,C)=>{const P=o.multi?new Set(s):new Set;C?P.add(c):P.delete(c),i(P)},"handleItemSelect"),A=a(c=>{i(c?new Set(m.map(C=>C.id)):new Set)},"handleSelectAll"),b=m.length>0&&m.every(c=>s.has(c.id)),B=s.size>0&&s.size<m.length&&!b,D=o.showActionsSlot?n.createElement(n.Fragment,null,n.createElement(p,{label:"Sort",kind:"ghost",size:"sm"},n.createElement(N,null)),n.createElement(p,{label:"Filter",kind:"ghost",size:"sm"},n.createElement(_,null))):void 0;return n.createElement("div",{className:`${l}-column-container`},n.createElement(r,{selectedItems:s,onItemSelect:u},n.createElement(r.Body,{hideSearch:!0,className:`${l}--no-header-border`},n.createElement(r.Column,{title:o.title,searchLabel:o.searchLabel,searchPlaceholder:o.searchPlaceholder,onSearch:d,hideSearch:!o.showSearch,actionsSlot:D,multi:o.multi,showSelectAll:o.showSelectAll,itemCount:m.length,allSelected:b,allIndeterminate:B,onSelectAll:A,onNavigate:o.enableNavigation?()=>{}:void 0,className:"custom-column-class",searchProps:{closeButtonLabelText:"Clear search"},tagProps:{className:"custom-tag-class"},selectAllCheckboxProps:{hideLabel:!1}},m.map(c=>n.createElement(r.Row,{key:c.id,itemId:c.id,title:c.title||"",value:c.value||"",hasChildren:o.enableNavigation&&c.id==="1"}))))))},"AddSelectColumnStory"),f={name:"AddSelect.Column",render:q,args:{title:"Available items",searchLabel:"Search within column",searchPlaceholder:"Search items",showSearch:!0,showActionsSlot:!0,multi:!0,showSelectAll:!1,enableNavigation:!1},argTypes:{title:{control:"text",description:"Header title for the column"},searchLabel:{control:"text",description:"Accessible label for the column search input"},searchPlaceholder:{control:"text",description:"Placeholder text for the column search input"},showSearch:{control:"boolean",description:"Toggle the hideSearch behavior",table:{category:"Story controls"}},showActionsSlot:{control:"boolean",description:"Toggle example content for the actionsSlot prop",table:{category:"Story controls"}},multi:{control:"boolean",description:"Switch between checkbox and radio row selection"},showSelectAll:{control:"boolean",description:"Show the Select all checkbox when multi is enabled"},enableNavigation:{control:"boolean",description:"Show how the column can pass navigation callbacks to rows",table:{category:"Story controls"}},children:{table:{disable:!0}},onSearch:{table:{disable:!0}},actionsSlot:{table:{disable:!0}},hideSearch:{table:{disable:!0}},itemCount:{table:{disable:!0}},allSelected:{table:{disable:!0}},allIndeterminate:{table:{disable:!0}},onSelectAll:{table:{disable:!0}},onNavigate:{table:{disable:!0}},className:{table:{disable:!0}},searchProps:{table:{disable:!0}},tagProps:{table:{disable:!0}},selectAllCheckboxProps:{table:{disable:!0}}}},G=a(o=>{const[e,d]=h.useState(o.selected?new Set(["1"]):new Set),[s,i]=h.useState(o.itemPanelOpen);n.useEffect(()=>{d(o.selected?new Set(["1"]):new Set)},[o.selected]),n.useEffect(()=>{i(o.itemPanelOpen)},[o.itemPanelOpen]);const m=a((u,A)=>{const b=o.multi?new Set(e):new Set;A?b.add(u):b.delete(u),d(b)},"handleItemSelect");return n.createElement("div",{className:`${l}-container--single`},n.createElement(r,{selectedItems:e,onItemSelect:m},n.createElement(r.Body,{hideSearch:!0,className:`${l}--no-header-border`},n.createElement(r.Column,{multi:o.multi,hideSearch:!0},n.createElement(r.Row,{itemId:"1",title:"Item title",subtitle:o.showSubtitle?"Item subtitle":void 0,value:"folder 1",selected:o.selected,indeterminate:o.indeterminate,disabled:o.disabled,hasChildren:o.hasChildren,hasItemPanel:o.hasItemPanel,onItemPanelClick:a(()=>i(!0),"onItemPanelClick"),itemPanelOpen:o.hasItemPanel&&s,icon:o.showIcon?n.createElement(x,{size:"md",name:"thomas j. watson",tooltipAlignment:"right",tooltipText:"user profile image"}):void 0,skeleton:o.skeleton,rowContent:o.useRowContent?n.createElement("div",{className:`${l}__row-content`},n.createElement("strong",null,"Custom row content"),n.createElement(S,{type:"purple",size:"sm"},"Custom")):void 0},o.showTag?n.createElement(S,{type:"blue",size:"sm"},"Folder"):null)))))},"AddSelectRowStory"),y={name:"AddSelect.Row",render:G,args:{multi:!1,selected:!1,indeterminate:!1,showSubtitle:!0,showTag:!1,showIcon:!1,useRowContent:!1,hasChildren:!0,hasItemPanel:!1,itemPanelOpen:!1,disabled:!1,skeleton:!1},argTypes:{multi:{control:"boolean",description:"Toggle row rendering between checkbox and radio button mode",table:{category:"Story controls"}},showSubtitle:{control:"boolean",description:"Demonstrate the optional subtitle prop",table:{category:"Story controls"}},showTag:{control:"boolean",description:"Render custom row children content",table:{category:"Story controls"}},showIcon:{control:"boolean",description:"Demonstrate the optional icon prop",table:{category:"Story controls"}},useRowContent:{control:"boolean",description:"Demonstrate custom rowContent slot (replaces title/subtitle/children)",table:{category:"Story controls"}},hasChildren:{control:"boolean",description:"Show the navigation indicator for hierarchical lists"},hasItemPanel:{control:"boolean",description:"Show the item details icon button"},disabled:{control:"boolean",description:"Disable the example row"},skeleton:{control:"boolean",description:"Render the row as a skeleton (loading state) with placeholder content"},itemId:{control:"text",description:"Unique identifier for the item (required)",table:{disable:!0}},title:{control:"text",description:"Item title (required)",table:{disable:!0}},subtitle:{control:"text",description:"Item subtitle (optional)",table:{disable:!0}},value:{control:"text",description:"Item value (required)",table:{disable:!0}},selected:{control:"boolean",description:"Set the row selection state",table:{category:"Story controls"}},indeterminate:{control:"boolean",description:"Whether the item is in an indeterminate state (for multi hierarchical selections)"},parentId:{control:"text",description:"Parent ID for hierarchical navigation",table:{disable:!0}},icon:{control:!1,description:"Optional icon slot (ReactNode). Toggle with showIcon control.",table:{disable:!0}},children:{control:!1,description:"Custom content to render after the title/subtitle section (badges, tags, metadata)",table:{disable:!0}},rowContent:{control:!1,description:"Custom row content (slot) - replaces the entire row content section (title, subtitle, and children). When provided, only the selection control and navigation indicators remain. Toggle with useRowContent control.",table:{disable:!0}},onItemPanelClick:{control:!1,description:"Callback when item panel view icon is clicked. Signature: (itemId: string) => void",table:{disable:!0}},itemPanelIconDescription:{control:"text",description:"Description for the item panel icon button",table:{disable:!0}},itemPanelOpen:{control:"boolean",description:"Whether the item panel is currently open for this item",table:{category:"Story controls"}},className:{control:"text",description:"Optional CSS class name",table:{disable:!0}},checkboxProps:{control:!1,description:"Additional props to pass to the Checkbox component (when multi=true)",table:{disable:!0}},radioButtonProps:{control:!1,description:"Additional props to pass to the RadioButton component (when multi=false)",table:{disable:!0}},itemPanelIconButtonProps:{control:!1,description:"Additional props to pass to the IconButton component (info panel)",table:{disable:!0}}}},K=a(o=>{const e=o.showEmptyState?[]:R,d=a(s=>n.createElement("div",{className:`${l}__summary-item-row`,style:{borderBlockEnd:"1px solid var(--cds-border-subtle-01)"}},n.createElement(x,{size:"md",name:s.title,tooltipText:s.title}),n.createElement("div",{className:`${l}__summary-item-row-text`},n.createElement("p",{className:`${l}__summary-item-row-text__title`},s.title),s.subtitle&&n.createElement("p",{className:`${l}__summary-item-row-text__subtitle`},s.subtitle)),n.createElement("span",{className:`${l}__summary-item-row-modifier`},"Modifier")),"renderCustomItem");return n.createElement("div",{className:`${l}-summary-container`},n.createElement(r.SelectionSummary,{title:o.title,selectedItemCount:e.length,showEditIcon:o.showEditIcon,onEdit:o.showEditIcon?()=>{}:void 0,editIconDescription:o.editIconDescription,emptyState:o.showEmptyState?n.createElement("div",{className:`${l}__empty-state`},n.createElement(F,{subtitle:n.createElement(n.Fragment,null,"No selected items.",n.createElement("br",null),"Select items to see them here.")})):void 0,className:o.className,headerContent:o.useCustomHeader?n.createElement("div",{className:`${l}__summary-header-content`},n.createElement("h3",null,"Custom Header"),n.createElement(p,{label:"popup",kind:"ghost",size:"sm"},n.createElement(k,null))):void 0,headerActions:o.showHeaderActions?n.createElement(n.Fragment,null,n.createElement(p,{label:"Filter",kind:"ghost",size:"sm"},n.createElement(_,null)),n.createElement(p,{label:"popup",kind:"ghost",size:"sm"},n.createElement(k,null))):void 0},e.slice(0,3).map(s=>o.useCustomChildren?n.createElement(n.Fragment,{key:s.id},d(s)):n.createElement(r.SelectionSummaryItem,{key:s.id,item:s,onRemove:a(()=>{},"onRemove"),useAccordion:!0}))))},"AddSelectSelectionSummaryStory"),w={name:"AddSelect.SelectionSummary",render:K,args:{title:"Selected items",showEditIcon:!0,showHeaderActions:!1,showEmptyState:!1,editIconDescription:"Edit selections",className:"",useCustomHeader:!1,useCustomChildren:!1},argTypes:{title:{control:"text",description:"Heading displayed above the selection summary list"},showEditIcon:{control:"boolean",description:"Show the edit icon button when onEdit is provided"},editIconDescription:{control:"text",description:"Edit icon aria-label"},className:{control:"text",description:"Optional CSS class name"},useCustomChildren:{control:"boolean",description:"Toggle example custom children (SelectionSummaryItem components)",table:{category:"Story controls"}},useCustomHeader:{control:"boolean",description:"Toggle example custom header content (headerContent prop)",table:{category:"Story controls"}},showHeaderActions:{control:"boolean",description:"Toggle example content for the headerActions prop",table:{category:"Story controls"}},showEmptyState:{control:"boolean",description:"Show the emptyState slot usage",table:{category:"Story controls"}},selectedItemCount:{control:!1,description:"Number of selected items — drives the count badge and empty-state visibility"},children:{control:!1,description:"Custom content or SelectionSummaryItem components"},emptyState:{control:!1,description:"Custom empty state component — shown when selectedItemCount === 0"},onEdit:{control:!1,description:"Edit icon click handler. Signature: () => void"},headerContent:{control:!1,description:"Custom header content (slot) - replaces entire header section"},headerActions:{control:!1,description:"Header actions slot - adds custom actions alongside the edit icon"},tagProps:{control:!1,description:"Additional props to pass to the Tag component"},editIconButtonProps:{control:!1,description:"Additional props to pass to the edit IconButton"}}},V=a(o=>{const[e,d]=h.useState(!0),s=R[0];return n.createElement("div",{className:`${l}__summary-item-wrapper`},e?n.createElement(r.SelectionSummaryItem,{item:s,useAccordion:o.useAccordion,onRemove:o.showRemoveButton?()=>d(!1):void 0,removeButtonLabel:o.removeButtonLabel,renderAccordionTitle:o.useCustomTitle?i=>n.createElement("div",{className:`${l}__accordion-title`},n.createElement(x,{size:"md",name:i.title,tooltipText:i.title}),n.createElement("div",{className:`${l}__accordion-title-text`},n.createElement("p",{className:`${l}__accordion-title-text__title`},i.title),i.subtitle&&n.createElement("p",{className:`${l}__accordion-title-text__subtitle`},i.subtitle))):void 0,renderAccordionBody:o.useCustomContent?i=>n.createElement("div",{className:`${l}__accordion-body`},n.createElement(S,{type:"blue",size:"sm"},i.title),n.createElement(S,{type:"cyan",size:"sm"},"Category A"),n.createElement(S,{type:"teal",size:"sm"},"Active"),n.createElement(S,{type:"purple",size:"sm"},"Priority")):void 0,renderItem:o.useCustomRenderer?i=>n.createElement("div",{className:`${l}__summary-item-row`},n.createElement("div",{className:`${l}__summary-item-row-reorder`},n.createElement(z,{size:16}),n.createElement(x,{size:"md",name:i.title,tooltipText:i.title}),n.createElement("div",{className:`${l}__summary-item-row-text`},n.createElement("p",{className:`${l}__summary-item-row-text__title`},i.title),i.subtitle&&n.createElement("p",{className:`${l}__summary-item-row-text__subtitle`},i.subtitle))),n.createElement("span",{className:`${l}__summary-item-row-modifier`},"Modifier")):void 0},o.useChildren?n.createElement("div",{className:`${l}__summary-item-row`},n.createElement(x,{size:"md",name:s.title,tooltipText:s.title}),n.createElement("div",{className:`${l}__summary-item-row-text`},n.createElement("p",{className:`${l}__summary-item-row-text__title`},s.title),s.subtitle&&n.createElement("p",{className:`${l}__summary-item-row-text__subtitle`},s.subtitle)),n.createElement("span",{className:`${l}__summary-item-row-modifier`},"Modifier")):void 0):n.createElement("p",{className:`${l}__summary-item-removed`},"Item removed in story preview."))},"AddSelectSelectionSummaryItemStory"),I={name:"AddSelect.SelectionSummaryItem",render:V,args:{useAccordion:!0,showRemoveButton:!0,removeButtonLabel:"Remove item",useCustomTitle:!1,useCustomContent:!1,useCustomRenderer:!1,useChildren:!1},argTypes:{useAccordion:{control:"boolean",description:"Render the item with Carbon Accordion markup"},showRemoveButton:{control:"boolean",description:"Toggle the remove action button",table:{category:"Story controls"}},removeButtonLabel:{control:"text",description:"Accessible label for the remove icon button"},useCustomTitle:{control:"boolean",description:"Demonstrate renderAccordionTitle in accordion mode",table:{category:"Story controls"}},useCustomContent:{control:"boolean",description:"Demonstrate renderAccordionBody in accordion mode",table:{category:"Story controls"}},useCustomRenderer:{control:"boolean",description:"Demonstrate renderItem prop with custom rendering (takes precedence over default rendering)",table:{category:"Story controls"}},useChildren:{control:"boolean",description:"Demonstrate custom children content (takes highest priority)",table:{category:"Story controls"}},item:{table:{disable:!0}},renderAccordionTitle:{table:{disable:!0}},renderAccordionBody:{table:{disable:!0}},renderItem:{table:{disable:!0}},children:{table:{disable:!0}},onRemove:{table:{disable:!0}},className:{table:{disable:!0}},accordionProps:{table:{disable:!0}},accordionItemProps:{table:{disable:!0}},removeIconButtonProps:{table:{disable:!0}}}},X=a(o=>{const e=g[0];return n.createElement("div",{className:`${l}-summary-container`},n.createElement(r.ItemPanel,{title:o.title,item:e,open:o.open,onClose:o.showCloseButton?()=>{}:void 0,closeIconDescription:o.closeIconDescription,className:o.className,renderItem:o.useRenderItem?d=>n.createElement("div",{className:`${l}__item-panel-content`},n.createElement("p",{className:`${l}__item-panel-content__title`},d.title),n.createElement("p",{className:`${l}__item-panel-content__body`},"Custom rendered details for ",d.value)):void 0},o.useChildren?n.createElement("div",{className:`${l}__item-panel-content`},n.createElement("p",{className:`${l}__item-panel-content__title`},"Custom children content"),n.createElement("p",{className:`${l}__item-panel-content__body`},"This content is passed as children and takes highest priority")):void 0))},"AddSelectItemPanelStory"),v={name:"AddSelect.ItemPanel",render:X,args:{title:"Item details",open:!0,showCloseButton:!0,closeIconDescription:"Close item details",className:"",useChildren:!1,useRenderItem:!1},argTypes:{title:{control:"text",description:"Panel title"},open:{control:"boolean",description:"Toggles the `--open` CSS modifier class. Use for CSS-driven slide-in/out transitions instead of conditional rendering."},item:{control:!1,description:"Item data (AddSelectItem)",table:{disable:!0}},onClose:{control:!1,description:"Close button handler. Signature: () => void",table:{disable:!0}},closeIconDescription:{control:"text",description:"Close button aria-label"},className:{control:"text",description:"Optional CSS class name"},children:{control:!1,description:"Custom content - takes highest priority (ReactNode)",table:{disable:!0}},renderItem:{control:!1,description:"Custom template for rendering the entire panel body content. Signature: (item: AddSelectItem) => ReactNode",table:{disable:!0}},closeIconButtonProps:{control:!1,description:"Additional props to pass to the close IconButton",table:{disable:!0}},showCloseButton:{control:"boolean",description:"Toggle the close button by passing onClose",table:{category:"Story controls"}},useChildren:{control:"boolean",description:"Demonstrate custom children content (highest priority)",table:{category:"Story controls"}},useRenderItem:{control:"boolean",description:"Demonstrate custom renderItem for AddSelectItem data",table:{category:"Story controls"}}}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  name: 'AddSelect.Body',
  ...
  argTypes: {
    ...
    children: {
      control: false,
      description: 'Child components (typically AddSelect.Column or AddSelect.Row)',
      table: {
        disable: true
      }
    },
  ...
  argTypes: {
    ...
    emptyState: {
      control: false,
      description: 'Custom empty state component — shown when selectedItemCount === 0'
    },
    onEdit: {
      control: false,
...
}`,...v.parameters?.docs?.source}}};const $e=["AddSelectBody","AddSelectColumn","AddSelectRow","AddSelectSelectionSummary","AddSelectSelectionSummaryItem","AddSelectItemPanel"];export{j as AddSelectBody,f as AddSelectColumn,v as AddSelectItemPanel,y as AddSelectRow,w as AddSelectSelectionSummary,I as AddSelectSelectionSummaryItem,$e as __namedExportsOrder,Fe as default};
//# sourceMappingURL=AddSelect.stories-CU8k1jNh.js.map
