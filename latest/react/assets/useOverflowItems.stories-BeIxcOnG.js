var w=Object.defineProperty;var i=(a,e)=>w(a,"name",{value:e,configurable:!0});import{j as n,aA as y,aC as I,r as o,e as s}from"./iframe-DhIv2Cz2.js";import{u as O}from"./useOverflowItems-CNKq0w1o.js";import{S as h}from"./Slider-w_EJ2MDw.js";import{T as f}from"./Tag-SRa8Jkg6.js";import{A as E}from"./index-CY1gNwRx.js";import{useMDXComponents as p}from"./index-CqKVgfqi.js";import{a as k}from"./bucket-7-ChCKEQjG.js";import"./preload-helper-Cc2_yIPf.js";import"./useResizeObserver-Cm2iF_nj.js";import"./useIsomorphicEffect-DtbzomVA.js";import"./Text-OlEmoPCg.js";import"./clamp-ekNJC_Xv.js";import"./useNormalizedInputProps-B_vakQDX.js";import"./bucket-20-BLUMbjfu.js";import"./DefinitionTooltip-CJc_xAEX.js";import"./index-d8hsHx5V.js";import"./index-C1b99TSV.js";import"./bucket-19-0ioYX1hu.js";import"./utils-A8kjRMc4.js";import"./bucket-10-CR9aY5BR.js";function u(a){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...p(),...a.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"useoverflowitems",children:"useOverflowItems"}),`
...
`]}),`
`]}),`
`]})]})}i(u,"_createMdxContent");function R(a={}){const{wrapper:e}={...p(),...a.components};return e?n.jsx(e,{...a,children:n.jsx(u,{...a})}):u(a)}i(R,"MDXContent");const Y={title:"Utilities/useOverflowItems",parameters:{layout:"padded",docs:{page:R}},tags:["autodocs"]},H=i(()=>{const[a,e]=o.useState(500),[l,x]=o.useState(10),d=o.useRef(null),b=i(t=>Array(t).fill(null).map((m,c)=>({id:c,label:`Tag ${c+1}`})),"makeTags")(l),{visibleItems:g,hiddenItems:v,itemRefHandler:j}=O(b,d),T=i(t=>{e(t)},"widthHandler");return s.createElement("div",null,s.createElement(h,{className:"slider",max:1e3,min:200,value:a,onChange:i(({value:t})=>T(t),"onChange"),hideTextInput:!0,labelText:"Parent container width"}),s.createElement(h,{className:"slider",max:50,min:1,value:l,onChange:i(({value:t})=>x(t),"onChange"),hideTextInput:!0,labelText:"Number of total tags"}),s.createElement("div",{className:"parent",style:{width:`${a}px`}},s.createElement(E,{text:"Parent container",type:"layer",icon:k},s.createElement("div",{className:"child",ref:d},s.createElement("p",null,"Visible items:"),g.map(t=>s.createElement(f,{type:"blue",key:t.id,ref:i(m=>{j(t.id,m)},"ref")},t.label))),s.createElement("div",{className:"child"},s.createElement("p",null,"Hidden items:"),v.map(t=>s.createElement(f,{key:t.id,type:"blue"},t.label))))))},"Template"),r=H.bind({});r.args={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`() => {
...
//# sourceMappingURL=useOverflowItems.stories-BeIxcOnG.js.map
