...
`]})]})}s(C,"_createMdxContent");function W(n={}){const{wrapper:e}={...E(),...n.components};return e?i.jsx(e,{...n,children:i.jsx(C,{...n})}):C(n)}s(W,"MDXContent");const V=s(()=>{const[n,e]=r.useState(0),[f,w]=r.useState(-1),p=r.useRef(null),c=r.useRef(null),u=[{id:1,text:"Item One Description",image:"https://assets.ibm.com/is/image/ibm/adobestock_723170015?$original$"},{id:2,text:"Item Two Description",image:"https://assets.ibm.com/is/image/ibm/adobestock_285773476?$original$"},{id:3,text:"Item Three Description",image:"https://assets.ibm.com/is/image/ibm/adobestock_438396946?$original$"},{id:4,text:"Item Four Description",image:"https://assets.ibm.com/is/image/ibm/adobestock_268221428?$original$"}];r.useEffect(()=>(p.current&&(c.current=I(p.current,{onViewChangeStart:j,onViewChangeEnd:y,useMaxHeight:!0})),()=>{c.current?.destroyEvents&&c.current.destroyEvents()}),[]);const j=s(()=>{},"onViewChangeStart"),y=s(o=>{l(o)},"onViewChangeEnd"),l=r.useCallback(({currentIndex:o,lastIndex:m})=>{e(o),w(m)},[]),b=s(()=>{c.current?.next()},"onNext"),_=s(()=>{c.current?.prev()},"onPrev");return t.createElement(P,null,t.createElement(S,null,t.createElement(v,null,t.createElement("div",{ref:p,className:"exampleCarouselWrapper"},u.map(o=>t.createElement("div",{key:o.id,className:"carousel_item"},t.createElement("img",{src:o.image,alt:`Item ${o.id}`})))))),t.createElement(S,{className:"carouselControlWrapper"},t.createElement(v,{lg:2,md:1,sm:1},t.createElement(x,{kind:"ghost",iconDescription:"Previous",hasIconOnly:!0,renderIcon:O,onClick:_,disabled:n===0})),t.createElement(v,{lg:12,md:6,sm:2},t.createElement("div",{className:"carouselIndicators"},u.map((o,m)=>t.createElement("div",{className:c.current?.getActiveItem?.()?.index===m?"activeIndicator":"",key:o.id})))),t.createElement(v,{lg:2,md:1,sm:1},t.createElement(x,{kind:"ghost",iconDescription:"Next",hasIconOnly:!0,renderIcon:$,onClick:b,disabled:f===n}))))},"CarouselExample");V.__docgenInfo={description:"",methods:[],displayName:"CarouselExample"};const z=s(({label:n})=>t.createElement("div",{className:"PlayingCard"},t.createElement("div",{style:{position:"absolute",top:16,left:16}},n),t.createElement("div",{style:{position:"absolute",bottom:16,right:16}},n)),"PlayingCard");z.propTypes={label:A.string.isRequired};z.__docgenInfo={description:"",methods:[],displayName:"PlayingCard",props:{label:{description:"The label to display on the playing card",type:{name:"string"},required:!0}}};const N=s(()=>{const[n,e]=r.useState(0),[f,w]=r.useState(-1),[p,c]=r.useState(-1),[u,j]=r.useState([]),y=r.useRef(null),l=r.useRef(null);r.useEffect(()=>(y.current&&(l.current=I(y.current,{onViewChangeStart:b,onViewChangeEnd:_,excludeSwipeSupport:!1})),()=>{l.current?.destroyEvents&&l.current.destroyEvents()}),[]);const b=s(()=>{},"onViewChangeStart"),_=s(a=>{o(a)},"onViewChangeEnd"),o=r.useCallback(({currentIndex:a,lastIndex:g,totalViews:H,historyStack:T})=>{e(a),w(g),c(H),j(T)},[]),m=[{label:"2",title:"Card 2"},{label:"3",title:"Card 3"},{label:"4",title:"Card 4"},{label:"5",title:"Card 5"},{label:"6",title:"Card 6"},{label:"7",title:"Card 7"},{label:"8",title:"Card 8"},{label:"9",title:"Card 9"},{label:"10",title:"Card 10"},{label:"J",title:"Jack"},{label:"Q",title:"Queen"},{label:"K",title:"King"},{label:"A",title:"Ace"}];return t.createElement("div",{className:"ViewStackStoryExample"},t.createElement("div",{className:"ViewStackStoryHistory"},t.createElement("div",{className:"ViewStackStoryHistoryRow"},`Current Index: ${n}`),t.createElement("div",{className:"ViewStackStoryHistoryRow"},`Last Index: ${f}`),t.createElement("div",{className:"ViewStackStoryHistoryRow"},`Total Views: ${p}`),t.createElement("label",{className:"ViewStackStoryHistoryEntriesLabel",htmlFor:"historyContainer"},"History:"),t.createElement("ol",{name:"historyContainer",className:"ViewStackStoryHistoryEntries",type:"1"},u&&u.map((a,g)=>t.createElement("li",{key:g,className:"ViewStackStoryHistoryEntry"},`[${g}] - id: ${a.id}, title: ${a.title}`)))),t.createElement("div",{className:"PlayingCardViewStack playingCardContainer",ref:y},m.map(a=>t.createElement("div",{key:a.label,title:a.title},t.createElement(z,{label:a.label})))),t.createElement("div",{className:"ViewStackStoryControls"},m.map((a,g)=>t.createElement(x,{key:a.label,size:"sm",kind:"ghost",onClick:s(()=>l.current?.goToIndex(g),"onClick")},a.title)),t.createElement(x,{size:"sm",kind:"ghost",disabled:n===f,onClick:s(()=>l.current?.next(),"onClick")},"Increment"),t.createElement(x,{size:"sm",kind:"ghost",disabled:u.length===1,onClick:s(()=>l.current?.prev(),"onClick")},"Back"),t.createElement(x,{size:"sm",kind:"ghost",disabled:u.length===1,onClick:s(()=>l.current?.reset(),"onClick")},"Home")))},"ViewStackExample");N.__docgenInfo={description:"",methods:[],displayName:"ViewStackExample"};const X={title:"Utilities/Carousel",component:s(()=>{},"component"),tags:["autodocs"],parameters:{styles:F,docs:{page:W}}},d=s(()=>t.createElement(V,null),"StandardCarousel");d.storyName="Carousel with navigation";const h=s(()=>t.createElement(N,null),"ViewStack");h.storyName="ViewStack navigation";d.__docgenInfo={description:"",methods:[],displayName:"StandardCarousel"};h.__docgenInfo={description:"",methods:[],displayName:"ViewStack"};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => {
...
//# sourceMappingURL=Carousel.stories-BNpvQ3cc.js.map
