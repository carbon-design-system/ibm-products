...
export const PageHeader = !pkg.isComponentEnabled(componentName)
    ...
    ({
      ...
      const checkUpdateVerticalSpace = () => {
        ...
        update.headerHeight = headerEl.current
          ...
          : 0;
        update.headerWidth = headerEl.current
          ? headerEl.current.offsetWidth
          : 0;
        ...
        update.subtitleRowHeight = subtitleRowEl
          ? subtitleRowEl.clientHeight
          : 0;
            ...
            <Grid>
              ...
              {subtitle !== undefined ? (
                <Row className={`${blockClass}--subtitle-row`}>
                  <Column className={`${blockClass}--subtitle`}>
                    {subtitle}
                  </Column>
                </Row>
              ) : null}
