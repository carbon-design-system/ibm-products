...
import '@carbon/ibm-products-web-components/es/components/text-input/index.js';
import '@carbon/ibm-products-web-components/es/components/textarea/index.js';
import '@carbon/ibm-products-web-components/es/components/button/index.js';
```
