...
can be created as [pattern](/docs/patterns-coachmark-stacked--overview) using
new [composable coachmark](/docs/preview-onboarding-coachmark-next--overview),
[carousel utility](https://github.com/carbon-design-system/carbon/blob/main/packages/utilities/src/carousel/README.md)
and other [carbon components](https://web-components.carbondesignsystem.com).
