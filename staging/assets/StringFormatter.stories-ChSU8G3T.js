import{e as c,r as R}from"./index-CPiZ6Cnx.js";import{aw as t,al as D,ax as P,ak as A}from"./index-z3zJDXtl.js";import{useMDXComponents as S}from"./index-CUO_02de.js";import"./chunk-NUUEMKO5-CVm38ugG.js";import{c as b,P as l}from"./index-CXyjPnaX.js";import{g as M}from"./devtools-BgfuqBVa.js";import{p as w}from"./settings-DkGFwmHv.js";import{D as N}from"./DefinitionTooltip-BPN6Mdin.js";import{a as I}from"./props-helper-C4XfpXsc.js";import{u as B}from"./useIsomorphicEffect-CqAX3nH-.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-BAt2XFX8.js";import"../sb-preview/runtime.js";import"./index-BSHYryQu.js";import"./index-Bsyy8W_U.js";import"./index-Df9so8jS.js";import"./index-DMCuvgYY.js";import"./index-DrFu-skq.js";import"./react-18-C6q_qjn2.js";import"./events-OVwOsPzJ.js";import"./index-DJK44odq.js";const n={TOP:"top",TOP_LEFT:"top-left",TOP_RIGHT:"top-right",BOTTOM:"bottom",BOTTOM_LEFT:"bottom-left",BOTTOM_RIGHT:"bottom-right",LEFT:"left",LEFT_BOTTOM:"left-bottom",LEFT_TOP:"left-top",RIGHT:"right",RIGHT_BOTTOM:"right-bottom",RIGHT_TOP:"right-top"},r={TOP:"top",TOP_START:"top-start",TOP_END:"top-end",BOTTOM:"bottom",BOTTOM_START:"bottom-start",BOTTOM_END:"bottom-end",LEFT:"left",LEFT_END:"left-end",LEFT_START:"left-start",RIGHT:"right",RIGHT_END:"right-end",RIGHT_START:"right-start"},H=o=>({[n.TOP_LEFT]:r.TOP_START,[n.TOP_RIGHT]:r.TOP_END,[n.BOTTOM_LEFT]:r.BOTTOM_START,[n.BOTTOM_RIGHT]:r.BOTTOM_END,[n.LEFT_BOTTOM]:r.LEFT_END,[n.LEFT_TOP]:r.LEFT_START,[n.RIGHT_BOTTOM]:r.RIGHT_END,[n.RIGHT_START]:r.RIGHT_START})[o],m=`${w.prefix}--string-formatter`,g="StringFormatter",d={lines:1,tooltipDirection:r.BOTTOM_START,truncate:!1,width:null};let a=c.forwardRef(({className:o,lines:e=d.lines,tooltipDirection:u=d.tooltipDirection,truncate:s=d.truncate,width:h=d.width,value:p,...E},j)=>{const T=R.useRef(null);B(()=>{T.current.style.maxWidth=h,T.current.style.WebkitLineClamp=e},[e,h]);const f=c.createElement("span",{ref:T,className:b(`${m}--content`,{[`${m}--truncate`]:s})},p);return c.createElement("span",{...E,className:b(m,o),ref:j,...M(g)},s?c.createElement(N,{className:`${m}__tooltip`,align:u,definition:p,openOnHover:!0},f):f)});a=w.checkComponentEnabled(a,g);a.displayName=g;a.validateAlignment=()=>(o,e,u)=>{const s=o[e];if(Object.values(n).includes(s)){const p=H(s);console.warn(`"${s}" is a deprecated value for the "${e}" prop on the "${u}" component. Use "${p}" instead. Allowable values are: ${Object.values(r).join(", ")}.`)}};a.propTypes={className:l.string,lines:l.number,tooltipDirection:I([a.validateAlignment(),l.oneOf(Object.values(n),Object.values(r))]),truncate:l.bool,value:l.string.isRequired,width:l.string};a.__docgenInfo={description:`StringFormatter allows for truncating text while displaying a tooltip
