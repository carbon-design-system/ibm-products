import{r as E,e}from"./index-BOZkNhcz.js";import{j as i,a as te,h as se,C as ne}from"./index-k6DjlwLo.js";import{useMDXComponents as V}from"./index-aaDvWpb8.js";import"./DocsRenderer-CFRXHY34-mrqLW0G7.js";import{A as ie}from"./index-BI5UeCJp.js";import{J as oe,b as j,c as h,_ as L,d as re,P as t,i as N}from"./index--clQM3eT.js";import{g as $}from"./devtools-BSXGZlBP.js";import{p as f}from"./settings-BYgtfLKl.js";import{b as ae}from"./index-YZUn1U4D.js";import{T as B}from"./Text-C-NQiyV2.js";import{d as le,e as ce}from"./bucket-13-CPhkYP6U.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-CFrrarbq.js";import"./index-hBZdtWkn.js";import"./index-2uioG_CI.js";import"./index-CO8sV34W.js";import"./index-ogSvIofg.js";import"./react-18-Cs6RDBhU.js";import"./bucket-10-D-kJO57o.js";import"./bucket-18-Dly-sSmK.js";import"./events-OVwOsPzJ.js";function de(n,s){const r=E.useRef(s);E.useEffect(()=>{r.current=s}),oe&&ae(window,"click",o=>{n.current&&!n.current.contains(o.target)&&r.current(o)})}var z;const H=e.createContext(null),J=e.createContext(null);function U(n){const{children:s,selection:r,className:o,["aria-label"]:d="Structured list section",ariaLabel:a,isCondensed:l,isFlush:v,...w}=n,p=j(),x=h(`${p}--structured-list`,{[`${p}--structured-list--selection`]:r,[`${p}--structured-list--condensed`]:l,[`${p}--structured-list--flush`]:v&&!r},o),[b,D]=e.useState(null);return e.createElement(H.Provider,{value:b},e.createElement(J.Provider,{value:D},e.createElement("div",L({role:"table",className:x},w,{"aria-label":a||d}),s)))}U.propTypes={"aria-label":t.string,ariaLabel:N(t.string),children:t.node,className:t.string,isCondensed:t.bool,isFlush:t.bool,selection:t.bool};t.node,t.string;function Q(n){const{children:s,className:r,...o}=n,d=j(),a=h(`${d}--structured-list-tbody`,r);return e.createElement("div",L({className:a,role:"rowgroup"},o),s)}Q.propTypes={children:t.node,className:t.string,head:t.bool,onKeyDown:t.func};const pe=e.createContext(null);function Y(n){const{onKeyDown:s,children:r,className:o,head:d,onClick:a,selection:l,...v}=n,[w,p]=E.useState(!1),x=re("grid-input"),b=e.useContext(H),D=e.useContext(J),g=j(),Z={id:x},O=h(`${g}--structured-list-row`,{[`${g}--structured-list-row--header-row`]:d,[`${g}--structured-list-row--focused-within`]:w&&!l||w&&l&&(b===x||b===null),[`${g}--structured-list-row--selected`]:b===x},o),A=E.useRef(null);return de(A,()=>{p(!1)}),d?e.createElement("div",L({role:"row"},v,{className:O}),l&&(z||(z=e.createElement(T,{head:!0}))),r):e.createElement("div",L({},v,{role:"row",className:O,ref:A,onClick:ee=>{D==null||D(x),a&&a(ee),l&&p(!0)},onFocus:()=>{p(!0)},onBlur:()=>{p(!1)},onKeyDown:s}),e.createElement(pe.Provider,{value:Z},l&&e.createElement(T,null,b===x?e.createElement(le,{className:`${g}--structured-list__icon`}):e.createElement(ce,{className:`${g}--structured-list__icon`})),r))}Y.propTypes={children:t.node,className:t.string,head:t.bool,label:N(t.bool),onClick:t.func,onKeyDown:t.func,selection:t.bool};t.string,N(t.bool),t.string,t.string,t.func,t.string,N(t.oneOfType([t.string,t.number]).isRequired);function T(n){const{children:s,className:r,head:o,noWrap:d,...a}=n,l=j(),v=h({[`${l}--structured-list-th`]:o,[`${l}--structured-list-td`]:!o,[`${l}--structured-list-content--nowrap`]:d},r);return o?e.createElement(B,L({className:v,role:"columnheader"},a),s):e.createElement(B,L({as:"div",className:v,role:"cell"},a),s)}T.propTypes={children:t.node,className:t.string,head:t.bool,noWrap:t.bool};const R={XSmall:"xs",Small:"sm",Medium:"md",Large:"lg"},_=`${f.prefix}--description-list`,k="DescriptionList",M={border:!1,size:R.Medium};let u=e.forwardRef(({border:n=M.border,children:s,className:r,size:o=M.size,...d},a)=>e.createElement("div",{...d,className:h(_,{[`${_}--bordered`]:n,[`${_}--${o}`]:o},r),ref:a,...$(k)},e.createElement(U,{role:"table",selection:!1},s)));u.deprecated={level:"warn",details:"This component is deprecated"};u=f.checkComponentEnabled(u,k);u.displayName=k;u.propTypes={border:t.bool,children:t.node,className:t.string,size:t.oneOf(Object.values(R))};u.__docgenInfo={description:`Type layouts provide an orderly layout of terms and definitions.
...
NB no need for a 'Playground' because all stories have all controls anyway.`,...(K=(G=y.parameters)==null?void 0:G.docs)==null?void 0:K.description}}};const Fe=["descriptionList"];export{Fe as __namedExportsOrder,Me as default,y as descriptionList};
