import{j as k,r as y,E as O,l as h,x as d,n as f,c as $}from"./iframe-B2dGZ3uq.js";import{u as T,c as b}from"./coachmark-beacon-BUq7dbfJ.js";import"./button-DVr7o_tG.js";import"./button-skeleton-D8YftpuT.js";import{H as v}from"./class-map-tNNkCSzW.js";import{_ as I}from"./16-nJySvwbz.js";import{_ as S,a as P}from"./16-h0a7ESSC.js";import{e as C}from"./index-YXHWeAQT.js";import{i as m}from"./icon-loader-Cf7p-8D_.js";import{P as t}from"./popover-content-DKTuhRDn.js";const w=":host(c4p-coachmark-header){display:flex;justify-content:flex-end}:host(c4p-coachmark-header) .c4p--coachmark-header-drag-handle{margin-inline-end:auto}:host(c4p-coachmark-header) .c4p--coachmark-header-drag-icon{fill:var(--cds-background, #ffffff)}:host(c4p-coachmark-header) .c4p--coachmark-header-close-icon{fill:var(--cds-background, #ffffff)}",z=k(w);var E=Object.defineProperty,H=Object.getOwnPropertyDescriptor,u=(o,n,s,c)=>{for(var e=c>1?void 0:c?H(n,s):n,a=o.length-1,r;a>=0;a--)(r=o[a])&&(e=(c?r(n,s,e):r(e))||e);return c&&e&&E(n,s,e),e};let p=class extends C(v(y)){constructor(){super(...arguments),this.closeIconDescription="",this.dragIconDescription="",this._handleClick=()=>{T({name:"open",detail:!b.get().open})}}render(){const{floating:o}=b.get();return d`
    ...
    `}};p.styles=z;u([f({reflect:!0})],p.prototype,"closeIconDescription",2);u([f({reflect:!0})],p.prototype,"dragIconDescription",2);p=u([$(`${h}-coachmark-header`)],p);const L=":host(c4p-coachmark-body){display:block;padding:0 1rem 1rem}",j=k(L);var A=Object.getOwnPropertyDescriptor,B=(o,n,s,c)=>{for(var e=c>1?void 0:c?A(n,s):n,a=o.length-1,r;a>=0;a--)(r=o[a])&&(e=r(e)||e);return e};let g=class extends C(v(y)){render(){return d` <slot></slot> `}};g.styles=j;g=B([$(`${h}-coachmark-body`)],g);const M=`/**
 * @license
 *
