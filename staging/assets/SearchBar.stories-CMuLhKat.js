...
`,e.jsx(he,{})]})}function ve(t={}){const{wrapper:r}={...G(),...t.components};return r?e.jsx(r,{...t,children:e.jsx(_,{...t})}):_(t)}const Ce="",at={title:"Experimental/Components/Search bar/SearchBar",component:n,tags:["autodocs"],argTypes:{value:{control:{disable:!0}},onChange:{control:{disable:!0}},className:{control:{disable:!0}},hideScopesLabel:{control:{disable:!0}},onSubmit:{control:{disable:!0}},scopeToString:{control:{disable:!0}},scopes:{control:{disable:!0}},scopesTypeLabel:{control:{disable:!0}},selectedScopes:{control:{disable:!0}},sortItems:{control:{disable:!0}},titleText:{control:{disable:!0}},translateWithId:{control:{disable:!0}}},parameters:{styles:Ce,docs:{page:ve}}},x=[{id:"scope-2",text:"Scope 2"},{id:"scope-1",text:"Scope 1"},{id:"scope-3",text:"Scope 3"}],y={clearButtonLabelText:"Clear",placeholderText:"Search...",submitLabel:"Search",labelText:"Label text",onChange:t=>I("onChange")(t),onSubmit:t=>I("onSubmit")(t)},w=({...t})=>e.jsx(n,{...t}),H=({...t})=>e.jsx(n,{...t}),l=w.bind({});l.args={...y};const p=w.bind({});p.args={...y,value:"Initial value"};const u=H.bind({});u.args={...y,scopes:x,scopesTypeLabel:"Scopes",scopeToString:t=>t?t.text:""};const d=H.bind({});d.args={...y,scopes:x,scopesTypeLabel:"Scopes",sortItems:t=>t,scopeToString:t=>t?t.text:""};const m=w.bind({});m.args={...y,scopes:x,scopesTypeLabel:"Scopes",selectedScopes:[x[0]],scopeToString:t=>t?t.text:""};var N,P,O;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`({
  ...args
}) => {
  return <SearchBar {...args} />;
}`,...(O=(P=l.parameters)==null?void 0:P.docs)==null?void 0:O.source}}};var V,D,A;p.parameters={...p.parameters,docs:{...(V=p.parameters)==null?void 0:V.docs,source:{originalSource:`({
  ...args
}) => {
  return <SearchBar {...args} />;
}`,...(A=(D=p.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var E,M,R;u.parameters={...u.parameters,docs:{...(E=u.parameters)==null?void 0:E.docs,source:{originalSource:`({
  ...args
}) => {
  return <SearchBar {...args} />;
}`,...(R=(M=u.parameters)==null?void 0:M.docs)==null?void 0:R.source}}};var $,F,k;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`({
  ...args
}) => {
  return <SearchBar {...args} />;
  ...
  return <SearchBar {...args} />;
}`,...(X=(U=m.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};const ot=["Default","InitialValue","Scopes","UnsortedScopes","SelectedScopes"];export{l as Default,p as InitialValue,u as Scopes,m as SelectedScopes,d as UnsortedScopes,ot as __namedExportsOrder,at as default};
