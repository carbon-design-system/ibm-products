...
}`,...d.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`argsIn => {
  const {
    containerWidth,
    allTagsModalTargetCustomDomNode,
    size,
...
}`,...i.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`argsIn => {
  const {
    containerWidth,
    allTagsModalTargetCustomDomNode,
    size,
...
}`,...m.parameters?.docs?.source}}};const ye=["FiveTags","ManyTags","MultilineTags","HundredsOfTags","WithClose","WithCloseAndOverflowTags"];export{g as FiveTags,i as HundredsOfTags,c as ManyTags,d as MultilineTags,p as WithClose,m as WithCloseAndOverflowTags,ye as __namedExportsOrder,be as default};
//# sourceMappingURL=TagSet.stories-B2zFBDPO.js.map
