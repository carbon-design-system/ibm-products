import{k as L,l as k,x as E}from"./iframe-Etog_1uH.js";import{c as q}from"./repeat-BkKzgudw.js";import"./guide-banner-element-CVDBFjBB.js";import{i as w}from"./icon-loader-2iGE0hUJ.js";import{v as P,a as I}from"./index-DkSYGz6Z.js";const O=".body{color:var(--cds-text-primary, #161616)}.body-elm{inline-size:600px;padding-inline-start:3rem}.footer{display:flex;justify-content:space-between;inline-size:100%}.footer-left .guide-banner-story__toggle-button{margin-inline-start:2rem}",B=L(O),p=`${k}--snappy`,A=`${p}__elm`,c=`${p}__selection`;function D(e,n){const s=document.querySelector(e);if(!s)return;const t=document.createElement("style");t.textContent=`
  .${p} {
    display: flex;
    flex: none;
    overflow: scroll;
