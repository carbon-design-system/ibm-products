...
"
    ...
    `}},wt={title:"Components/Onboarding/InterstitialScreen"};P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  argTypes,
  render: args => {
