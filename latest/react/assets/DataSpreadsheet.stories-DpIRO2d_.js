import{j as t,aA as y,aC as E,aB as H,r as n,e as s}from"./iframe-CtoKioxt.js";import{useMDXComponents as b}from"./index-ClRINNPk.js";import{O as v}from"./index-DXIofiWL.js";import{O as A}from"./OverflowMenuItem-DjjDZLJ3.js";import{D as d}from"./DataSpreadsheet-KonOdt14.js";import"./preload-helper-PPVm8Dsz.js";import"./useAttachedMenu-Bqdk6DpD.js";import"./mergeRefs-BZpmU3mx.js";import"./bucket-13-DH4S8Q-V.js";import"./wrapFocus-BVfmuAZ2.js";import"./useOutsideClick-DrI2TK2-.js";import"./Text-vtctM3R-.js";import"./index.esm-E4Z4ZQDd.js";import"./uuidv4-BN2rGLQG.js";import"./usePreviousValue-CcZwIsc9.js";import"./inheritsLoose-DHKJTbHM.js";import"./props-helper-B5pvbCOQ.js";import"./devtools-BpDcN5qy.js";import"./getNodeTextContent-C8IeKkUQ.js";const S=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],f=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],L=e=>{const a=[];for(let r=0;r<e;r++)a.push(r);return a},j=e=>{const a=e&&{ownerName:f[Math.floor(Math.random()*f.length)],weight:Math.floor(Math.random()*40)},r={petType:S[Math.floor(Math.random()*S.length)],firstName:f[Math.floor(Math.random()*f.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...r,...a}:r},w=({rows:e,extraColumns:a})=>((o=0)=>{const m=[e][o];return L(m).map(()=>({...j(a)}))})();function M(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...b(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
...
//# sourceMappingURL=DataSpreadsheet.stories-DpIRO2d_.js.map
