...
import styles from './set-of-page-actions.scss?lit';

const blockClass = `c4p--set-of-page-actions`;

interface PageAction {
  label: string;
}

@customElement('set-of-page-actions')
export default class SetOfPageActions extends LitElement {
  /**
...
declare global {
  interface HTMLElementTagNameMap {
    'set-of-page-actions': SetOfPageActions;
  }
}
