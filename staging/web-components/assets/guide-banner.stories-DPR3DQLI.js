import{k as T,l as _,x as f}from"./iframe-CPwma648.js";import{c as E}from"./repeat-RU2UzROa.js";import"./guide-banner-element-BDUOhQwD.js";import{i as x}from"./icon-loader-Bb4ppSSv.js";import{i as S,a as k}from"./20-CppOV_ea.js";import"./preload-helper-D9Z9MdNV.js";import"./class-map-BjEbJ_wj.js";import"./button-BE8YYPkS.js";import"./button-skeleton-Dtbl2yvK.js";import"./16-D5maUdCH.js";const q=".body{color:var(--cds-text-primary, #161616)}.body-elm{padding:2rem;inline-size:600px}.footer{display:flex;justify-content:space-between;inline-size:100%}",C=T(q),l=`${_}--snappy`,L=`${l}__elm`,d=`${l}__selection`;function w(t,r){const n=document.querySelector(t);if(!n)return;const i=document.createElement("style");i.textContent=`
  .${l} {
    display: flex;
    flex: none;
    overflow: scroll;
