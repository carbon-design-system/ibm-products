...
`,o.jsx(n.p,{children:`The CoachmarkOverlayElements pattern acts as a container element for onboarding
and should only be used within the scope of a Coachmark.`}),`
`,o.jsx(n.p,{children:"To build this pattern, we recommend including the following components:"}),`
`,o.jsxs(n.ul,{children:[`
`,o.jsx(n.li,{children:o.jsx(n.a,{href:"https://carbon-for-ibm-products.netlify.app/?path=/docs/experimental-onboarding-coachmark-next--overview",rel:"nofollow",children:"Coachmark"})}),`
`,o.jsx(n.li,{children:o.jsx(n.a,{href:"https://web-components.carbondesignsystem.com/?path=/docs/components-button",rel:"nofollow",children:"cds-button"})}),`
`,o.jsx(n.li,{children:"Carousel utility"}),`
`]}),`
`,o.jsx(n.h2,{id:"about-onboarding",children:"About Onboarding"}),`
`,o.jsxs(n.p,{children:[o.jsx(n.a,{href:"https://pages.github.ibm.com/security/security-design/department/end-to-end-experiences/onboarding/overview/",rel:"nofollow",children:"Onboarding"}),`
is a continuous learning methodology and framework that aims to orient, onboard,
explain, educate, and cultivate novice users into high-functioning power users.`]}),`
`,o.jsx(n.h2,{id:"example-usage",children:"Example usage"}),`
`,`
`,o.jsx(ee,{className:"coachmarkExample",withSource:"none",children:o.jsx("div",{className:"CoachmarkBaseExampleUsage",children:o.jsx(te,{of:void 0})})})]})}function oe(t={}){const{wrapper:n}={...R(),...t.components};return n?o.jsx(n,{...t,children:o.jsx(W,{...t})}):W(t)}const $=(t,n,c,s)=>{let d=null,h=null,g=0;const _=400;let m=!1,f=null,v=null;const E=a=>{d=a.touches[0].clientX},z=a=>{h=a.touches[0].clientX},w=()=>{if(d!==null&&h!==null){const a=d-h;Math.abs(a)>50&&(a>0?n():c())}d=null,h=null},k=a=>{m=!0,f=a.clientX},I=a=>{m&&(v=a.clientX)},C=()=>{if(m&&f!==null&&v!==null){const a=f-v;Math.abs(a)>50&&(a>0?n():c())}m=!1,f=null,v=null},u=a=>{const L=Date.now();if(Math.abs(a.deltaX)>Math.abs(a.deltaY)&&Math.abs(a.deltaX)>20){if(a.preventDefault(),L-g<_)return;a.deltaX>0?n():c(),g=L}};s&&(t.removeEventListener("touchstart",E),t.removeEventListener("touchmove",z),t.removeEventListener("touchend",w),t.removeEventListener("mousedown",k),t.removeEventListener("mousemove",I),t.removeEventListener("mouseup",C),t.removeEventListener("wheel",u)),t.addEventListener("touchstart",E),t.addEventListener("touchmove",z),t.addEventListener("touchend",w),t.addEventListener("mousedown",k),t.addEventListener("mousemove",I),t.addEventListener("mouseup",C),t.addEventListener("wheel",u)},ae=(t,n)=>{const c="carousel";let s=[0],y=[0];const d={},h=4,{onViewChangeStart:g,onViewChangeEnd:_,excludeSwipeSupport:m}=n||{},f=(e,i)=>{d[e]=i},v=(e,i)=>{if(e.querySelector(`.${i}`))return;const r=document.createElement("div");for(r.classList.add(`${i}`);e.firstChild;)r.appendChild(e.firstChild);e.appendChild(r)},E=()=>s.map(e=>({id:e,elem:d[e]})),z=()=>{const e=Object.keys(d).length,i=d[e-1],r=E();return{currentIndex:s[0],lastIndex:parseInt(i?.dataset.index||s[0].toString(),10),totalViews:e,historyStack:r}},w=()=>{y=[...s];const e=z();g?.(e)},k=e=>{if(!e)return;const i=e.dataset.index;if(i&&s[0]===parseInt(i,10)){const r=z();_?.(r)}},I=e=>{const r=Object.keys(d).length-1;return Math.max(0,Math.min(e,r))},C=e=>{const i=I(e);s[0]!==i&&(w(),s=[i,...s],V(!1))},u=e=>{k(e)},a=(e,i,r,p,j)=>{e.classList.add(`${c}__view`),e.classList.toggle(`${c}__view-in-stack`,i&&!r),e.classList.toggle(`${c}__view-active`,i&&r),j&&!p&&e.classList.add(`${c}__view-recycle-in`),!j&&p&&e.classList.add(`${c}__view-recycle-out`)},L=e=>{e.classList.remove(`${c}__view-recycle-in`,`${c}__view-recycle-out`)},D=e=>e*parseFloat(getComputedStyle(document.documentElement).fontSize),M=e=>{const i=D(h);if(t.clientHeight<i){e<i&&(e=i);const p=t.querySelector(`.${c}__itemsWrapper`);p&&(p.style.blockSize=`${e}px`)}},V=e=>{let i=0;Array.from(N).forEach((r,p)=>{const j=s.findIndex(b=>b===p),H=y.filter(b=>b===p).length,G=y.length>s.length&&y[0]===p&&H>0,J=y.length<s.length&&s[0]===p&&H>0,K=j>-1,Q=p===s[0];if(a(r,K,Q,G,J),e){f(p,r),setTimeout(()=>{(!i||r.offsetHeight<i&&i>D(h))&&(i=r.offsetHeight),r.style.position="absolute",M(i)});const b=Z=>{L(r),Z.target===d[s[0]]&&u(r)};r._carouselListener=b,r.addEventListener("animationend",b),r.addEventListener("transitionend",b),r.setAttribute("data-index",p.toString())}}),e&&k(Array.from(N)[0])},B=()=>{const e=s[0]+1;C(e)},O=()=>{s.length-1>=1&&(w(),s=s.slice(1),V(!1))},A=e=>{C(e)},P=()=>({index:s[0],item:d[s[0]]}),U=()=>{s=[0],V(!1)},q=()=>{Object.values(d).forEach(e=>{e&&e._carouselListener&&(e.removeEventListener("animationend",e._carouselListener),e.removeEventListener("transitionend",e._carouselListener))}),m||$(t,B,O,!0)},F=e=>{const i=e.querySelector("slot");return i?i.assignedElements({flatten:!0}):Array.from(e.children)};v(t,`${c}__itemsWrapper`);const Y=t.querySelector(`.${c}__itemsWrapper`),N=F(Y);return t.classList.add(`${c}__view-stack`),V(!0),m||$(t,B,O,!1),{next:B,prev:O,reset:U,goToIndex:A,getActiveItem:P,destroyEvents:q,allViews:d}},re=""+new URL("sample-image-Xi2Ah9yk.png",import.meta.url).href,ze={title:"Patterns/Coachmark Overlay Elements",component:()=>{},tags:["autodocs"],parameters:{styles:ie,docs:{page:oe}}};function ce(){const[t,n]=x.useState(()=>document.documentElement.getAttribute("data-carbon-theme"));return x.useEffect(()=>{const c=document.documentElement,s=()=>{const h=c.getAttribute("data-carbon-theme");n(g=>g!==h?h:g)},y=new MutationObserver(h=>{for(const g of h)g.type==="attributes"&&g.attributeName==="data-carbon-theme"&&s()});y.observe(c,{attributes:!0,attributeFilter:["data-carbon-theme"]});const d=setInterval(s,200);return()=>{y.disconnect(),clearInterval(d)}},[]),t}const le=t=>{const n=ce(),[c,s]=x.useState(!0),[y,d]=x.useState(-1),[h,g]=x.useState(-1),_=x.useRef(null),m=x.useRef(null),f=[{id:1,title:"Example 1",text:"This is an example description."},{id:2,title:"Example 2",text:"This is an example description."}],v=()=>{s(!1),m.current.reset()},E=()=>{s(u=>!u)};x.useEffect(()=>{_&&_.current&&(m.current=ae(_.current,{onViewChangeStart:z,onViewChangeEnd:w}))},[m,c]);const z=()=>{},w=u=>{k(u)},k=x.useCallback(({currentIndex:u,lastIndex:a})=>{d(u),g(a)},[]),I=()=>{m.current.next()},C=()=>{m.current.prev()};return l.createElement(ne,{theme:n},l.createElement(T,{position:{x:151,y:155},open:c,onClose:v,align:"top",...t},l.createElement(se,{label:"Show information",buttonProps:{onClick:E,id:"CoachmarkBtn"}}),l.createElement(T.Content,{highContrast:!0},l.createElement(T.Content.Header,{closeIconDescription:"Close"}),l.createElement(T.Content.Body,null,l.createElement("div",null,l.createElement("img",{src:re,style:{width:"100%",marginBottom:"1rem"}})),l.createElement("div",{ref:_,className:"exampleCarouselWrapper"},f.map(u=>l.createElement("div",{key:u.id},l.createElement("h2",null,u.title),l.createElement("p",null,u.text)))),l.createElement("div",{className:"carouselControlWrapper__footer"},l.createElement("div",{className:"carouselControlWrapper--controls-progress"},f.map((u,a)=>{if(m.current?.getActiveItem?.()?.index===a)return l.createElement("span",{key:u.id},`${m.current?.getActiveItem?.()?.index+1} / ${f.length}`)})),l.createElement("div",{className:"carouselControlWrapper--buttons"},y!==0&&l.createElement(X,{size:"sm",iconDescription:"Previous",kind:"ghost",onClick:C},"Back"),h!==y?l.createElement(X,{size:"sm",iconDescription:"Next",onClick:I},"Next"):l.createElement(X,{size:"sm",onClick:v},"Done")))))))},S=le.bind({});S.args={};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`args => {
...
}`,...S.parameters?.docs?.source}}};const we=["CoachmarkOverlay"];export{S as CoachmarkOverlay,we as __namedExportsOrder,ze as default};
