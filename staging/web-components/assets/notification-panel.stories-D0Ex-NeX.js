 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */class O extends P{constructor(){super(...arguments),this.size="lg"}}O.styles=Zt;f([p({type:String,reflect:!0})],O.prototype,"title",void 0);f([p({type:String,reflect:!0})],O.prototype,"subtitle",void 0);f([p({type:String,reflect:!0})],O.prototype,"size",void 0);f([p()],O.prototype,"kind",void 0);f([p({type:String,reflect:!0})],O.prototype,"illustrationTheme",void 0);f([lt()],O.prototype,"hasIllustration",void 0);const s="cds",ht=`
...
`,Qt=o=>class extends o{focus(){if(this.shadowRoot.delegatesFocus)super.focus();else{const e=this.shadowRoot.querySelector(ht)||this.querySelector(ht);e?e.focus():super.focus()}}};var Jt=yt([".cds--link{border:0;box-sizing:border-box;color:var(--cds-link-text-color,var(--cds-link-primary,#0f62fe));display:inline-flex;font-family:inherit;font-size:100%;font-size:var(--cds-body-compact-01-font-size,.875rem);font-weight:var(--cds-body-compact-01-font-weight,400);letter-spacing:var(--cds-body-compact-01-letter-spacing,.16px);line-height:var(--cds-body-compact-01-line-height,1.28572);margin:0;outline:none;padding:0;text-decoration:none;transition:color 70ms cubic-bezier(.2,0,.38,.9);vertical-align:baseline}.cds--link *,.cds--link :after,.cds--link :before{box-sizing:inherit}.cds--link:hover{color:var(--cds-link-hover-text-color,var(--cds-link-primary-hover,#0043ce));text-decoration:underline}.cds--link:active:not(.cds--link--disabled),.cds--link:active:visited,.cds--link:active:visited:hover{color:var(--cds-link-text-color,var(--cds-link-primary,#0f62fe));outline:1px solid var(--cds-focus,#0f62fe);outline-color:var(--cds-link-focus-text-color,var(--cds-focus,#0f62fe));text-decoration:underline}@media screen and (prefers-contrast){.cds--link:active:not(.cds--link--disabled),.cds--link:active:visited,.cds--link:active:visited:hover{outline-style:dotted}}.cds--link:focus:not(.cds--link--disabled){outline:1px solid var(--cds-focus,#0f62fe);outline-color:var(--cds-link-focus-text-color,var(--cds-focus,#0f62fe));text-decoration:underline}@media screen and (prefers-contrast){.cds--link:focus:not(.cds--link--disabled){outline-style:dotted}}.cds--link:visited{color:var(--cds-link-text-color,var(--cds-link-primary,#0f62fe))}.cds--link:visited:hover{color:var(--cds-link-hover-text-color,var(--cds-link-primary-hover,#0043ce))}.cds--link--disabled,.cds--link--disabled:hover{border:0;box-sizing:border-box;color:var(--cds-text-disabled,hsla(0,0%,9%,.25));cursor:not-allowed;font-family:inherit;font-size:100%;font-size:var(--cds-body-compact-01-font-size,.875rem);font-weight:var(--cds-body-compact-01-font-weight,400);font-weight:400;letter-spacing:var(--cds-body-compact-01-letter-spacing,.16px);line-height:var(--cds-body-compact-01-line-height,1.28572);margin:0;padding:0;text-decoration:none;vertical-align:baseline}.cds--link--disabled *,.cds--link--disabled :after,.cds--link--disabled :before,.cds--link--disabled:hover *,.cds--link--disabled:hover :after,.cds--link--disabled:hover :before{box-sizing:inherit}.cds--link.cds--link--visited:visited{color:var(--cds-link-visited-text-color,var(--cds-link-visited,#8a3ffc))}.cds--link.cds--link--visited:visited:hover{color:var(--cds-link-hover-text-color,var(--cds-link-primary-hover,#0043ce))}.cds--link.cds--link--inline{display:inline;text-decoration:underline}.cds--link--disabled.cds--link--inline{text-decoration:underline}.cds--link--sm,.cds--link--sm.cds--link--disabled:hover{font-size:var(--cds-helper-text-01-font-size,.75rem);letter-spacing:var(--cds-helper-text-01-letter-spacing,.32px);line-height:var(--cds-helper-text-01-line-height,1.33333)}.cds--link--lg,.cds--link--lg.cds--link--disabled:hover{font-size:var(--cds-body-compact-02-font-size,1rem);font-weight:var(--cds-body-compact-02-font-weight,400);letter-spacing:var(--cds-body-compact-02-letter-spacing,0);line-height:var(--cds-body-compact-02-line-height,1.375)}.cds--link__icon{align-self:center;display:inline-flex;margin-inline-start:.5rem}:host(cds-link){outline:none}:host(cds-link) .cds--link--disabled{color:var(--cds-text-disabled,hsla(0,0%,9%,.25))}:host(cds-link) .cds--link__icon[hidden]{display:none}"]);const to=(o,e)=>{try{customElements.define(o,e)}catch{console.warn(`Attempting to re-define ${o}`)}return e},oo=(o,e)=>{const{kind:t,elements:i}=e;return{kind:t,elements:i,finisher(n){try{customElements.define(o,n)}catch{console.warn(`Attempting to re-define ${o}`)}}}},eo=o=>e=>typeof e=="function"?to(o,e):oo(o,e),io={MEDIUM:"md"};let y=class extends Qt(P){constructor(){super(...arguments),this._hasIcon=!1,this.disabled=!1,this.inline=!1,this.size=io.MEDIUM,this.visited=!1}_handleSlotChange({target:e}){const{name:t}=e,i=e.assignedNodes().some(n=>n.nodeType!==Node.TEXT_NODE||n.textContent.trim());this[t==="icon"?"_hasIcon":""]=i,this.requestUpdate()}get _classes(){const{disabled:e,size:t,inline:i,visited:n,_hasIcon:a}=this;return k({[`${s}--link`]:!0,[`${s}--link--disabled`]:e,[`${s}--link--icon`]:a,[`${s}--link--inline`]:i,[`${s}--link--${t}`]:t,[`${s}--link--visited`]:n})}_handleClick(e){}_renderInner(){const{_hasIcon:e,_handleSlotChange:t}=this;return r`
    ...
    `}render(){const{disabled:e}=this;return e?this._renderDisabledLink():this._renderLink()}};y.shadowRootOptions=Object.assign(Object.assign({},P.shadowRootOptions),{delegatesFocus:!0});y.styles=Jt;f([dt("#link")],y.prototype,"_linkNode",void 0);f([p({type:Boolean,reflect:!0})],y.prototype,"disabled",void 0);f([p({reflect:!0})],y.prototype,"download",void 0);f([p({reflect:!0})],y.prototype,"href",void 0);f([p({reflect:!0})],y.prototype,"hreflang",void 0);f([p({type:Boolean,reflect:!0})],y.prototype,"inline",void 0);f([p({attribute:"link-role"})],y.prototype,"linkRole",void 0);f([p({reflect:!0})],y.prototype,"ping",void 0);f([p({reflect:!0})],y.prototype,"rel",void 0);f([p({reflect:!0})],y.prototype,"size",void 0);f([p({reflect:!0})],y.prototype,"target",void 0);f([p({reflect:!0})],y.prototype,"type",void 0);f([p({type:Boolean,reflect:!0})],y.prototype,"visited",void 0);y=f([eo(`${s}-link`)],y);let V;const no=new Uint8Array(16);function so(){if(!V&&(V=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!V))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return V(no)}const u=[];for(let o=0;o<256;++o)u.push((o+256).toString(16).slice(1));function ao(o,e=0){return u[o[e+0]]+u[o[e+1]]+u[o[e+2]]+u[o[e+3]]+"-"+u[o[e+4]]+u[o[e+5]]+"-"+u[o[e+6]]+u[o[e+7]]+"-"+u[o[e+8]]+u[o[e+9]]+"-"+u[o[e+10]]+u[o[e+11]]+u[o[e+12]]+u[o[e+13]]+u[o[e+14]]+u[o[e+15]]}const co=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),gt={randomUUID:co};function I(o,e,t){if(gt.randomUUID&&!o)return gt.randomUUID();o=o||{};const i=o.random||(o.rng||so)();return i[6]=i[6]&15|64,i[8]=i[8]&63|128,ao(i)}const{stablePrefix:tt}=T,ro=(o="light",e="large")=>{const t=I(),i=k({[`${tt}--empty-state__illustration`]:!0,[`${tt}--empty-state__illustration-error`]:!0,[`${tt}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
        ...
        `},{stablePrefix:ot}=T,po=(o="light",e="large")=>{const t=I(),i=k({[`${ot}--empty-state__illustration`]:!0,[`${ot}--empty-state__illustration-noData`]:!0,[`${ot}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:et}=T,lo=(o="light",e="large")=>{const t=I(),i=k({[`${et}--empty-state__illustration`]:!0,[`${et}--empty-state__illustration-noTags`]:!0,[`${et}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:it}=T,fo=(o="light",e="large")=>{const t=I(),i=k({[`${it}--empty-state__illustration`]:!0,[`${it}--empty-state__illustration-notFound`]:!0,[`${it}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:nt}=T,vo=(o="light",e="large")=>{const t=I(),i=k({[`${nt}--empty-state__illustration`]:!0,[`${nt}--empty-state__illustration-notification`]:!0,[`${nt}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:st}=T,ho=(o="light",e="lg")=>{const t=I(),i=k({[`${st}--empty-state__illustration`]:!0,[`${st}--empty-state__illustration-unauthorized`]:!0,[`${st}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const{stablePrefix:Y}=T;function go(o){const{title:e,subtitle:t,size:i,kind:n,illustrationTheme:a,hasIllustration:c}=o,z=k({[`${Y}--empty-state__header`]:!0,[`${Y}--empty-state__header--small`]:i==="sm"}),x=k({[`${Y}--empty-state___subtitle`]:!0,[`${Y}--empty-state__subtitle--small`]:i==="sm"});let g;if(!c)switch(n){case"error":g=ro(a,i);break;case"noData":g=po(a,i);break;case"noTags":g=lo(a,i);break;case"notFound":g=fo(a,i);break;case"notifications":g=vo(a,i);break;case"unauthorized":g=ho(a,i);break}return r`
...
}`,...F.parameters?.docs?.source}}};const re=["Default","EmptyState"],yi=Object.freeze(Object.defineProperty({__proto__:null,Default:X,EmptyState:F,__namedExportsOrder:re,default:ce},Symbol.toStringTag,{value:"Module"}));export{yi as N};
