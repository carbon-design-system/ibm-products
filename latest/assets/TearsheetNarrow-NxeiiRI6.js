import{P as e}from"./index-Cd8snwnz.js";import{p as l,B as n}from"./settings-DqneCnpo.js";import{T as p,t as d,p as c}from"./TearsheetShell-Ba8wlB-P.js";import{e as a}from"./index-BOZkNhcz.js";import{p as h,a as m}from"./props-helper-DIx2Ramn.js";import{g as u}from"./devtools-Bjt2CwRv.js";import{A as f}from"./ActionSet-BJEln6zp.js";const o="TearsheetNarrow",y={verticalPosition:"lower"};let t=a.forwardRef(({verticalPosition:s=y.verticalPosition,...r},i)=>a.createElement(p,{...u(o),...h(r,d),verticalPosition:s,ref:i,size:"narrow"}));t=l.checkComponentEnabled(t,o);t.displayName=o;const g={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:m([f.validateActions(()=>"lg"),e.arrayOf(e.shape({...n.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:n.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string,description:e.node,hasCloseIcon:e.bool,label:e.node,onClose:e.func,open:e.bool,portalTarget:c,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...g};t.__docgenInfo={description:`A narrow tearsheet is a slimmer variant of the tearsheet, providing a dialog
