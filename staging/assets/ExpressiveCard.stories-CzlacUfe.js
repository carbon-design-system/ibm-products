import{j as n,p as ie}from"./settings-CljJQLyl.js";import{u as ne,c as le,_ as ce,R as me}from"./floating-ui.react-C-lGofMW.js";import{P as e}from"./index-Dk74W0Oi.js";import{R as de,r as ue}from"./index-BwDkhjyp.js";import{G as oe}from"./Grid-CnkrpUdK.js";import{C as re}from"./Column-RLBd-601.js";import{A as pe,a as ge}from"./index-CMVUDlQd.js";import{S as ye}from"./StoryDocsPage-BdpnhFN0.js";import{a as j}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as he}from"./devtools-C9kUiWhx.js";import{p as fe}from"./props-helper-BM8tfO54.js";import{C as Se}from"./Card-De-1chjP.js";import{b as ve,A as xe}from"./bucket-0-M87sILds.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-B5D95Jtx.js";import"./index-1ulDwjQN.js";import"./index-BONylQH5.js";import"./index-xbyQ_51k.js";import"./bucket-17-ByMkANur.js";import"./index-D6Mwpvt5.js";import"./iframe-C3O3RKYb.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./story-helper-Ba8HmmvT.js";import"./tslib.es6-B4_xh3D5.js";import"./v4-CQkTLCs1.js";import"./index-_4Qtr-t1.js";import"./Text-B6Yb8geH.js";import"./useAttachedMenu-D2EsEGO9.js";import"./mergeRefs-CTUecegF.js";import"./bucket-12-BOhlrMfU.js";import"./wrapFocus-DMN3GZJC.js";import"./index-CUiOlLtv.js";import"./LayerContext-DbU-6VX4.js";import"./bucket-6-CJUP1MJz.js";import"./bucket-9-CfAXSH6D.js";const te=o=>{let{as:t="div",className:i,children:x,ratio:b="1x1",...l}=o;const c=ne(),C=le(i,`${c}--aspect-ratio`,`${c}--aspect-ratio--${b}`);return de.createElement(t,ce({className:C},l),x)};te.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let a=ue.forwardRef((o,t)=>{const i=fe(o,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.jsx(Se,{ref:t,...i,...he(z)})});a=ie.checkComponentEnabled(a,z);a.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),children:e.node,className:e.string,description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};a.displayName=z;a.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
