import{k as L,_ as S,n as k,c as z,p as a,w as M,x as e,l as x}from"./iframe-CRtCEvHj.js";import{S as s,a as I}from"./side-panel-z1o4wdV9.js";import{B as o}from"./button-BPrzbWFT.js";import"./button-skeleton-Bkfs8A1v.js";import"./text-input-fIvTTJ0p.js";import"./text-input-skeleton-qlfwOlhX.js";import"./textarea-skeleton-fsFLHvzS.js";import{I as H}from"./icon-button-Dm8UBGd3.js";import{f as B,g as G}from"./16-Klj0Ejm-.js";import{_ as W}from"./16-CVWqvXKz.js";import{i as A}from"./icon-loader-DNTraskY.js";import"./breadcrumb-skeleton-bmHmtDzq.js";import{s as F,C as Y,i as X}from"./actionable-notification-button-DInYUA9Q.js";const q=".side-panel-stories__body-content{display:flex;flex-direction:column;padding:1rem;gap:1rem}.side-panel-stories__text-inputs{display:flex;gap:1rem}.side-panel-stories__text-inputs>*{flex-basis:50%}.side-panel-stories__story-container{position:fixed;display:grid;block-size:100vh;grid-template-rows:3rem 1fr;inline-size:100vw;inset-block-start:0;inset-inline-start:0}.side-panel-stories__story-header{background:var(--cds-background-inverse, #393939)}.side-panel-stories__story-content{position:relative;display:flex;align-items:center;justify-content:center}.side-panel-stories__custom-header-content{margin-block-end:.5rem}",f=L(q);let T=class extends Y{constructor(){super(...arguments),this.titleId="",this.kind=B.INFO}_renderIcon(){const{statusIconDescription:c,kind:l}=this,{[l]:h}=X;return h?h({class:`${a}--inline-notification__icon`,children:c?M`<title>${c}</title>`:void 0}):void 0}_renderText(){const{subtitle:c,title:l,titleId:h,_type:v}=this;return e`
