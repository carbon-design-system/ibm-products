...
`,e.jsx(U,{})]})}function W(r={}){const{wrapper:t}={...D(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(g,{...r})}):g(r)}const N=""+new URL("abstract-image-KeSi23KF.svg",import.meta.url).href,m={label:"Label",title:"Title",metadata:[{id:"1",icon:r=>n.createElement(B,{size:16,...r}),iconDescription:"2 mins"},{id:"2",icon:r=>n.createElement(F,{size:16,...r}),iconDescription:"Beginner"}],footerActionIcon:r=>n.createElement(K,{size:16,...r}),onClick:M("on click")},De={title:"Experimental/Onboarding/GetStartedCard",component:o,tags:["autodocs"],parameters:{docs:{page:W}},decorators:[r=>{const t=_();return n.createElement("div",{className:`${t}--grid`},r())}]},p=r=>{const{children:t,...A}=r;return n.createElement(o,{label:"Prepare your data",title:"Generate synthetic Tabular data",...A},t)},i=p.bind({});i.args={...m,pictogram:r=>n.createElement(R,{size:32,...r})};const s=p.bind({});s.args={...m,sequence:3};const d=p.bind({});d.args={...m,pictogram:r=>n.createElement(R,{size:32,...r}),media:n.createElement("img",{src:N,alt:"abstract Image"})};const c=p.bind({});c.args={...m,sequence:3,media:n.createElement("img",{src:N,alt:"abstract Image"})};const l=p.bind({});l.args={...m,sequence:3,disabled:!0};var b,y,x;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`opts => {
  const {
    children,
    ...args
  } = opts;
...
}`,...(x=(y=i.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var j,C,v;s.parameters={...s.parameters,docs:{...(j=s.parameters)==null?void 0:j.docs,source:{originalSource:`opts => {
  const {
    children,
    ...args
  } = opts;
...
}`,...(v=(C=s.parameters)==null?void 0:C.docs)==null?void 0:v.source}}};var S,w,T;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`opts => {
  const {
    children,
    ...args
  } = opts;
...
}`,...(T=(w=d.parameters)==null?void 0:w.docs)==null?void 0:T.source}}};var q,G,P;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:`opts => {
  const {
    children,
    ...args
  } = opts;
...
}`,...(P=(G=c.parameters)==null?void 0:G.docs)==null?void 0:P.source}}};var E,O,k;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`opts => {
  const {
    children,
    ...args
  } = opts;
...
}`,...(k=(O=l.parameters)==null?void 0:O.docs)==null?void 0:k.source}}};const Re=["Default","withSequence","withMediaAndPictogram","withMediaAndSequence","withDisabled"];export{i as Default,Re as __namedExportsOrder,De as default,l as withDisabled,d as withMediaAndPictogram,c as withMediaAndSequence,s as withSequence};
