import{R as n,r as se}from"./index-BwDkhjyp.js";import{b as ne,c as le,_ as ce,$ as me}from"./index-CQ0F2wkl.js";import{P as e}from"./index-Dk74W0Oi.js";import{G as te}from"./Grid-DmYr0bLG.js";import{C as oe}from"./Column-n48QE4UZ.js";import{A as de,a as ue}from"./index-DJMs1yu9.js";import{S as pe}from"./StoryDocsPage-DVIWh70a.js";import{a as E}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as ge}from"./devtools-Bz70ioU6.js";import{p as ye}from"./settings-xiNX1vM3.js";import{p as fe}from"./props-helper-BS5A6Pu3.js";import{C as he}from"./Card-CYidTSQ1.js";import{b as be,A as Se}from"./bucket-0-DyNWBZ5j.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-BONylQH5.js";import"./index-ABeo-Xma.js";import"./bucket-17-B1XGOcQQ.js";import"./index-CTiS1d2M.js";import"./iframe-t6fBb6Y8.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./story-helper-6_fmjwZ-.js";import"./tslib.es6-B4_xh3D5.js";import"./v4-CQkTLCs1.js";import"./index-CJvxHwuA.js";import"./events-OVwOsPzJ.js";import"./MenuItem-BnQb4tLm.js";import"./useControllableState-DwpxGhsf.js";import"./useAttachedMenu-DuO3mIji.js";import"./Text-BiMgJRID.js";import"./bucket-2-DlXCnOsR.js";import"./index-Bp_RdxBV.js";import"./mergeRefs-CTUecegF.js";import"./bucket-12-C1h62Pz5.js";import"./wrapFocus-0D7LLA53.js";import"./index-CvBNEhOa.js";import"./LayerContext-DbU-6VX4.js";import"./bucket-6-DBBo9VQm.js";import"./bucket-9-BGCJpvdq.js";const re=t=>{let{as:r="div",className:s,children:v,ratio:C="1x1",...l}=t;const c=ne(),x=le(s,`${c}--aspect-ratio`,`${c}--aspect-ratio--${C}`);return n.createElement(r,ce({className:x},l),v)};re.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let i=se.forwardRef((t,r)=>{const s=fe(t,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.createElement(he,{ref:r,...s,...ge(z)})});i=ye.checkComponentEnabled(i,z);i.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),aiLabel:e.oneOfType([e.node,e.bool]),children:e.node,className:e.string,description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};i.displayName=z;i.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
