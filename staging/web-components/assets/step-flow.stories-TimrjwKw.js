import{z as x,r as $,E as l,x as a,n as k,A as w}from"./iframe-j3bhT_D8.js";import{o as I}from"./index-DNMjEL-O.js";import{S as C}from"./step-group-Dmh_osBk.js";import{r as n}from"./state-zYQCmPVu.js";import"./progress-step-CSkXF701.js";import"./stack-Djv_KAl2.js";import"./code-snippet-skeleton-BqsbBfox.js";import"./tearsheet-CMbi_RcW.js";import{r as F,t as P}from"./manageFocusTrap-IXE3mZn1.js";import"./button-B9IpL7du.js";import"./button-skeleton-sMxbtBle.js";import"./grid-BP-4DXIZ.js";import"./side-panel-DANidG45.js";import"./text-input-DNpuLfFd.js";import"./text-input-skeleton-Bf9HZcqN.js";import"./preload-helper-PPVm8Dsz.js";import"./collection-helpers-DS5mzmOk.js";import"./icon-loader-5On6LiET.js";import"./class-map-BXLIDRHY.js";import"./skeleton-text-Bf1JHkcV.js";import"./16-Ci-Iy0jC.js";import"./16-D3CzXAJU.js";import"./icon-button-XV8CNuyC.js";import"./definition-tooltip-CHsVGe9e.js";import"./host-listener-DN1-XIwx.js";import"./deep-shadow-contains-BoPypEO0.js";import"./popover-content-CW50EdPy.js";import"./16-iEvmxbCa.js";import"./style-map-CTGlC5Vy.js";import"./16-D0aIqdwb.js";import"./query-assigned-elements-DWK28A8R.js";import"./layer-CDsFIyxc.js";import"./modal-label-XtgHdwiu.js";import"./inline-loading-D8FfaZrG.js";import"./16-DSuDh1sQ.js";import"./20-CvqWH37X.js";import"./consume-DI2TaawZ.js";import"./16-803qFA73.js";import"./16-D5maUdCH.js";import"./resizer-panel-Dk_YWRVk.js";import"./tslib.es6-Cdhlq9ds.js";import"./action-set-HAxdSYUz.js";import"./ref-DxZXqfwn.js";import"./form-BTpacr1I.js";import"./validity-CzEiVmrf.js";import"./if-non-empty-DmVRupGx.js";import"./16-C1hWzIbz.js";import"./16-B8NH1ntc.js";const z="#storybook-root #main-content{padding:0}",S=x(z);var O=Object.defineProperty,T=Object.getOwnPropertyDescriptor,h=(e,t,s,r)=>{for(var o=r>1?void 0:r?T(t,s):t,i=e.length-1,p;i>=0;i--)(p=e[i])&&(o=(r?p(t,s,o):p(o))||o);return r&&o&&O(t,s,o),o};let c=class extends I($){constructor(){super(...arguments),this.narrow=!1,this._open=!1,this._email="",this._city="",this._state="",this._trapFocusAPI=null,this._stepInfo=new C}_onButtonClick(){this._open=!0}_handleCancelButton(){this._open=!1,this._stepInfo.reset()}_handleBackButton(){const{currentStep:e}=this._stepInfo.data;if(e!==0)return this._stepInfo.handlePrevious()}_handleNextButton(){const{currentStep:e,totalSteps:t}=this._stepInfo.data;if(e+1===t){this._open=!1,this._stepInfo.reset();return}return this._stepInfo.handleNext()}_handleEmailInput(e){const t=structuredClone(this._stepInfo.data.formState);t.email=e.target.value,this._stepInfo.updateFormState=t}_handleCityInput(e){const t=structuredClone(this._stepInfo.data.formState);t.city=e.target.value,this._stepInfo.updateFormState=t}_handleStateInput(e){const t=structuredClone(this._stepInfo.data.formState);t.state=e.target.value,this._stepInfo.updateFormState=t}connectedCallback(){super.connectedCallback(),this._stepInfo.updateTotalStepCount=3}disconnectedCallback(){this._trapFocusAPI?.cleanup()}firstUpdated(e){F(this.shadowRoot?.querySelector("c4p-tearsheet"))}updated(e){e.has("_open")&&this._open&&(this._trapFocusAPI=P())}render(){const{formState:e,totalSteps:t,currentStep:s}=this._stepInfo.data;return a` <cds-button
        type="button"
        size="md"
