    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset={0.43} stopColor="#e4e4e4" stopOpacity={0.87} />
          <stop offset={0.55} stopColor="#e7e7e7" stopOpacity={0.76} />
          <stop offset={0.67} stopColor="#ececec" stopOpacity={0.62} />
          <stop offset={0.78} stopColor="#f1f1f1" stopOpacity={0.45} />
          <stop offset={0.89} stopColor="#f7f7f7" stopOpacity={0.25} />
          <stop offset={0.99} stopColor="#fefefe" stopOpacity={0.03} />
        ...
        <style>
          {
            '.prefix__cls-1{fill:none}.prefix__cls-80{opacity:.25}.prefix__cls-75{fill:#595655}.prefix__cls-76{opacity:.15}.prefix__cls-77{fill:#373d42}.prefix__cls-78{fill:#002b50}.prefix__cls-80{mix-blend-mode:multiply}.prefix__cls-81{fill:#2b2828}'
          }
        </style>
      </defs>
      <g
      ...
      >
        <g id="prefix__Layer_1" data-name="Layer 1">
          ...
          />
          <path className="prefix__cls-76" d="M279.14 489.68z" />
          <ellipse
            className="prefix__cls-77"
            cx={244.95}
            cy={586.07}
