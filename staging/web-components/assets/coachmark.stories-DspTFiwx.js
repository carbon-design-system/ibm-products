import{A as f,r as b,d as a,E as w,x as h,n as y,c as k}from"./iframe-BoCQr2sp.js";import{u as D,c as x}from"./coachmark-beacon-CRw9uStn.js";import"./button-zsE1n1Bb.js";import"./button-skeleton-BKVbevEW.js";import{H as $}from"./host-listener-DN1-XIwx.js";import{_ as P}from"./16-D5maUdCH.js";import{_ as O}from"./16-BJ-s22c-.js";import{o as v}from"./index-BBvoEKsi.js";import{i as m}from"./icon-loader-BqrhyFhm.js";import{P as e}from"./popover-content-mhoElPR3.js";import{_ as F}from"./16-B_l_7QwJ.js";const I=":host(c4p-coachmark-header){display:flex;justify-content:flex-end}:host(c4p-coachmark-header) .c4p--coachmark-header-drag-handle{margin-inline-end:auto}:host(c4p-coachmark-header) .c4p--coachmark-header-drag-icon{fill:var(--cds-background, #ffffff)}:host(c4p-coachmark-header) .c4p--coachmark-header-close-icon{fill:var(--cds-background, #ffffff)}",E=f(I);var z=Object.defineProperty,H=Object.getOwnPropertyDescriptor,u=(o,r,i,c)=>{for(var t=c>1?void 0:c?H(r,i):r,n=o.length-1,s;n>=0;n--)(s=o[n])&&(t=(c?s(r,i,t):s(t))||t);return c&&t&&z(r,i,t),t};let p=class extends v($(b)){constructor(){super(...arguments),this.closeIconDescription="",this.dragIconDescription="",this._handleClick=o=>{o.stopPropagation();const r=this.closest(`${a}-coachmark`);r&&(r.dispatchEvent(new CustomEvent(`${a}-coachmark-request-close`,{bubbles:!0,composed:!0,cancelable:!0,detail:{source:"header-close-button"}})),r.open=!1),D({name:"open",detail:!1})}}render(){const{floating:o}=x.get();return h`
    ...
    `},B={title:"Components/Onboarding/Coachmark"};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    ...args,
    align: 'bottom',
    caret: true,
...
}`,...d.parameters?.docs?.source}}};const W=["Tooltip","Floating"],eo=Object.freeze(Object.defineProperty({__proto__:null,Floating:d,Tooltip:l,__namedExportsOrder:W,default:B},Symbol.toStringTag,{value:"Module"}));export{eo as C,d as F,l as T};
