  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig(stories.fullPageError, stories.fullPageError.args),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(stories.fullPageError403, stories.fullPageError403.args),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(stories.fullPageError404, stories.fullPageError404.args),
    },
  ]}
/>
