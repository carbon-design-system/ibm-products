import{P as e}from"./index-CXyjPnaX.js";import{p,B as a}from"./settings-DkGFwmHv.js";import{e as o}from"./index-CPiZ6Cnx.js";import{T as d,p as h}from"./TearsheetShell-Cac5arl4.js";import{a as c}from"./props-helper-C4XfpXsc.js";import{g as m}from"./devtools-BgfuqBVa.js";import{A as f}from"./ActionSet-niQNGcwi.js";const n="Tearsheet";let t=o.forwardRef(({influencerPosition:i="left",influencerWidth:r="narrow",...s},l)=>o.createElement(d,{...m(n),...s,influencerPosition:i,influencerWidth:r,ref:l,size:"wide"}));t=p.checkComponentEnabled(t,n);t.displayName=n;const u={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:c([f.validateActions(()=>"2xl"),e.arrayOf(e.shape({...a.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:a.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string,description:e.node,hasCloseIcon:e.bool,headerActions:e.element,influencer:e.element,influencerPosition:e.oneOf(["left","right"]),influencerWidth:e.oneOf(["narrow","wide"]),label:e.node,launcherButtonRef:e.any,navigation:e.element,onClose:e.func,open:e.bool,portalTarget:h,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...u};t.__docgenInfo={description:`A tearsheet is a mostly full-screen type of dialog that keeps users
...
to allow an action bar navigation or breadcrumbs to also show through.`,type:{name:"enum",value:[{value:"'normal'",computed:!1},{value:"'lower'",computed:!1}]}},launcherButtonRef:{description:"Provide a ref to return focus to once the tearsheet is closed.",type:{name:"any"},required:!1}},composes:["PropsWithChildren"]};export{t as T,u as d};
