...
import createTearsheetGif from '../CreateTearsheet/storybook_assets/create_tearsheet.gif';
import createTearsheetAnatomy from '../CreateTearsheet/storybook_assets/create_tearsheet_anatomy.jpg';
