import{e as n,r as se}from"./index-BOZkNhcz.js";import{b as ne,c as ce,_ as le,P as e,a3 as me}from"./index--clQM3eT.js";import{G as oe}from"./Grid-D2-CuTqT.js";import{C as re}from"./Column-DDtOIyjn.js";import{T as de,a as pe,b as ue,A as ge,c as ye}from"./index-CKq6Ewiq.js";import{S as fe}from"./StoryDocsPage-CSGBKR-8.js";import{a as E}from"./chunk-D5ZWXAHU-DlerbUHg.js";import{g as he}from"./devtools-BSXGZlBP.js";import{p as be}from"./settings-BYgtfLKl.js";import{p as Se}from"./props-helper-BNocl_Zr.js";import{C as ve}from"./Card-8A-NkwsR.js";import{e as Ce}from"./bucket-9-C6VBS02H.js";import{b as xe,A as ze}from"./bucket-0-tjTgXQWL.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-hBZdtWkn.js";import"./index-2uioG_CI.js";import"./index-YZUn1U4D.js";import"./bucket-17-Dbz5FtJu.js";import"./index-k6DjlwLo.js";import"./iframe-CFrrarbq.js";import"./index-CO8sV34W.js";import"./index-ogSvIofg.js";import"./story-helper-DEC8H8IF.js";import"./v4-CtRu48qb.js";import"./events-OVwOsPzJ.js";import"./MenuItem-BSeNOHR5.js";import"./useControllableState-BHFQnaNh.js";import"./useAttachedMenu-BS0JXRSz.js";import"./Text-C-NQiyV2.js";import"./bucket-2-rFuAlaTW.js";import"./index-0E3e6jj2.js";import"./mergeRefs-CTUecegF.js";import"./bucket-12-BQFRxjkG.js";import"./wrapFocus-DuCohhwL.js";import"./index-_87NmGAs.js";import"./LayerContext-DxTbsTfh.js";import"./bucket-6-B5NNCZ27.js";const te=o=>{let{as:t="div",className:l,children:v,ratio:C="1x1",...i}=o;const s=ne(),x=ce(l,`${s}--aspect-ratio`,`${s}--aspect-ratio--${C}`);return n.createElement(t,le({className:x},i),v)};te.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let c=se.forwardRef((o,t)=>{const l=Se(o,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.createElement(ve,{ref:t,...l,...he(z)})});c=be.checkComponentEnabled(c,z);c.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),children:e.node,className:e.string,decorator:e.oneOfType([e.node,e.bool]),description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};c.displayName=z;c.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
