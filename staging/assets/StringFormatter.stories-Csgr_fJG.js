import{p as _,j as e}from"./settings-Bk-Ww79A.js";import{useMDXComponents as F}from"./index-DlpNa54Y.js";import"./chunk-HLWAVYOI-D4RjTd1I.js";import{e as w,i as R,C as E}from"./index-TffMvrPM.js";import{R as P}from"./index-BwDkhjyp.js";import{P as l}from"./index-Dk74W0Oi.js";import{c as g}from"./useMergedRefs-DoviDd4t.js";import{g as D}from"./devtools-jK7s13u1.js";import{D as A}from"./DefinitionTooltip-D-5Wnfe9.js";import{a as M}from"./props-helper-DKwMo5Mj.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-CiqBCP_Q.js";import"./index-8ToAQMOn.js";import"./index-BONylQH5.js";import"./iframe-DrDxz63W.js";import"../sb-preview/runtime.js";import"./react-18-Dd3bHtks.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-BjQFKvNH.js";import"./isSymbol-BZYRlrjc.js";import"./index-DrFu-skq.js";const n={TOP:"top",TOP_LEFT:"top-left",TOP_RIGHT:"top-right",BOTTOM:"bottom",BOTTOM_LEFT:"bottom-left",BOTTOM_RIGHT:"bottom-right",LEFT:"left",LEFT_BOTTOM:"left-bottom",LEFT_TOP:"left-top",RIGHT:"right",RIGHT_BOTTOM:"right-bottom",RIGHT_TOP:"right-top"},r={TOP:"top",TOP_START:"top-start",TOP_END:"top-end",BOTTOM:"bottom",BOTTOM_START:"bottom-start",BOTTOM_END:"bottom-end",LEFT:"left",LEFT_END:"left-end",LEFT_START:"left-start",RIGHT:"right",RIGHT_END:"right-end",RIGHT_START:"right-start"},N=o=>({[n.TOP_LEFT]:r.TOP_START,[n.TOP_RIGHT]:r.TOP_END,[n.BOTTOM_LEFT]:r.BOTTOM_START,[n.BOTTOM_RIGHT]:r.BOTTOM_END,[n.LEFT_BOTTOM]:r.LEFT_END,[n.LEFT_TOP]:r.LEFT_START,[n.RIGHT_BOTTOM]:r.RIGHT_END,[n.RIGHT_START]:r.RIGHT_START})[o],p=`${_.prefix}--string-formatter`,u="StringFormatter",d={lines:1,tooltipDirection:r.BOTTOM_START,truncate:!1,width:null};let a=P.forwardRef(({className:o,lines:t=d.lines,tooltipDirection:m=d.tooltipDirection,truncate:s=d.truncate,width:h=d.width,value:c,...S},j)=>{const T=e.jsx("span",{className:g(`${p}--content`,{[`${p}--truncate`]:s}),style:{maxWidth:h,WebkitLineClamp:t},children:c});return e.jsx("span",{...S,className:g(p,o),ref:j,...D(u),children:s?e.jsx(A,{className:`${p}__tooltip`,align:m,definition:c,openOnHover:!0,children:T}):T})});a=_.checkComponentEnabled(a,u);a.displayName=u;a.validateAlignment=()=>(o,t,m)=>{const s=o[t];if(Object.values(n).includes(s)){const c=N(s);console.warn(`"${s}" is a deprecated value for the "${t}" prop on the "${m}" component. Use "${c}" instead. Allowable values are: ${Object.values(r).join(", ")}.`)}};a.propTypes={className:l.string,lines:l.number,tooltipDirection:M([a.validateAlignment(),l.oneOf(Object.values(n),Object.values(r))]),truncate:l.bool,value:l.string.isRequired,width:l.string};a.__docgenInfo={description:`StringFormatter allows for truncating text while displaying a tooltip
...
NB no need for a 'Playground' because all stories have all controls anyway.`,...(y=(x=i.parameters)==null?void 0:x.docs)==null?void 0:y.description}}};const ce=["stringFormatter"];export{ce as __namedExportsOrder,le as default,i as stringFormatter};
