import"./index-CQ0F2wkl.js";import{p,B as i}from"./settings-xiNX1vM3.js";import{R as r}from"./index-BwDkhjyp.js";import{T as d,t as h,p as c}from"./TearsheetShell-DGNFyaak.js";import{P as e}from"./index-Dk74W0Oi.js";import{a as m}from"./props-helper-BS5A6Pu3.js";import{g as f}from"./devtools-Bz70ioU6.js";import{A as u}from"./ActionSet-DKjZKKQp.js";const o="Tearsheet";let t=r.forwardRef(({influencerPosition:n="left",influencerWidth:a="narrow",...s},l)=>r.createElement(d,{...f(o),...s,influencerPosition:n,influencerWidth:a,ref:l,size:"wide"}));t=p.checkComponentEnabled(t,o);t.displayName=o;const y={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:m([u.validateActions(()=>"2xl"),e.arrayOf(e.shape({...i.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:i.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:n,hasCloseIcon:a})=>h(n,a)),description:e.node,hasCloseIcon:e.bool,headerActions:e.element,influencer:e.element,influencerPosition:e.oneOf(["left","right"]),influencerWidth:e.oneOf(["narrow","wide"]),label:e.node,launcherButtonRef:e.any,navigation:e.element,onClose:e.func,open:e.bool,portalTarget:c,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...y};t.__docgenInfo={description:`A tearsheet is a mostly full-screen type of dialog that keeps users
