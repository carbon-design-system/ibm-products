import{j as y,n as f,r as g,x as p,u as _}from"./iframe-B2dGZ3uq.js";import{_ as b,a as w,b as C,c as z,d as D,e as O,f as x,g as A,h as S,i as I,j as k}from"./16-DYrvuIVq.js";import{_ as P}from"./16-D6PKKtR4.js";import{i as n}from"./icon-loader-Cf7p-8D_.js";import{a as T}from"./query-DAIS6qJ0.js";import{e as H}from"./class-map-tNNkCSzW.js";import{c as m}from"./repeat-Bh9XyU8Y.js";import"./button-DVr7o_tG.js";import"./button-skeleton-D8YftpuT.js";import"./overflow-menu-item-5Z3vevkK.js";import"./documentLang-E105Y72C.js";import{L as j}from"./overflowHandler-6nRVSJRW.js";import{s as L}from"./story-styles-DdhFGuq2.js";import"./preload-helper-PPVm8Dsz.js";import"./collection-helpers-Cnsts1JG.js";import"./icon-button-BjUtidcR.js";import"./definition-tooltip-BVXyj3o2.js";import"./popover-content-DKTuhRDn.js";import"./state-Cj-ErXDi.js";/**
 * @license
 *
 ...
 */const F="Run Deploy Build Test Scan Format Debug Profile Analyze Sync Upload",u=F.split(/\s+/),v=[()=>n(b,{slot:"icon"}),()=>n(w,{slot:"icon"}),()=>n(C,{slot:"icon"}),()=>n(z,{slot:"icon"}),()=>n(D,{slot:"icon"}),()=>n(O,{slot:"icon"}),()=>n(x,{slot:"icon"}),()=>n(P,{slot:"icon"}),()=>n(A,{slot:"icon"}),()=>n(S,{slot:"icon"}),()=>n(I,{slot:"icon"})];function $({count:a,size:t,onClick:o=i=>alert(`Clicked action: ${i}`)}){return Array.from({length:a},(i,e)=>{const s=u[e%u.length],c=v[e%v.length];return{text:s,icon:c(),size:t,onClick:()=>o(s)}})}$({count:12});const R=":host .c4p--set-of-actions{height:100%}:host .c4p--set-of-actions cds-button:not(:defined),:host .c4p--set-of-actions cds-overflow-menu:not(:defined){display:none}:host .c4p--set-of-actions--horizontal{display:flex}:host .c4p--set-of-actions--vertical{display:inline-flex;flex-direction:column}:host .c4p--set-of-actions__overflow-svg{align-self:unset;color:var(--cds-icon-primary, #161616)}:host .c4p--set-of-actions [data-floating-menu-container]{position:relative}:host .c4p--set-of-actions [data-hidden]:not([data-fixed]){display:none}",U=y(R);var W=Object.defineProperty,q=Object.getOwnPropertyDescriptor,l=(a,t,o,i)=>{for(var e=i>1?void 0:i?q(t,o):t,s=a.length-1,c;s>=0;s--)(c=a[s])&&(e=(i?c(t,o,e):c(e))||e);return i&&e&&W(t,o,e),e};const h="c4p--set-of-actions";let r=class extends g{constructor(){super(...arguments),this.hiddenItems=[],this.actionsData=[],this.orientation=""}connectedCallback(){super.connectedCallback(),this.style.visibility="hidden"}firstUpdated(){this.container&&this.updateComplete.then(()=>{setTimeout(()=>{this.setupOverflowHandler(),this.style.visibility="visible"})})}updated(t){t.has("actionsData")&&this.updateComplete.then(()=>{this.hiddenItems=[],setTimeout(()=>this.setupOverflowHandler())}),this.hiddenItems.length||this.shadowRoot?.querySelector("[data-hidden]:not([data-offset])")?.removeAttribute("data-hidden")}setupOverflowHandler(){this.container&&(this.overflowHandler?.disconnect(),this.overflowHandler=j({container:this.container,dimension:this.orientation=="horizontal"?"width":"height",onChange:(t,o)=>{this.hiddenItems=this.actionsData?.slice(t.length)}}))}disconnectedCallback(){super.disconnectedCallback(),this.overflowHandler?.disconnect()}render(){return p`
      ...
      >
        ...
        >
          ...
          >
            ${n(k,{class:`${h}__overflow-svg`,slot:"icon"})}
