import{j as e,aB as l,aC as g,e as i,c as b}from"./iframe-BpnXlfCj.js";import{useMDXComponents as s}from"./index-QCBC86FQ.js";import{I as d,a as k,b as f}from"./InlineTipLink-D4EISlxT.js";import"./index-CBLguE03.js";import"./devtools-ChJlzgtM.js";import"./uuidv4-BN2rGLQG.js";import"./bucket-9-lCgH83Sx.js";import"./Link-DVHh8Q_B.js";import"./bucket-10-BwRafF_B.js";function c(t){const n={a:"a",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"inlinetip",children:"InlineTip"}),`
...
`,e.jsx(g,{})]})}function I(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(c,{...t})}):c(t)}const j=".storybook--inline-tip-wide{margin-block-start:2rem;max-inline-size:784px}.storybook--inline-tip-narrow{margin-block-start:2rem;max-inline-size:348px}",T=""+new URL("sample-image-Xi2Ah9yk.png",import.meta.url).href,{action:o}=__STORYBOOK_MODULE_ACTIONS__,N={title:"Preview Candidate/Onboarding/InlineTip",component:d,tags:["autodocs","Onboarding"],parameters:{styles:j,layout:"padded",docs:{page:I}},argTypes:{action:{options:["None","<InlineTipButton>","<InlineTipLink>"],control:{type:"radio"}},renderMedia:{options:["None","Render a static image"],control:{type:"radio"}},narrow:{control:{type:null}}}},p={children:i.createElement("ul",null,i.createElement("li",null,"Use ",i.createElement("b",null,"case-specific")," content that explains the concept or adds context."),i.createElement("li",null,"Use case-specific ",i.createElement("i",null,"content that")," explains the concept or adds context."),i.createElement("li",null,"Use case-specific content that explains the concept or adds context.")),closeIconDescription:"Close",collapseButtonLabel:"Read less",collapsible:!1,action:"None",expandButtonLabel:"Read more",renderMedia:"None",onClick:()=>{o("Clicked the tertiary button")()},onClose:()=>{o("Clicked the close button")()},title:"Use case-specific heading",withLeftGutter:!1},m=t=>{const{renderMedia:n,narrow:h,action:u}=t,x=function(){switch(n){case"Render a static image":return()=>i.createElement("img",{alt:"",src:T});default:return null}}(),w=function(){switch(u){case"<InlineTipButton>":return i.createElement(f,{onClick:()=>{o("Clicked the action button")()}},"Click me");case"<InlineTipLink>":return i.createElement(k,{href:"https://www.ibm.com",onClick:()=>{o("Clicked the link")()},target:"_blank"},"Learn more");default:return null}}();return i.createElement("div",{className:b([h?"storybook--inline-tip-narrow":"storybook--inline-tip-wide"])},i.createElement(d,{...t,renderMedia:x,action:w}))},r=m.bind({});r.args={narrow:!1,...p};const a=m.bind({});a.args={narrow:!0,...p};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => {
  const {
    renderMedia,
    narrow,
...
}`,...a.parameters?.docs?.source}}};const O=["inlineTip","inlineTipNarrow"];export{O as __namedExportsOrder,N as default,r as inlineTip,a as inlineTipNarrow};
//# sourceMappingURL=InlineTip.stories-DiU5RQSd.js.map
