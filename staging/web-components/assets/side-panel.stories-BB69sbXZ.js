import{k as _,x as o,l as y}from"./iframe-DQyJnm4A.js";import{S as s,a as $}from"./side-panel-C1d0mpgj.js";import{B as e}from"./button-CHqLvRPl.js";import"./button-skeleton-C49ZPxKy.js";import"./text-input-CvoNNrmP.js";import"./text-input-skeleton-DLJEECqq.js";import"./textarea-skeleton-BWw9RSEG.js";import{I as E}from"./icon-button-HhyAlveC.js";import{_ as O}from"./16-gUhxGjnI.js";import{_ as R}from"./16-CVWqvXKz.js";import{i as T}from"./icon-loader-D1vPuoPv.js";import"./breadcrumb-skeleton-DMih6Exn.js";import"./toast-notification-BD934h5E.js";import"./actionable-notification-button-NLElTe8l.js";import"./callout-notification-BbTgy14K.js";import"./preload-helper-PPVm8Dsz.js";import"./state-C7rvMkZ9.js";import"./query-D0jTsbLw.js";import"./query-assigned-elements-CblsR2sJ.js";import"./class-map-DFp88DkL.js";import"./16-803qFA73.js";import"./16-D5maUdCH.js";import"./index-gRrbDvJ2.js";import"./layer-g2Yniqkx.js";import"./16-Dm3JyFkI.js";import"./validity-CUJaV9kI.js";import"./definition-tooltip-BdTBEypy.js";import"./popover-content-D05arJAW.js";import"./floating-controller-oBvGnMaE.js";import"./link-DVDmmdaT.js";const w=".side-panel-stories__body-content{flex-direction:column;gap:1rem;padding:1rem;display:flex}.side-panel-stories__text-inputs{gap:1rem;display:flex}.side-panel-stories__text-inputs>*{flex-basis:50%}.side-panel-stories__story-container{grid-template-rows:3rem 1fr;block-size:100vh;inline-size:100vw;display:grid;position:fixed;inset-block-start:0;inset-inline-start:0}.side-panel-stories__story-header{background:var(--cds-background-inverse,#393939)}.side-panel-stories__story-content{justify-content:center;align-items:center;display:flex;position:relative}.side-panel-stories__custom-header-content{margin-block-end:.5rem}",c=_(w),i="side-panel-stories__",f=t=>{switch(t){case 1:return o`
        <style>
          ${c}
        </style>
        <h5>Section</h5>
      ...
      `:null,I=t=>{switch(t){case 1:return o`<cds-button key="p" slot="actions" kind=${e.PRIMARY}
        >Primary</cds-button
      >`;case 2:return o`
      ...
      `;case 3:return o` <cds-button slot="actions" kind=${e.DANGER}
        ...
        <cds-button slot="actions" kind=${e.PRIMARY}
          >Primary</cds-button
        >`;case 4:return o` <cds-button slot="actions" kind=${e.GHOST}
          >Ghost</cds-button
        >
        ...
        <cds-button slot="actions" kind=${e.PRIMARY}
          >Primary</cds-button
        >`;case 5:return o`<cds-button
          key="danger"
          slot="actions"
          kind=${e.DANGER}
          >Danger</cds-button
        >
        <cds-button key="secondary" slot="actions" kind=${e.SECONDARY}
          >Secondary</cds-button
        >
        <cds-button key="primary" slot="actions" kind=${e.PRIMARY}
          >Primary</cds-button
        >`;case 6:return o`<cds-button
          key="danger"
          slot="actions"
          kind=${e.DANGER}
          >Danger</cds-button
        >
        <cds-button key="tertiary" slot="actions" kind=${e.TERTIARY}
          >Tertiary</cds-button
        >
        <cds-button key="secondary" slot="actions" kind=${e.SECONDARY}
          >Secondary</cds-button
        ...
        </div>`;default:return null}},S=()=>{document.querySelector(`${y}-side-panel`)?.toggleAttribute("open")},A=()=>{document.querySelector(`${y}-side-panel`)?.setAttribute("current-step","1")},k=()=>{document.querySelector(`${y}-side-panel`)?.setAttribute("current-step","0")},P={[`Extra small size (${s.EXTRA_SMALL})`]:s.EXTRA_SMALL,[`Small size (${s.SMALL})`]:s.SMALL,[`Medium size (default) (${s.MEDIUM})`]:s.MEDIUM,[`Large size (${s.LARGE})`]:s.LARGE,[`Extra Extra Large size (${s.EXTRA_EXTRA_LARGE})`]:s.EXTRA_EXTRA_LARGE},N={left:$.LEFT,"right (default)":$.RIGHT},D={Empty:0,"Brief content":1,"Longer content":2},l="side-panel-stories__",z={"No label":0,"Shorter label":1,"Longer label":2},C=t=>{switch(t){case 1:return"A short label";case 2:return"A longer label that might go on for a little bit";default:return""}},H={"No subtitle":0,"Short subtitle":1,"Longer subtitle":2},M={"No action toolbar":0,"With action toolbar":1},B={"No actions":0,"One button":1,"Two buttons with ghost":2,"Two buttons with danger":3,"Three buttons with ghost":4,"Three buttons with danger":5,"Too many buttons":6},G={"No Slug":0,"With Slug":1},W={"No custom header components":0,"With custom components above title":1,"With custom components below title":2,"With custom components above & below title":3},Y=Object.values(E),n={args:{actionItems:1,actionToolbarItems:0,animateTitle:!0,class:"a-user-class",closeIconDescription:"Close panel",closeIconTooltipAlignment:"left",condensedActions:!1,content:2,includeOverlay:!0,label:2,open:!1,placement:$.RIGHT,preventCloseOnClickOutside:!1,selectorPageContent:"#page-content-selector",selectorInitialFocus:"#side-panel-story-text-input-a",hideCloseButton:!1,size:s.MEDIUM,slideIn:!1,slug:0,subtitle:1,title:"This title is testing a very long title to see how this behaves with a longer title. It needs to be long enough to trigger overflow when collapsed."},argTypes:{actionItems:{control:"select",description:"Slot (actions)",options:B},actionToolbarItems:{control:"select",description:"Slot (action-toolbar)",options:M},animateTitle:{control:"boolean",description:"animate-title (Title animates on scroll)"},class:{control:"text",description:"class"},closeIconDescription:{control:"text",description:"Close icon description"},closeIconTooltipAlignment:{control:"select",description:"Close icon tooltip alignment",options:Y},condensedActions:{control:"boolean",description:"condensed-actions"},content:{control:"select",description:"Slot (default), panel contents",options:D},includeOverlay:{control:"boolean",description:"include-overlay"},label:{control:"select",description:"label",options:z},open:{control:"boolean",description:"open"},placement:{control:"select",description:"placement",options:N},preventCloseOnClickOutside:{control:"boolean",description:"prevent-close-on-click-outside"},selectorPageContent:{control:"text",description:"selector-page-content"},selectorInitialFocus:{control:"text",description:"selector-initial-focus"},hideCloseButton:{control:"boolean",description:'Show/hide the "X" close button'},size:{control:"select",description:"size",options:P},slideIn:{control:"boolean",description:"slide-in"},slug:{control:"select",description:"slug (AI slug)",options:G},subtitle:{control:"select",description:"Slot (subtitle)",options:H},title:{control:"text",description:"title"}},render:t=>o`
      <div class="${l}story-container">
        <div class="${l}story-header"></div>
        <div id="page-content-selector" class="${l}story-content">
          <cds-button @click="${S}">Toggle side-panel</cds-button>
        </div>
      </div>
      <c4p-side-panel
    ...
    `},ht={title:"Components/SidePanel"};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  ...defaultTemplate
...
}`,...g.parameters?.docs?.source}}};const vt=["SlideOver","SlideIn","WithActionToolbar","SpecifyElementToHaveFocus","WithStaticTitle","WithStaticTitleAndActionToolbar","WithoutTitle","CustomHeader"];export{g as CustomHeader,r as SlideIn,a as SlideOver,u as SpecifyElementToHaveFocus,d as WithActionToolbar,p as WithStaticTitle,m as WithStaticTitleAndActionToolbar,b as WithoutTitle,vt as __namedExportsOrder,ht as default};
