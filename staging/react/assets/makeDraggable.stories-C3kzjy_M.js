import{el as n,em as h,eo as v,r as s,e as a,B as d,U as x,V as R,m as b}from"./iframe-BixY_nzU.js";import{m}from"./makeDraggable-BMCZwF7o.js";import{useMDXComponents as p}from"./index-DsEZ0qxD.js";import{i as f}from"./bucket-6-Ygy5YQ9m.js";function u(r){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...p(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"makedraggable",children:"makeDraggable"}),`
...
`,n.jsx(h,{children:n.jsx(v,{of:o})})]})}function k(r={}){const{wrapper:e}={...p(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(u,{...r})}):u(r)}const B={title:"Utilities/makeDraggable",parameters:{layout:"padded",docs:{page:k}},tags:["autodocs"]},E=()=>{const r=s.useRef(null),e=s.useRef(null),t=s.useRef(null);return s.useEffect(()=>{r.current&&e.current&&t.current&&m({el:r.current,dragHandle:e.current,focusableDragHandle:t.current})},[r.current,e.current,t.current]),a.createElement("div",{className:"mt-10 flex justify-center"},a.createElement("div",{ref:r,className:"draggable__div"},a.createElement("div",{ref:e,className:"draggable__div-header"},a.createElement("header",{ref:e,className:"div-header"},a.createElement(d,{kind:"ghost",ref:t,className:"drag-icon-div"},a.createElement(f,null)))),a.createElement("div",{className:"draggable__div-body"},a.createElement("p",null,"This server has 150 GB of block storage remaining."))))},N=()=>{const[r,e]=s.useState(!0),t=s.useRef(null),g=s.useRef(null),c=s.useRef(null);return s.useEffect(()=>{if(r&&t.current&&g.current&&c.current){const l=t.current.querySelector(".cds--popover");l instanceof HTMLElement&&(l.style.transform="none",l.style.left="0px",l.style.top="0px",m({el:l,dragHandle:g.current,focusableDragHandle:c.current}))}},[r,t.current,c.current]),a.createElement("div",{className:"mt-10 flex justify-center"},a.createElement(x,{open:r,ref:t,className:"popover"},a.createElement(d,{"aria-expanded":r,onClick:()=>{e(!r)}},"Toggle"),a.createElement(R,{className:"popover-content"},a.createElement("header",{ref:g,className:"popover-header popover-title"},a.createElement(d,{kind:"ghost",ref:c,className:"drag-icon",onClick:()=>console.log("clicked")},a.createElement(f,null)),a.createElement(d,{kind:"ghost",onClick:()=>e(!1),className:"close-icon"},a.createElement(b,null))),a.createElement("p",{className:"heading"}," Available storage"),a.createElement("p",{className:"popover-details"},"This server has 150 GB of block storage remaining."))))},i=E.bind({}),o=N.bind({});i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`() => {
...
}`,...o.parameters?.docs?.source}}};const T=["DraggableCustomDiv","DraggablePopover"];export{i as DraggableCustomDiv,o as DraggablePopover,T as __namedExportsOrder,B as default};
