import{k as O,r as f,x as n,t as b,n as S}from"./iframe-Dq7_sE-R.js";import{r as a}from"./state-145bePLO.js";import"./modal-label-uK7wUTdO.js";import"./form-item-BUwdi7Ae.js";import"./text-input-Bxq2zgyi.js";import"./toast-notification-V-aWqDpV.js";import"./checkbox-cgHJru-P.js";import"./link-B9XCLPk6.js";import{_ as P,a as R}from"./16-xraWWrlP.js";import{i as x}from"./icon-loader-DBarA4V3.js";import"./button-CAMQBIDi.js";import{_ as T}from"./16-gUhxGjnI.js";import"./preload-helper-PPVm8Dsz.js";import"./host-listener-DN1-XIwx.js";import"./inline-loading-Cyvw46C6.js";import"./class-map-lm-sIrT2.js";import"./16-DSuDh1sQ.js";import"./icon-button-DuMI0ej2.js";import"./definition-tooltip-DfSYRZUQ.js";import"./popover-content-CwEb-NFO.js";import"./floating-controller-O5_OP1Uj.js";import"./query-D0jTsbLw.js";import"./button-skeleton-BqzEqCwi.js";import"./20-CvqWH37X.js";import"./16-BKf1RCCE.js";import"./validity-5v9si4Dr.js";import"./16-D5maUdCH.js";const $=()=>{const e=new Date;let o=e.getHours();const i=e.getMinutes().toString().padStart(2,"0"),s=e.getSeconds().toString().padStart(2,"0"),t=o>=12?"PM":"AM";return o=o%12,o=o||12,`${o}:${i}:${s} ${t}`},j=":host cds-modal-body{padding-bottom:0}.no-bullets{list-style-type:none;padding-inline-start:2rem;margin:0}.notification{position:absolute;right:.75rem;top:.75rem}",D=O(j);var z=Object.defineProperty,M=Object.getOwnPropertyDescriptor,C=(e,o,i,s)=>{for(var t=s>1?void 0:s?M(o,i):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,i,t):l(t))||t);return s&&t&&z(o,i,t),t};let m=class extends f{constructor(){super(...arguments),this._open=!1,this._showNotification=!1,this._textInput="",this._enableDelete=!1}_close(){this._open=!1,this._textInput=""}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_setDeleteButtonState(){this._enableDelete=this._textInput==="Bx1001"}_onInputChange(e){this._textInput=e.target.value,this._setDeleteButtonState()}_onDelete(e){this._close(),this._showNotification=!0}render(){return n`
    ...
    `}};u.styles=D;N([S()],u.prototype,"action",2);N([a()],u.prototype,"_open",2);N([a()],u.prototype,"_showNotification",2);u=N([b("delete-remove-medium-impact")],u);var F=Object.defineProperty,G=Object.getOwnPropertyDescriptor,B=(e,o,i,s)=>{for(var t=s>1?void 0:s?G(o,i):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,i,t):l(t))||t);return s&&t&&F(o,i,t),t};let _=class extends f{constructor(){super(...arguments),this._showNotification=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._showNotification=!0}render(){return n`
      ...
      ${this._showNotification?n`<cds-toast-notification
            ...
            @cds-notification-closed="${this._onNotificationClose}"
          ></cds-toast-notification>`:null}
    `}};_.styles=D;B([S()],_.prototype,"action",2);B([a()],_.prototype,"_showNotification",2);_=B([b("delete-remove-low-impact")],_);const De={title:"Patterns/Delete and remove"},y={render:()=>n`<delete-high-impact></delete-high-impact>`},g={render:()=>n`<delete-connected-items></delete-connected-items>`},k={render:()=>n`<delete-batch></delete-batch>`},v={render:()=>n`<delete-remove-medium-impact
      action="delete"
...
}`,...w.parameters?.docs?.source}}};const Ce=["highImpactDeletion","deletionWithConnectedItems","batchDeletion","mediumImpactDeletion","lowImpactDeletion"];export{Ce as __namedExportsOrder,k as batchDeletion,De as default,g as deletionWithConnectedItems,y as highImpactDeletion,w as lowImpactDeletion,v as mediumImpactDeletion};
