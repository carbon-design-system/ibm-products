# Carbon for IBM Products `ScrollGradient` example
...
5. Review the changes made and restore/rectify the template TAGS typically in capitals. These are replaced as part of the build process. E.g. ScrollGradient, 2025, import './config'
