...
import AnatomyImg from './tearsheet-anatomy.png';
...
<Preview>
  <Story id="experimental-tearsheet--all-attributes-set" />
</Preview>

### Narrow tearsheet

<Preview>
  <Story id="experimental-tearsheetnarrow--all-attributes-set" />
</Preview>
