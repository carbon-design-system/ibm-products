...
`,e.jsx(I,{})]})}function W(r={}){const{wrapper:t}={...R(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(g,{...r})}):g(r)}const N=""+new URL("abstract-image-KeSi23KF.svg",import.meta.url).href,l={label:"Label",title:"Title",metadata:[{id:"1",icon:r=>n.createElement(F,{size:16,...r}),iconDescription:"2 mins"},{id:"2",icon:r=>n.createElement(K,{size:16,...r}),iconDescription:"Beginner"}],footerActionIcon:r=>n.createElement(U,{size:16,...r}),onClick:_("on click")},Ae={title:"Experimental/Onboarding/GetStartedCard",component:o,tags:["autodocs"],parameters:{docs:{page:W}},decorators:[r=>{const t=z();return n.createElement("div",{className:`${t}--grid`},r())}]},p=r=>{const{children:t,...A}=r;return n.createElement(o,{label:"Prepare your data",title:"Generate synthetic Tabular data",...A},t)},i=p.bind({});i.args={...l,pictogram:r=>n.createElement(D,{size:32,...r})};const s=p.bind({});s.args={...l,sequence:3};const d=p.bind({});d.args={...l,pictogram:r=>n.createElement(D,{size:32,...r}),media:n.createElement("img",{src:N,alt:"abstract Image"})};const c=p.bind({});c.args={...l,sequence:3,media:n.createElement("img",{src:N,alt:"abstract Image"})};const m=p.bind({});m.args={...l,sequence:3,disabled:!0};var b,y,x;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`opts => {
  const {
    children,
    ...args
  } = opts;
...
}`,...(k=(O=m.parameters)==null?void 0:O.docs)==null?void 0:k.source}}};const Ie=["Default","withSequence","withMediaAndPictogram","withMediaAndSequence","withDisabled"];export{i as Default,Ie as __namedExportsOrder,Ae as default,m as withDisabled,d as withMediaAndPictogram,c as withMediaAndSequence,s as withSequence};
