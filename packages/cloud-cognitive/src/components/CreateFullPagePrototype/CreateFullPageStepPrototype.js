...
import { CREATE_FULL_PAGE_STEP_PROTOTYPE } from './constants.js';
import { FormGroup } from 'carbon-components-react';

const componentName = 'CreateFullPageStepPrototype';
const blockClass = `${pkg.prefix}--create-full-page__step`;

export let CreateFullPageStepPrototype = forwardRef(
  (
    {
      children,
      className,
...
CreateFullPageStepPrototype = pkg.checkComponentEnabled(
  CreateFullPageStepPrototype,
  componentName
);

CreateFullPageStepPrototype.propTypes = {
  /**
...
CreateFullPageStepPrototype.defaultProps = {
  type: CREATE_FULL_PAGE_STEP_PROTOTYPE,
  hasForm: true,
};
