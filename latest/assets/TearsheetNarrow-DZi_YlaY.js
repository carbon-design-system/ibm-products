import{P as e}from"./index-CXyjPnaX.js";import{p as l,B as n}from"./settings-DkGFwmHv.js";import{T as p,p as d,t as c}from"./TearsheetShell-Cac5arl4.js";import{e as a}from"./index-CPiZ6Cnx.js";import{p as h,a as m}from"./props-helper-C4XfpXsc.js";import{g as u}from"./devtools-BgfuqBVa.js";import{A as f}from"./ActionSet-niQNGcwi.js";const o="TearsheetNarrow",y={verticalPosition:"lower"};let t=a.forwardRef(({verticalPosition:s=y.verticalPosition,...r},i)=>a.createElement(p,{...u(o),...h(r,c),verticalPosition:s,ref:i,size:"narrow"}));t=l.checkComponentEnabled(t,o);t.displayName=o;const g={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:m([f.validateActions(()=>"lg"),e.arrayOf(e.shape({...n.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:n.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string,description:e.node,hasCloseIcon:e.bool,label:e.node,onClose:e.func,open:e.bool,portalTarget:d,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...g};t.__docgenInfo={description:`A narrow tearsheet is a slimmer variant of the tearsheet, providing a dialog
...
main content area, and a set of action buttons.`,methods:[],displayName:"TearsheetNarrow",props:{actions:{required:!1,tsType:{name:"Array",elements:[{name:"ButtonProps",elements:[{name:"ReactElementType",raw:"React.ElementType"}],raw:"ButtonProps<React.ElementType>"}],raw:"ButtonProps<React.ElementType>[]"},description:`The navigation actions to be shown as buttons in the action area at the
...
to allow an action bar navigation or breadcrumbs to also show through.`,defaultValue:{value:"'lower'",computed:!1},type:{name:"enum",value:[{value:"'normal'",computed:!1},{value:"'lower'",computed:!1}]}}},composes:["PropsWithChildren"]};export{t as T,g as d};
