...
export const BreadcrumbWithOverflow = !pkg.isComponentEnabled(componentName)
          ...
          if (sizingContainerRef.current) {
            ...
            for (let item of sizingBreadcrumbItems) {
              ...
              const marginWidths = computedStyle
                ...
                : 0;
              breadcrumbWidthsIncludingMargin.push(
                item.offsetWidth + marginWidths
              );
            }
            ...
            for (
              let i = 0;
              i < breadcrumbWidthsIncludingMargin.length - 1;
              i++
            ) {
