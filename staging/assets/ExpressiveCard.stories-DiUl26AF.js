import{j as n,p as ie}from"./settings-B0yoEqB-.js";import{u as ne,c as le,_ as ce,z as me}from"./useMergedRefs-CY5AfkP4.js";import{P as e}from"./index-Dk74W0Oi.js";import{R as de,r as ue}from"./index-BwDkhjyp.js";import{G as oe}from"./Grid-Dk7eOJpp.js";import{C as re}from"./Column-CtuSerDG.js";import{S as pe,a as ge}from"./index-BTlTfnmk.js";import{S as ye}from"./StoryDocsPage-ChoQ20NW.js";import{a as j}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as he}from"./devtools-Cvhd47uB.js";import{p as fe}from"./props-helper-TFaonUid.js";import{C as Se}from"./Card-BijRQ87z.js";import{b as xe,A as ve}from"./bucket-0-B0v4OsOH.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-D6dlm1BF.js";import"./index-D2JPet7M.js";import"./index-BONylQH5.js";import"./index-D0hq9jV7.js";import"./bucket-17-DEU5xTcO.js";import"./index-D4z3D3nr.js";import"./iframe-BBSBJ9v0.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./story-helper-CLT5J87X.js";import"./tslib.es6-B4_xh3D5.js";import"./v4-CQkTLCs1.js";import"./index-CRLQHgyt.js";import"./Text-CiWJR74P.js";import"./useAttachedMenu-BaaFYui-.js";import"./bucket-12-DR0XAE11.js";import"./wrapFocus-CuszVIVc.js";import"./mergeRefs-CTUecegF.js";import"./index-BYHiJ3ZX.js";import"./LayerContext-DbU-6VX4.js";import"./bucket-6-DVxyWg0u.js";import"./bucket-9-C9TeJaCv.js";const te=o=>{let{as:t="div",className:i,children:v,ratio:b="1x1",...l}=o;const c=ne(),C=le(i,`${c}--aspect-ratio`,`${c}--aspect-ratio--${b}`);return de.createElement(t,ce({className:C},l),v)};te.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let a=ue.forwardRef((o,t)=>{const i=fe(o,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.jsx(Se,{ref:t,...i,...he(z)})});a=ie.checkComponentEnabled(a,z);a.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),children:e.node,className:e.string,description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};a.displayName=z;a.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
