import{k as n,x as i}from"./iframe-BSerOd4r.js";import"./options-tile-Di6TN4hC.js";import"./toggle-BlVMhpO2.js";import"./toggle-skeleton-DvtP1EaN.js";import"./dropdown-skeleton-DooTMm3W.js";const s=".options-tile__body p{font-size:var(--cds-body-01-font-size, .875rem);font-weight:var(--cds-body-01-font-weight, 400);line-height:var(--cds-body-01-line-height, 1.42857);letter-spacing:var(--cds-body-01-letter-spacing, .16px);margin-block-end:1rem}.options-tile__dropdown:first-of-type{margin-block-end:1rem}",l=n(s),d={body:{control:"text",description:"Slot body content"},defaultOpen:{control:"boolean",description:"If `true` the body of the component is shown"},size:{control:"radio",options:["lg","xl"],description:"Determines the size of the header"},summary:{control:"text",description:"Slot text that is displayed under the title"},titleId:{control:"text",description:"ID for the title"},titleText:{control:"text",description:"Text for the title"}},o="options-tile",e={args:{defaultOpen:!1,size:"lg",titleId:"title-01",titleText:"Language"},argTypes:d,render:t=>i`
      <style>
        ${l}
      </style>
      <c4p-options-tile
