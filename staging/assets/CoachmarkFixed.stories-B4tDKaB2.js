import{p as N,j as e}from"./settings-B0yoEqB-.js";import{c as j}from"./useMergedRefs-CY5AfkP4.js";import{L as E}from"./Link-CYjur6eE.js";import{g as z}from"./story-helper-CLT5J87X.js";import{useMDXComponents as _}from"./index-DlpNa54Y.js";import"./chunk-HLWAVYOI-C8rwFTKs.js";import{e as Y,i as G,C as J}from"./index-D4z3D3nr.js";import{R as Q,r as o}from"./index-BwDkhjyp.js";import{P as l}from"./index-Dk74W0Oi.js";import{g as Z}from"./devtools-Cvhd47uB.js";import{r as ee}from"./index-BONylQH5.js";import{a as te,b as oe,C as ne,c as ae,d as O}from"./CoachmarkOverlayElements-C_H7Imoc.js";import{C as re}from"./CoachmarkTagline-Gs7WjvVS.js";import{u as se}from"./use-reduced-motion-BisnjenD.js";import{u as ie}from"./useIsomorphicEffect-D7JMtAof.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-D6dlm1BF.js";import"./index-D2JPet7M.js";import"./tslib.es6-B4_xh3D5.js";import"./iframe-BBSBJ9v0.js";import"../sb-preview/runtime.js";import"./react-18-Dd3bHtks.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./uuidv4-BQrI85uz.js";import"./bucket-5-4mfd4DYT.js";import"./lodash-C6Eq4oiK.js";import"./SteppedAnimatedMedia-Bp6IIOTP.js";import"./lottie-D0UQuq7-.js";import"./clamp-Bg2yowlN.js";import"./toNumber-DVQITUtX.js";import"./Carousel-BGNhap5t.js";import"./bucket-8-CK-ZkPeI.js";const P=`${N.prefix}--coachmark`,L=`${P}-fixed`,T=`${P}-overlay`,g="CoachmarkFixed",f={onClose:()=>{},theme:"light",tagline:""};let i=Q.forwardRef(({children:n,className:t,onClose:x=f.onClose,portalTarget:h,tagline:q=f.tagline,theme:b=f.theme,...A},M)=>{const V=o.useRef(null),a=o.useRef(null),[c,m]=o.useState(!1),[y,k]=o.useState(!1),[W,$]=o.useState(),[H,X]=o.useState({x:0,y:0}),[p,C]=o.useState(!1),v=se();ie(()=>{a.current=h?(document==null?void 0:document.querySelector(h))??(document==null?void 0:document.querySelector("body")):document==null?void 0:document.querySelector("body")},[h]);const d=o.useCallback(()=>{v?m(!1):C(!1)},[v]),U=r=>{r.propertyName==="transform"&&!p&&(m(!1),x())},w=r=>{$(r.target.getBoundingClientRect()),X({x:r.target.offsetLeft,y:r.target.offsetTop}),m(!1),k(!0)},u=o.useCallback(r=>{r.key==="Escape"&&d()},[d]);o.useEffect(()=>(document.addEventListener("keydown",u,!1),()=>{document.removeEventListener("keydown",u,!1)}),[u]);const K={buttonProps:{"aria-expanded":c,tabIndex:0,onClick:w,onDoubleClick:w},closeButtonProps:{onClick:d},targetRect:W,targetOffset:H,isOpen:c,tacos:"tacos"};return o.useEffect(()=>{y&&(k(!1),m(!0))},[y]),o.useEffect(()=>{C(c)},[c]),o.useEffect(()=>()=>m(!1),[]),e.jsx(te.Provider,{value:K,children:e.jsxs("div",{...A,className:j(L,`${L}__${b}`,t),ref:M,...Z(g),children:[e.jsx(re,{title:q,onClose:x}),c&&(a==null?void 0:a.current)&&ee.createPortal(e.jsx(oe,{ref:V,fixedIsVisible:p,kind:ne.FIXED,onClose:d,onTransitionEnd:U,theme:b,className:j(p&&`${T}--is-visible`,T),children:n}),a==null?void 0:a.current)]})})});i=N.checkComponentEnabled(i,g);i.displayName=g;i.propTypes={children:l.node.isRequired,className:l.string,onClose:l.func,portalTarget:l.string,tagline:l.string.isRequired,theme:l.oneOf(["light","dark"])};i.__docgenInfo={description:`Fixed coachmarks are used to call out specific functionality or concepts
