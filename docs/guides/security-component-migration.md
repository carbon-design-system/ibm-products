...
| `ActionableNotification`           | [Carbon v11 Migration guide][101]                                                                                 | `@carbon/react`        | Medium |
...
| `Button`                           | [Carbon v11 Migration guide][102]                                                                                 | `@carbon/react`        | Medium |
| `ButtonSkeleton`                   | [Carbon v11 Migration guide][103]                                                                                 | `@carbon/react`        | Medium |
...
| `ClickableTile`                    | [Carbon v11 Migration guide][105]                                                                                 | `@carbon/react`        | Medium |
...
| `ComboButton`                      | Deprecated - Promoted to Carbon v11. [View changes][107]                                                          | `@carbon/react`        | Medium |
...
| `DataTable`                        | No code changes. Scss changes can be found [here][108]                                                            | `@carbon/react`        | Medium |
| `DataTablePagination`              | **Deprecated:** [View replacement][3]                                                                             | `@carbon/react`        | Medium |
| `DatePicker`                       | [Carbon v11 Migration guide][109]                                                                                 | `@carbon/react`        | Medium |
| `DatePickerInput`                  | [Carbon v11 Migration guide][110]                                                                                 | `@carbon/react`        | Medium |
...
| `Dropdown`                         | [Carbon v11 Migration guide][111]                                                                                 | `@carbon/react`        | Medium |
| `DropdownSkeleton`                 | The deprecated prop `inline` has been removed                                                                     | `@carbon/react`        | Medium |
| `ErrorPage`                        | **Deprecated:** [View replacement][4]                                                                             | `@carbon/ibm-products` | Medium |
| `ExpandableTile`                   | [Carbon v11 Migration guide][112]                                                                                 | `@carbon/react`        | Medium |
| `ExternalLink`                     | **Deprecated** [View replacement][5]                                                                              | `@carbon/react`        | Medium |
| `FileUploader`                     | [Carbon v11 Migration guide][113]                                                                                 | `@carbon/react`        | Medium |
| `FileUploaderButton`               | [Carbon v11 Migration guide][114]                                                                                 | `@carbon/react`        | Medium |
...
| `FilterableMultiSelect`            | [Carbon v11 Migration guide][115]                                                                                 | `@carbon/react`        | Medium |
...
| `FormGroup`                        | [Carbon v11 Migration guide][116]                                                                                 | `@carbon/react`        | Medium |
...
| `IconButton`                       | **Deprecated:** [View replacement][7]                                                                             | `@carbon/react`        | Medium |
| `IconButtonBar`                    | **Deprecated:** [View replacement][8]                                                                             | `@carbon/ibm-products` | Medium |
...
| `Modal`                            | [Carbon v11 Migration guide][118]                                                                                 | `@carbon/react`        | Medium |
...
| `NonEntitledSection`               | **Deprecated:** [View replacement][9]                                                                             | `@carbon/ibm-products` | Medium |
...
| `OverflowMenu`                     | [Carbon v11 Migration guide][120]                                                                                 | `@carbon/react`        | Medium |
| `OverflowMenuItem`                 | [Carbon v11 Migration guide][121]                                                                                 | `@carbon/react`        | Medium |
...
| `RadioButtonGroup`                 | [Carbon v11 Migration guide][122]                                                                                 | `@carbon/react`        | Medium |
| `RadioTile`                        | [Carbon v11 Migration guide][123]                                                                                 | `@carbon/react`        | Medium |
...
| `Search`                           | [Carbon v11 Migration guide][124]                                                                                 | `@carbon/react`        | Medium |
...
| `Select`                           | [Carbon v11 Migration guide][125]                                                                                 | `@carbon/react`        | Medium |
| `SelectableTile`                   | [Carbon v11 Migration guide][126]                                                                                 | `@carbon/react`        | Medium |
...
| `Slider`                           | [Carbon v11 Migration guide][127]                                                                                 | `@carbon/react`        | Medium |
...
| `TableToolbarSearch`               | [Carbon v11 Migration guide][130]                                                                                 | `@carbon/react`        | Medium |
...
| `Tearsheet`                        | **Deprecated:** [View replacement][14]                                                                            | `@carbon/ibm-products` | Medium |
| `TearsheetSmall`                   | **Deprecated:** [View replacement][15]                                                                            | `@carbon/ibm-products` | Medium |
| `TextArea`                         | The `className` prop is now applied to the outermost element of `TextArea`                                        | `@carbon/react`        | Medium |
| `TextInput`                        | [Carbon v11 Migration guide][132]                                                                                 | `@carbon/react`        | Medium |
| `Tile`                             | [Carbon v11 Migration guide][133]                                                                                 | `@carbon/react`        | Medium |
...
| `TimePicker`                       | [Carbon v11 Migration guide][134]                                                                                 | `@carbon/react`        | Medium |
| `TimePickerSelect`                 | [Carbon v11 Migration guide][135]                                                                                 | `@carbon/react`        | Medium |
| `ToastNotification`                | [Carbon v11 Migration guide][117]                                                                                 | `@carbon/react`        | Medium |
| `Toggle`                           | [Carbon v11 Migration guide][136]                                                                                 | `@carbon/react`        | Medium |
