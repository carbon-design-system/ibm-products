import{j as i,p as l,B as s}from"./settings-CljJQLyl.js";import"./floating-ui.react-C-lGofMW.js";import{T as p,t as d,p as c,a as h}from"./TearsheetShell-CgULgFRM.js";import{R as m}from"./index-BwDkhjyp.js";import{p as u,a as f}from"./props-helper-BM8tfO54.js";import{P as e}from"./index-Dk74W0Oi.js";import{g as y}from"./devtools-C9kUiWhx.js";import{A as g}from"./ActionSet-0r0uXgna.js";const a="TearsheetNarrow",b={verticalPosition:"lower"};let t=m.forwardRef(({verticalPosition:o=b.verticalPosition,...n},r)=>i.jsx(p,{...y(a),...u(n,h),verticalPosition:o,ref:r,size:"narrow"}));t=l.checkComponentEnabled(t,a);t.displayName=a;const T={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:f([g.validateActions(()=>"lg"),e.arrayOf(e.shape({...s.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:s.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:o,hasCloseIcon:n})=>d(o,n)),description:e.node,hasCloseIcon:e.bool,label:e.node,onClose:e.func,open:e.bool,portalTarget:c,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...T};t.__docgenInfo={description:`A narrow tearsheet is a slimmer variant of the tearsheet, providing a dialog
