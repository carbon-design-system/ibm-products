import{e as a,p as h,P as e,B as o}from"./iframe-HX3uP5rF.js";import{T as c,p as m}from"./TearsheetShell-BY70pfli.js";import{a as f}from"./props-helper-BQIeo-gE.js";import{g as u}from"./devtools-CNhWTRl7.js";const n="Tearsheet";let t=a.forwardRef((i,r)=>{const{influencerPosition:s="left",influencerWidth:l="narrow",children:p,...d}=i;return a.createElement(c,{...u(n),...d,influencerPosition:s,influencerWidth:l,ref:r,size:"wide"},p)});t=h.checkComponentEnabled(t,n);t.displayName=n;const y={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:f([e.arrayOf(e.shape({...o.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:o.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string,description:e.node,hasCloseIcon:e.bool,headerActions:e.element,influencer:e.element,influencerPosition:e.oneOf(["left","right"]),influencerWidth:e.oneOf(["narrow","wide"]),label:e.node,launcherButtonRef:e.any,navigation:e.element,onClose:e.func,open:e.bool,portalTarget:m,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...y};t.__docgenInfo={description:`A tearsheet is a mostly full-screen type of dialog that keeps users
...
to allow an action bar navigation or breadcrumbs to also show through.`,type:{name:"enum",value:[{value:"'normal'",computed:!1},{value:"'lower'",computed:!1}]}}},composes:["PropsWithChildren"]};export{t as T,y as d};
