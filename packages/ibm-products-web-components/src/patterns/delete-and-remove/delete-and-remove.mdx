...
The Carbon web components listed in the 'ingredients' section are used within a
wrapper component to implement the functionality.
...
<cds-modal size="sm" ?open="${this._open}" prevent-close>
  ...
  <cds-modal-body>
    <cds-modal-body-content description="">
      Deleting 'Resource' will permanently delete the configuration. This action
      cannot be undone.
...
- A checkbox to confirm the deletion the all its connected items.
