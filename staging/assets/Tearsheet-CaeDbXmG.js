import"./floating-ui.dom.mjs-BB6krl5l.js";import{p,B as i}from"./settings-GP6q6PuD.js";import{R as r}from"./index-BwDkhjyp.js";import{T as d,t as h,p as c}from"./TearsheetShell-KCgzDlKY.js";import{P as e}from"./index-Dk74W0Oi.js";import{a as m}from"./props-helper-2sr7eXy7.js";import{g as u}from"./devtools-TX7bKGcX.js";import{A as f}from"./ActionSet-D6YJr6NC.js";const o="Tearsheet";let t=r.forwardRef(({influencerPosition:n="left",influencerWidth:a="narrow",...s},l)=>r.createElement(d,{...u(o),...s,influencerPosition:n,influencerWidth:a,ref:l,size:"wide"}));t=p.checkComponentEnabled(t,o);t.displayName=o;const y={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:m([f.validateActions(()=>"2xl"),e.arrayOf(e.shape({...i.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:i.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:n,hasCloseIcon:a})=>h(n,a)),description:e.node,hasCloseIcon:e.bool,headerActions:e.element,influencer:e.element,influencerPosition:e.oneOf(["left","right"]),influencerWidth:e.oneOf(["narrow","wide"]),label:e.node,launcherButtonRef:e.any,navigation:e.element,onClose:e.func,open:e.bool,portalTarget:c,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...y};t.__docgenInfo={description:`A tearsheet is a mostly full-screen type of dialog that keeps users
...
action buttons.`,methods:[],displayName:"Tearsheet",props:{actions:{required:!1,tsType:{name:"Array",elements:[{name:"ButtonProps",elements:[{name:"literal",value:"'button'"}],raw:"ButtonProps<'button'>"}],raw:"ButtonProps<'button'>[]"},description:`The navigation actions to be shown as buttons in the action area at the
...
there are a no navigation actions and/or hasCloseIcon is true.`,type:{name:"string"},required:!0},launcherButtonRef:{description:"Provide a ref to return focus to once the tearsheet is closed.",type:{name:"any"},required:!1}},composes:["PropsWithChildren"]};export{t as T,y as d};
