import{j as o,x as a}from"./iframe-DSdqiJWw.js";import"./full-page-error-Bc88C0UD.js";const c=".full-page-error-stories__story-container{position:fixed;display:grid;block-size:100vh;grid-template-rows:3rem 1fr;inline-size:100vw;inset-block-start:0;inset-inline-start:0}.full-page-error-stories__story-header{background:var(--cds-background-inverse, #393939)}",i=o(c);/**
 * @license
 *
