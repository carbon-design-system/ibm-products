var E=Object.defineProperty;var t=(e,a)=>E(e,"name",{value:a,configurable:!0});import{u as y,j as r,aN as v,aT as H,aO as A,R as s,r as l}from"./iframe-i4lJGu2h.js";import{A as j}from"./index-CPX_YDDd.js";import{O as L}from"./OverflowMenuItem-BT6qSwLy.js";import{O as N}from"./index-BUgATU43.js";import{D as d}from"./DataSpreadsheet-sk10zLv9.js";import"./preload-helper-Cc2_yIPf.js";import"./bucket-11-D-Y7JHJg.js";import"./bucket-21-CNxINDYf.js";import"./Text-Beop0pyf.js";import"./useAttachedMenu-DDPRo2A0.js";import"./environment-DRRHKtsv.js";import"./mergeRefs-BH0-8uDG.js";import"./bucket-14-COgSPOA5.js";import"./wrapFocus-D75OU94c.js";import"./useOutsideClick-Da7ss3G7.js";import"./index.esm-Ds2azPFr.js";import"./uuidv4-Fbcg8Vng.js";import"./usePreviousValue-Ct5Dt6pM.js";import"./inheritsLoose-CdLKJotq.js";import"./index-B31OZAQa.js";import"./props-helper-ktKsHiYb.js";import"./devtools-BVSjn6-P.js";import"./getNodeTextContent-CjFansOq.js";const b=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],S=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],O=t(e=>{const a=[];for(let o=0;o<e;o++)a.push(o);return a},"range"),T=t(e=>{const a=e&&{ownerName:S[Math.floor(Math.random()*S.length)],weight:Math.floor(Math.random()*40)},o={petType:b[Math.floor(Math.random()*b.length)],firstName:S[Math.floor(Math.random()*S.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...o,...a}:o},"newPet"),x=t(({rows:e,extraColumns:a})=>t((n=0)=>{const m=[e][n];return O(m).map(()=>({...T(a)}))},"makeDataLevel")(),"generateData");function M(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...y(),...e.components};return r.jsxs(r.Fragment,{children:[r.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
...
}`,...C.parameters?.docs?.source}}};const De=["dataSpreadsheet","largeDatasetSpreadsheet","largeDatasetSpreadsheetCustom","emptyWithCells","withManyColumns","withDifferentOptions","withDragDropCallback"];export{De as __namedExportsOrder,p as dataSpreadsheet,ge as default,g as emptyWithCells,u as largeDatasetSpreadsheet,h as largeDatasetSpreadsheetCustom,w as withDifferentOptions,C as withDragDropCallback,D as withManyColumns};
//# sourceMappingURL=DataSpreadsheet.stories-udZNB52m.js.map
