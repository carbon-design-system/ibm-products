...
interface TearsheetShellProps extends PropsWithChildren {
  ...
  /**
   * Optional prop that is intended for any scenerio where something is being generated by AI to reinforce AI transparency,
   * accountibility, and explainability at the UI level.
   */
  aiLabel?: ReactNode;
