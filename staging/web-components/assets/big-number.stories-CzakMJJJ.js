import{k as S,l as _,x as y}from"./iframe-Etog_1uH.js";import{i as v}from"./icon-loader-2iGE0hUJ.js";import"./definition-tooltip-DNxqllHQ.js";import{_ as O,a as j,b as w,c as B}from"./16-DnrYd2k_.js";import{_ as T}from"./16-DvgjsF02.js";import{B as c}from"./big-number-CcmCBgRR.js";const D="#storybook-root #main-content{padding:0}.c4p--big-number-stories__viewport{display:grid;align-items:center;padding:1rem;block-size:10rem}.custom-label{font-size:var(--cds-label-01-font-size, .75rem);font-weight:var(--cds-label-01-font-weight, 400);line-height:var(--cds-label-01-line-height, 1.33333);letter-spacing:var(--cds-label-01-letter-spacing, .32px);display:inline-block;margin:0;color:var(--cds-text-secondary, #525252)}.prefix--big-number--xl .custom-label{font-size:var(--cds-body-compact-01-font-size, .875rem);font-weight:var(--cds-body-compact-01-font-weight, 400);line-height:var(--cds-body-compact-01-line-height, 1.28572);letter-spacing:var(--cds-body-compact-01-letter-spacing, .16px)}.c4p--big-number-stories__label-with-tooltip{display:inline-flex;align-items:center;gap:.5rem}.c4p--big-number-stories__tooltip{display:inline-flex;align-items:center}",$=S(D),a=`${_}--big-number-stories`,o={"-123 ":-123,"0 ":0,"12 ":12,"345 ":345,"6789 ":6789,"12345.678 ":12345.678,"678901.2456 ":678901.2456,"1000000 ":1e6,"2345678 ":2345678,"90123456 ":90123456,"789012345 ":789012345,"6789012345 ":6789012345,"null ":null,"undefined ":void 0},z={fractionDigits:1,label:"Label",loading:!1,locale:"en-US",percentage:!1,size:c.Default,total:13,trending:!1,truncate:!0,value:5},h={loading:{options:[!0,!1],control:{type:"boolean"}},locale:{options:["bg","cs","da-DK","de-CH","de","en-AU","en-GB","en-US","en-ZA","es-ES","es","et","fi","fr-CA","fr-CH","fr","hu","it","ja","lv","nl-BE","nl-NL","no","pl","pt-BR","pt-PT","ru-UA","ru","sk","sl","th","tr","uk-UA","vi"],control:{type:"select"}},percentage:{options:[!0,!1],control:{type:"boolean"}},size:{options:Object.values(c),control:{type:"radio"}},total:{control:{type:"select",labels:Object.keys(o)},options:Object.values(o).map((t,e)=>e),mapping:Object.values(o)},trending:{options:[!0,!1],control:{type:"boolean"}},truncate:{options:[!0,!1],control:{type:"boolean"}},value:{control:{type:"select",labels:Object.keys(o)},options:Object.values(o).map((t,e)=>e),mapping:Object.values(o)}},C={args:z,argTypes:h,render:t=>{const{fractionDigits:e,label:l,loading:p,locale:d,percentage:u,size:i,total:g,trending:b,truncate:m,value:f}=t;return y`
    ...
    `}},n={...C},N={args:{...z,trending:!0},argTypes:h,render:t=>{const{fractionDigits:e,label:l,loading:p,locale:d,percentage:u,size:i,total:g,trending:b,truncate:m,value:f}=t,k=x=>{switch(x){case"lg":return B;case"xl":return w;default:return j}};return y`
      <style>
        ${$}
      </style>
      <div class="${a}__viewport">
        ...
        >
          <div slot="label" class="${a}__label-with-tooltip">
            <span class="custom-label"> ${l} </span>
          ...
          ${v(k(i),{slot:"trending-icon",class:`${_}--big-number__trend`})}
          <cds-icon-button
            kind="ghost"
            size="sm"
            align="bottom"
