import{A as $,n as h,r as y,x as p,H as g}from"./iframe-Jmzb2J_X.js";import{_ as b,a as w,b as C,c as z,d as O,e as A,f as D,g as x,h as S,i as I}from"./16-CfG0rDIQ.js";import{_ as k}from"./16-BswKfa1f.js";import{i as n}from"./icon-loader-D-DCGbf4.js";import{c as P,e as H}from"./class-map-Dq7Cgk20.js";import{c as m}from"./repeat-DIBRS4gg.js";import"./button-BIg63iLT.js";import"./button-skeleton-CxxG6nwo.js";import"./overflow-menu-item-oTKli2fc.js";import{c as T}from"./index-C-eRm0LX.js";import{_ as j}from"./16-DOn1njS0.js";import{s as F}from"./story-styles-D_d0vBkR.js";import"./preload-helper-PPVm8Dsz.js";import"./host-listener-DN1-XIwx.js";import"./collection-helpers-DS5mzmOk.js";import"./deep-shadow-contains-e9TvcXtW.js";import"./consume-DI2TaawZ.js";import"./state-DUKcvrci.js";import"./16-C2f9e6nj.js";import"./index-Bo0ZDXiz.js";import"./icon-button-D0dqBuDI.js";import"./definition-tooltip-0jAFAzlc.js";import"./popover-content-BraSTtPt.js";const L="Run Deploy Build Test Scan Format Debug Profile Analyze Sync Upload",u=L.split(/\s+/),v=[()=>n(b,{slot:"icon"}),()=>n(w,{slot:"icon"}),()=>n(C,{slot:"icon"}),()=>n(z,{slot:"icon"}),()=>n(O,{slot:"icon"}),()=>n(A,{slot:"icon"}),()=>n(D,{slot:"icon"}),()=>n(k,{slot:"icon"}),()=>n(x,{slot:"icon"}),()=>n(S,{slot:"icon"}),()=>n(I,{slot:"icon"})];function _({count:a,size:t,onClick:o=i=>alert(`Clicked action: ${i}`)}){return Array.from({length:a},(i,e)=>{const s=u[e%u.length],c=v[e%v.length];return{text:s,icon:c(),size:t,onClick:()=>o(s)}})}_({count:12});const R=":host .c4p--set-of-actions{height:100%}:host .c4p--set-of-actions cds-button:not(:defined),:host .c4p--set-of-actions cds-overflow-menu:not(:defined){display:none}:host .c4p--set-of-actions--horizontal{display:flex}:host .c4p--set-of-actions--vertical{display:inline-flex;flex-direction:column}:host .c4p--set-of-actions__overflow-svg{align-self:unset;color:var(--cds-icon-primary, #161616)}:host .c4p--set-of-actions [data-floating-menu-container]{position:relative}:host .c4p--set-of-actions [data-hidden]:not([data-fixed]){display:none}",U=$(R);var W=Object.defineProperty,q=Object.getOwnPropertyDescriptor,l=(a,t,o,i)=>{for(var e=i>1?void 0:i?q(t,o):t,s=a.length-1,c;s>=0;s--)(c=a[s])&&(e=(i?c(t,o,e):c(e))||e);return i&&e&&W(t,o,e),e};const f="c4p--set-of-actions";let r=class extends y{constructor(){super(...arguments),this.hiddenItems=[],this.actionsData=[],this.orientation=""}connectedCallback(){super.connectedCallback(),this.style.visibility="hidden"}firstUpdated(){this.container&&this.updateComplete.then(()=>{setTimeout(()=>{this.setupOverflowHandler(),this.style.visibility="visible"})})}updated(t){t.has("actionsData")&&this.updateComplete.then(()=>{this.hiddenItems=[],setTimeout(()=>this.setupOverflowHandler())}),this.hiddenItems.length||this.shadowRoot?.querySelector("[data-hidden]:not([data-offset])")?.removeAttribute("data-hidden")}setupOverflowHandler(){this.container&&(this.overflowHandler?.disconnect(),this.overflowHandler=T({container:this.container,dimension:this.orientation=="horizontal"?"width":"height",onChange:(t,o)=>{this.hiddenItems=this.actionsData?.slice(t.length)}}))}disconnectedCallback(){super.disconnectedCallback(),this.overflowHandler?.disconnect()}render(){return p`
      <div
  ...
  `},d={args:{...E},argTypes:B,render:N},ut={title:"Patterns/Item overflow"};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    ...defaultProps
  },
  argTypes,
  render: renderActionsTemplate
}`,...d.parameters?.docs?.source}}};const vt=["SetOfActions"];export{d as SetOfActions,vt as __namedExportsOrder,ut as default};
