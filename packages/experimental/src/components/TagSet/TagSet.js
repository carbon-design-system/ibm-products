...
export const TagSet = !pkg.isComponentEnabled(componentName)
        ...
        <ReactResizeDetector onResize={handleResize}>
          <div className={cx([blockClass, className])} ref={tagSet}>
            <div
              ...
              <div
                className={`${blockClass}--tag-container`}
                ref={displayedArea}>
                {displayedTags}
              </div>
              ...
              <span
                ...
                <Tooltip
                  ...
                  open={tipOpen}
                  triggerText={
                    <Tag>+{children.length - displayedTags.length}</Tag>
                  }
                  showIcon={false}
                  ref={overflowTag}>
                  <div
