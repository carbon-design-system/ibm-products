...
const blockClass = `multi-add-select-global-actions-pattern`;
...
export interface MultiAddSelectWithGlobalActionsProps {
  /**
...
export const MultiAddSelectWithGlobalActions = forwardRef<
  HTMLDivElement,
  MultiAddSelectWithGlobalActionsProps
>(
  (
    {
      open,
...
MultiAddSelectWithGlobalActions.propTypes = {
...
MultiAddSelectWithGlobalActions.displayName = 'MultiAddSelectWithGlobalActions';
