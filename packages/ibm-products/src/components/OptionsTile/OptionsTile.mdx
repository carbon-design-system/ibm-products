  ...
  additionalActions={[
      {
        ...
        onClick: () => stackblitzPrefillConfig(stories.optionsTile, [], [], stories.default.parameters.styles),
      },
    ]}>
</Canvas>
...
<Canvas
  ...
  additionalActions={[
      {
        title: 'Open in Stackblitz',
        onClick: () => stackblitzPrefillConfig(stories.staticOptionsTile, [], [], stories.default.parameters.styles),
      },
    ]}>
</Canvas>
