import{j as n,ep as M,e as t,c as F,p as T,P as h,r as l,C as _,B as u}from"./iframe-D7eStwkL.js";import{useMDXComponents as U}from"./index-BmduCp-X.js";import{c as v}from"./clamp-CsXXRQhr.js";import{S as A}from"./SelectableTag-DFA0KFoc.js";import{I as r}from"./InterstitialScreen-1RFzVrqK.js";import{b as j}from"./bucket-0-L01MYrbT.js";import"./Tag-DTggSZHJ.js";import"./DefinitionTooltip-8CBhbmfn.js";import"./index-DtlUN_qQ.js";import"./bucket-18-BuJkdNpM.js";import"./utils-DEi-HpEF.js";import"./Text-CX3SBrnk.js";import"./mergeRefs-91-mP8KM.js";import"./useControllableState-Nc8tGw_d.js";import"./ComposedModal-Dj2JxVd0.js";import"./index-BEhuL1MR.js";import"./index-BwtNW634.js";import"./LayerContext-CYpz3aOG.js";import"./clamp--00YEiB8.js";import"./ButtonSet-DFPcwcVc.js";import"./InlineLoading-D_3KuMGG.js";import"./bucket-6-VqTa2pt7.js";import"./requiredIfGivenPropIsTruthy-VsRXdxiC.js";import"./wrapFocus-BaNPWWSx.js";import"./devtools-Df6KS5y3.js";import"./ProgressIndicator-CzuuL3C2.js";import"./bucket-19-CU-7ragV.js";import"./bucket-9-DXX_t-vr.js";import"./useId-Df4HKPCr.js";import"./uuidv4-BN2rGLQG.js";import"./Carousel-CCi-z4xy.js";import"./useIsomorphicEffect-DXbKZHyj.js";function N(i){const e={a:"a",code:"code",h1:"h1",h2:"h2",h4:"h4",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...U(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"interstitialscreen",children:"InterstitialScreen"}),`
...
@returns void`,type:{name:"func"}}}};const V="interstitial-stories",g=`${T.prefix}--interstitial-screen`,Ce={title:"Components/Onboarding/InterstitialScreen",component:r,tags:["autodocs","Onboarding"],subcomponents:{Header:r.Header,Body:r.Body,Footer:r.Footer},decorators:[i=>t.createElement("div",{className:`${V}__viewport`},i())],parameters:{styles:W,docs:{page:H}}},b={"carbon.progress-step.complete":"Terminé","carbon.progress-step.incomplete":"Partiel","carbon.progress-step.current":"Actuel","carbon.progress-step.invalid":"Non valide"},k=({handleGotoStep:i})=>t.createElement(t.Fragment,null,t.createElement(p,{stepTitle:"Step 1",translateWithId:e=>b[e]??e},t.createElement(d,{size:"md",title:"Use case-specific heading 1",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),t.createElement(p,{stepTitle:"Step 2",translateWithId:e=>b[e]??e},t.createElement(d,{size:"md",title:"Use case-specific heading 2",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),t.createElement(p,{stepTitle:"Step 3",translateWithId:e=>b[e]??e},t.createElement(d,{size:"md",title:"Use case-specific heading 3",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),t.createElement(p,{stepTitle:"Step 4",translateWithId:e=>b[e]??e},t.createElement(d,{size:"md",title:"Use case-specific heading 4",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),t.createElement(p,{stepTitle:"Step 5",translateWithId:e=>b[e]??e},t.createElement(d,{size:"md",title:"Use case-specific heading 5",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."}))),L=({handleGotoStep:i,disableActionButton:e},a,s)=>t.createElement(t.Fragment,null,t.createElement(p,{stepTitle:"Step 1"},t.createElement(d,{className:s?"GenericView":"",title:"Use case-specific heading",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept.",disableActionButton:e}))),o={headerTitle:"Use case-specific title",headerSubTitle:"Use case-specific sub title",ariaLabel:"Interstitial Screen"},I=()=>{const[i,e]=l.useState(!0),a=l.useRef(null);return t.createElement(t.Fragment,null,t.createElement(u,{onClick:()=>{e(!0)},ref:a},"Show Interstitial modal"),t.createElement(r,{open:i,onClose:()=>{e(!1)},ariaLabel:o.ariaLabel,launcherButtonRef:a},t.createElement(r.Header,{headerTitle:o.headerTitle,headerSubTitle:o.headerSubTitle,hideProgressIndicator:!0}),t.createElement(r.Body,{contentRenderer:s=>L(s)}),t.createElement(r.Footer,null)))},x=()=>{const[i,e]=l.useState(!0),a=l.useRef(null);return t.createElement(t.Fragment,null,t.createElement(u,{onClick:()=>{e(!0)},ref:a},"Show Interstitial modal"),t.createElement(r,{open:i,onClose:()=>{e(!1)},ariaLabel:o.ariaLabel,launcherButtonRef:a},t.createElement(r.Header,{headerTitle:o.headerTitle,headerSubTitle:o.headerSubTitle}),t.createElement(r.Body,{contentRenderer:s=>k(s)}),t.createElement(r.Footer,null)))},w=()=>{const[i,e]=l.useState(!0),a=l.useRef(null);return t.createElement(t.Fragment,null,t.createElement(u,{onClick:()=>{e(!0)},ref:a},"Show Interstitial modal"),t.createElement(r,{open:i,onClose:()=>{e(!1)},ariaLabel:o.ariaLabel,launcherButtonRef:a},t.createElement(r.Header,{headerTitle:o.headerTitle,headerSubTitle:o.headerSubTitle}),t.createElement(r.Body,{contentRenderer:s=>k(s)}),t.createElement(r.Footer,{actionButtonRenderer:({handleGotoStep:s,progStep:c,stepCount:m})=>t.createElement(t.Fragment,null,t.createElement(u,{className:`${g}--skip-btn`,kind:"ghost",size:"lg",title:"Explore on my own",onClick:()=>e(!1)},"Explore on my own"),t.createElement("div",{className:`${g}--footer-controls`},c>0&&t.createElement(u,{className:`${g}--prev-btn`,kind:"secondary",size:"lg",title:"Previous",onClick:()=>{const f=m-1,R=v(c-1,0,f);s(R)}},"Previous"),c<m-1&&t.createElement(u,{className:`${g}--next-btn`,renderIcon:j,size:"lg",title:"Next",onClick:()=>{const f=m-1,R=v(c+1,0,f);s(R)}},"Next"),c===m-1&&t.createElement(u,{className:`${g}--start-btn`,renderIcon:j,size:"lg",title:"Start",onClick:()=>e(!1)},"Start")))})))},C=()=>{const[i,e]=l.useState(!0),a=l.useRef(null),s=async(c,m)=>{c!=="skip"&&await new Promise(S=>{setTimeout(()=>{S()},1500)})};return t.createElement(t.Fragment,null,t.createElement(u,{onClick:()=>{e(!0)},ref:a},"Show Interstitial modal"),t.createElement(r,{open:i,onClose:()=>{e(!1)},ariaLabel:o.ariaLabel,launcherButtonRef:a},t.createElement(r.Header,{headerTitle:o.headerTitle,headerSubTitle:o.headerSubTitle}),t.createElement(r.Body,{contentRenderer:c=>k(c)}),t.createElement(r.Footer,{onAction:s})))},y=()=>{const[i,e]=l.useState(!0);l.useState(!0);const a=l.useRef(null);return t.createElement(t.Fragment,null,t.createElement(u,{onClick:()=>{e(!0)},ref:a},"Show Interstitial full screen"),t.createElement(r,{open:i,onClose:()=>{e(!1)},isFullScreen:!0,ariaLabel:o.ariaLabel,launcherButtonRef:a},t.createElement(r.Header,{headerTitle:o.headerTitle,headerSubTitle:o.headerSubTitle}),t.createElement(r.Body,{contentRenderer:s=>L(s,!0,!0)}),t.createElement(r.Footer,null)))},E=()=>{const[i,e]=l.useState(!0);l.useState(!0);const a=l.useRef(null);return t.createElement(t.Fragment,null,t.createElement(u,{onClick:()=>{e(!0)},ref:a},"Show Interstitial full screen"),t.createElement(r,{open:i,onClose:()=>{e(!1)},isFullScreen:!0,ariaLabel:o.ariaLabel,launcherButtonRef:a},t.createElement(r.Header,{headerTitle:o.headerTitle,headerSubTitle:o.headerSubTitle}),t.createElement(r.Body,{contentRenderer:s=>k(s)}),t.createElement(r.Footer,null)))};I.__docgenInfo={description:"",methods:[],displayName:"Modal"};x.__docgenInfo={description:"",methods:[],displayName:"ModalWithMultipleSteps"};w.__docgenInfo={description:"",methods:[],displayName:"WithCustomActionButtons"};C.__docgenInfo={description:"",methods:[],displayName:"WithAsynchronousActionCallback"};y.__docgenInfo={description:"",methods:[],displayName:"fullScreen"};E.__docgenInfo={description:"",methods:[],displayName:"fullScreenWithMultipleSteps"};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`() => {
...
}`,...E.parameters?.docs?.source}}};const ye=["Modal","ModalWithMultipleSteps","WithCustomActionButtons","WithAsynchronousActionCallback","fullScreen","fullScreenWithMultipleSteps"];export{I as Modal,x as ModalWithMultipleSteps,C as WithAsynchronousActionCallback,w as WithCustomActionButtons,ye as __namedExportsOrder,Ce as default,y as fullScreen,E as fullScreenWithMultipleSteps};
