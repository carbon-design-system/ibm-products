var O=Object.defineProperty;var o=(a,e)=>O(a,"name",{value:e,configurable:!0});import{u as C,j as t,aN as R,aT as B,R as n,c as F,B as g,r as c}from"./iframe-CN5GxhYW.js";import{D as z}from"./Dropdown-DV6xTivr.js";import{T as N}from"./TextArea-CdAdMmHh.js";import{T as f}from"./TextInput-B15_7X2F.js";import{F as I}from"./Form-ScTsO1l0.js";import{C as P,M as D,a as A,b as W}from"./ComposedModal-D1v7ivyj.js";import{R as j}from"./RadioButton-oUHe2hSs.js";import{R as L}from"./RadioButtonGroup-aG0CKz3E.js";import"./preload-helper-Cc2_yIPf.js";import"./defaultItemToString-DDHghiWu.js";import"./downshift.esm-DqAWtRY4.js";import"./FormContext-BxWLgyc8.js";import"./inheritsLoose-CdLKJotq.js";import"./index-DSYn1vMq.js";import"./index-CYg9OXdX.js";import"./bucket-20-y6b6UwuS.js";import"./mergeRefs-BH0-8uDG.js";import"./useNormalizedInputProps-DDVLdI9l.js";import"./Text-Co6YBuGU.js";import"./bucket-21-BrCzSrZF.js";import"./hasHelperText-CcJ_VphT.js";import"./getAnnouncement-BwJDzAQp.js";import"./index-DB40h0fE.js";import"./LayerContext-ceyDb81d.js";import"./clamp-ekNJC_Xv.js";import"./isTopmostVisibleModal-iW97RJzz.js";import"./InlineLoading-BzS4iPtX.js";import"./bucket-7-ClP0NUKT.js";import"./ButtonSet-CMCk3317.js";import"./wrapFocus-Bfo9V0Ng.js";import"./index-t8wrbEZd.js";const V=".create-modal .cds--modal-close{display:none}@media(min-width:42rem){.create-modal .cds--modal-container{max-block-size:95%}}@media(min-width:66rem){.create-modal .cds--modal-container{max-block-size:95%}}.create-modal .cds--modal-header{border-block-end:1px solid var(--cds-layer-accent-01, #e0e0e0);margin-block-end:0;padding-block-end:.5rem;padding-inline-end:20%}.create-modal .cds--modal-footer .cds--btn{max-inline-size:none}.create-modal__subtitle{font-size:var(--cds-body-compact-01-font-size, .875rem);font-weight:var(--cds-body-compact-01-font-weight, 400);line-height:var(--cds-body-compact-01-line-height, 1.28572);letter-spacing:var(--cds-body-compact-01-letter-spacing, .16px);color:var(--cds-text-secondary, #525252);margin-block-end:.5rem}.create-modal__description{font-size:var(--cds-body-01-font-size, .875rem);font-weight:var(--cds-body-01-font-weight, 400);line-height:var(--cds-body-01-line-height, 1.42857);letter-spacing:var(--cds-body-01-letter-spacing, .16px);margin:.5rem 0 1rem;padding-inline-end:calc(20% - 1rem)}.create-modal__form .cds--fieldset{margin-block-end:0;min-inline-size:100%}.create-modal__form>*{margin-block-end:1rem}.create-modal__form>*:last-child{margin-block-end:0}";function T(a){const e={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",ul:"ul",...C(),...a.components};return t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"create-modal",children:"Create Modal"}),`
...
`,`
`,t.jsx(R,{withSource:"none",children:t.jsx(B,{of:u})}),`
...
`,t.jsx(e.a,{href:"https://carbondesignsystem.com/components/form/usage/",rel:"nofollow",children:"Carbon's Form usage page"}),"."]})]})}o(T,"_createMdxContent");function $(a={}){const{wrapper:e}={...C(),...a.components};return e?t.jsx(e,{...a,children:t.jsx(T,{...a})}):T(a)}o($,"MDXContent");const x="create-modal",y=n.forwardRef((a,e)=>{const{className:r,children:d,onRequestClose:m,onRequestSubmit:s,open:p,title:l,subtitle:h,description:i,secondaryButtonText:M,primaryButtonText:E,disableSubmit:k,selectorPrimaryFocus:_,...S}=a;return n.createElement(P,{...S,selectorPrimaryFocus:_,className:F(x,r),open:p,ref:e,"aria-label":l,size:"sm",preventCloseOnClickOutside:!0,onClose:o(()=>(m?.(),!1),"onClose")},n.createElement(D,{title:l,titleClassName:`${x}__title`},h&&n.createElement("p",{className:`${x}__subtitle`},h)),n.createElement(A,{hasForm:!0},i&&n.createElement("p",{className:`${x}__description`},i),n.createElement(I,{className:`${x}__form`,"aria-label":l,onSubmit:o(q=>q.preventDefault(),"onSubmit")},d)),n.createElement(W,null,n.createElement(g,{type:"button",kind:"secondary",onClick:m},M),n.createElement(g,{type:"submit",kind:"primary",onClick:s,disabled:k},E)))});y.displayName="CreateModal";y.__docgenInfo={description:"",methods:[],displayName:"CreateModal",props:{className:{required:!1,tsType:{name:"string"},description:""},open:{required:!1,tsType:{name:"boolean"},description:""},title:{required:!0,tsType:{name:"string"},description:""},subtitle:{required:!1,tsType:{name:"ReactNode"},description:""},description:{required:!0,tsType:{name:"ReactNode"},description:""},secondaryButtonText:{required:!0,tsType:{name:"string"},description:""},primaryButtonText:{required:!0,tsType:{name:"string"},description:""},disableSubmit:{required:!1,tsType:{name:"boolean"},description:""},selectorPrimaryFocus:{required:!0,tsType:{name:"string"},description:""}},composes:["PropsWithChildren"]};const X=["Option 0","Option 1","Option 2"],w=o(({open:a,setOpen:e})=>{const[r,d]=c.useState(""),[m,s]=c.useState(null),[p,l]=c.useState(""),h=o(()=>{d(""),s(null),l(""),e(!1)},"handleClose");return n.createElement(y,{open:a,onRequestClose:h,title:"Title",subtitle:"Your subtitle text will appear here",description:"This is example description text that will appear here in your modal",primaryButtonText:"Create",secondaryButtonText:"Cancel",selectorPrimaryFocus:"#text-input-1",onRequestSubmit:h},n.createElement(f,{id:"text-input-1",labelText:"Text input label",helperText:"Helper text goes here",placeholder:"Placeholder",value:r,onChange:o(i=>d(i.target.value),"onChange")}),n.createElement(z,{id:"dropdown-1",titleText:"Dropdown label",helperText:"This is some helper text",label:"Dropdown menu options",items:X,selectedItem:m,onChange:o(({selectedItem:i})=>s(i??null),"onChange")}),n.createElement(N,{id:"text-area-1",placeholder:"Placeholder text",labelText:"Text area label",helperText:"Optional helper text",value:p,onChange:o(i=>l(i.target.value),"onChange")}))},"StandardCreateModal");w.__docgenInfo={description:"",methods:[],displayName:"StandardCreateModal",props:{open:{required:!0,tsType:{name:"boolean"},description:""},setOpen:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""}}};const v=o(({open:a,setOpen:e})=>{const[r,d]=c.useState(""),[m,s]=c.useState(!1),p=o(()=>{d(""),s(!1),e(!1)},"handleClose");return n.createElement(y,{open:a,onRequestClose:p,title:"Title",subtitle:"Your subtitle text will appear here",description:"This is example description text that will appear here in your modal",primaryButtonText:"Create",secondaryButtonText:"Cancel",disableSubmit:r.length===0,selectorPrimaryFocus:"#text-input-1",onRequestSubmit:p},n.createElement(f,{id:"text-input-1",labelText:"Text input label",placeholder:"Placeholder",value:r,onChange:o(l=>{d(l.target.value),s(!1)},"onChange"),onBlur:o(()=>{r.length===0&&s(!0)},"onBlur"),invalid:m,invalidText:"This is a required field"}),n.createElement(f,{id:"text-input-2",labelText:"Text input label (optional)",placeholder:"Placeholder"}),n.createElement(f,{id:"text-input-3",labelText:"Text input label (optional)",placeholder:"Placeholder"}),n.createElement(L,{legendText:"Radio button legend text goes here",name:"radio-button-group",defaultSelected:"radio-1"},n.createElement(j,{labelText:"Radio-1",value:"radio-1",id:"radio-1"}),n.createElement(j,{labelText:"Radio-2",value:"radio-2",id:"radio-2"}),n.createElement(j,{labelText:"Radio-3",value:"radio-3",id:"radio-3"})))},"CreateModalWithValidation");v.__docgenInfo={description:"",methods:[],displayName:"CreateModalWithValidation",props:{open:{required:!0,tsType:{name:"boolean"},description:""},setOpen:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""}}};const Ee={title:"Patterns/Create flows/Create Modal",component:o(()=>{},"component"),tags:["autodocs"],parameters:{styles:V,docs:{page:$}}},Y=o(a=>{const[e,r]=c.useState(!1);return n.createElement(n.Fragment,null,n.createElement(g,{onClick:o(()=>r(!0),"onClick")},"Launch modal"),n.createElement(w,{open:e,setOpen:r,...a}))},"CreateModalPattern"),G=o(a=>{const[e,r]=c.useState(!1);return n.createElement(n.Fragment,null,n.createElement(g,{onClick:o(()=>r(!0),"onClick")},"Launch CreateModal with form validation"),n.createElement(v,{open:e,setOpen:r,...a}))},"CreateModalWithValidationPattern"),u=Y.bind({});u.args={};const b=G.bind({});b.args={};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`args => {
...
}`,...b.parameters?.docs?.source}}};const ke=["CreateModal","WithFormValidation"];export{u as CreateModal,b as WithFormValidation,ke as __namedExportsOrder,Ee as default};
//# sourceMappingURL=CreateModal.stories-Ckat6DEJ.js.map
