import{j as t,aA as y,aC as E,aB as H,r as n,e as s}from"./iframe-CECvNR-E.js";import{useMDXComponents as b}from"./index-CB45JN3N.js";import{O as v}from"./index-D6SLJGyk.js";import{O as A}from"./OverflowMenuItem-CuAQreUF.js";import{D as d}from"./DataSpreadsheet-BhRijfYg.js";import"./preload-helper-PPVm8Dsz.js";import"./useAttachedMenu-D1mlKi8p.js";import"./mergeRefs-BZpmU3mx.js";import"./bucket-13-BsaKR1EV.js";import"./wrapFocus-2UnpdR_d.js";import"./useOutsideClick-NWUtwkfn.js";import"./Text-JYrlRVpp.js";import"./index.esm-CB6JTwDV.js";import"./uuidv4-BN2rGLQG.js";import"./usePreviousValue-DzUN10Wt.js";import"./inheritsLoose-DHKJTbHM.js";import"./props-helper-BomzR2el.js";import"./devtools-4IrNVtGE.js";import"./getNodeTextContent-C8IeKkUQ.js";const S=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],f=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],L=e=>{const a=[];for(let r=0;r<e;r++)a.push(r);return a},j=e=>{const a=e&&{ownerName:f[Math.floor(Math.random()*f.length)],weight:Math.floor(Math.random()*40)},r={petType:S[Math.floor(Math.random()*S.length)],firstName:f[Math.floor(Math.random()*f.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...r,...a}:r},w=({rows:e,extraColumns:a})=>((o=0)=>{const m=[e][o];return L(m).map(()=>({...j(a)}))})();function M(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...b(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
...
//# sourceMappingURL=DataSpreadsheet.stories-DV0PFoL9.js.map
