import{j as i,p as l,B as s}from"./settings-Bk-Ww79A.js";import{R as p}from"./index-BwDkhjyp.js";import{P as e}from"./index-Dk74W0Oi.js";import{g as d}from"./devtools-jK7s13u1.js";import{p as c,a as h}from"./props-helper-DKwMo5Mj.js";import"./useMergedRefs-DoviDd4t.js";import{T as m,t as u,p as f,a as y}from"./TearsheetShell-Cp-zdMef.js";import{A as g}from"./ActionSet-rjy9XBbR.js";const a="TearsheetNarrow",b={verticalPosition:"lower"};let t=p.forwardRef(({verticalPosition:o=b.verticalPosition,...n},r)=>i.jsx(m,{...d(a),...c(n,y),verticalPosition:o,ref:r,size:"narrow"}));t=l.checkComponentEnabled(t,a);t.displayName=a;const T={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:h([g.validateActions(()=>"lg"),e.arrayOf(e.shape({...s.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:s.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:o,hasCloseIcon:n})=>u(o,n)),description:e.node,hasCloseIcon:e.bool,label:e.node,onClose:e.func,open:e.bool,portalTarget:f,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...T};t.__docgenInfo={description:`A narrow tearsheet is a slimmer variant of the tearsheet, providing a dialog
