import{k as T,l as _,x as f}from"./iframe-D_goBqV9.js";import{c as E}from"./repeat-DeSKDKIS.js";import"./guide-banner-element-DLl7yvfJ.js";import{i as x}from"./icon-loader-wTLyOJdN.js";import{i as S,a as k}from"./20-CppOV_ea.js";import"./preload-helper-PPVm8Dsz.js";import"./class-map-Cd1_UiXq.js";import"./button-BiU2GWBy.js";import"./button-skeleton-D_cJh9PI.js";import"./16-D5maUdCH.js";const q=".body{color:var(--cds-text-primary,#161616)}.body-elm{inline-size:600px;padding:2rem}.footer{justify-content:space-between;inline-size:100%;display:flex}",C=T(q),l=`${_}--snappy`,L=`${l}__elm`,d=`${l}__selection`;function w(t,r){const n=document.querySelector(t);if(!n)return;const i=document.createElement("style");i.textContent=`
  .${l} {
    display: flex;
    flex: none;
    overflow: scroll;
