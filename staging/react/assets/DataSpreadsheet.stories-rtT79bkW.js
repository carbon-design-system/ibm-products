var y=Object.defineProperty;var t=(e,a)=>y(e,"name",{value:a,configurable:!0});import{j as s,aD as H,aF as v,aE as A,r as l,e as r}from"./iframe-DgruYanb.js";import{useMDXComponents as E}from"./index-CUlNcuo1.js";import{O as L}from"./OverflowMenuItem-KM0pxpoo.js";import{O as j}from"./index-B911w2zo.js";import{D as m}from"./DataSpreadsheet-C5Pi-DUa.js";import"./preload-helper-Cc2_yIPf.js";import"./Text-D1lCafHM.js";import"./mergeRefs-BH0-8uDG.js";import"./useAttachedMenu-DVWyH_8U.js";import"./environment-DRRHKtsv.js";import"./bucket-13-DzNOrorl.js";import"./wrapFocus-CTeM4Oek.js";import"./useOutsideClick-DZy5JJee.js";import"./index.esm-CQal-Oij.js";import"./uuidv4-Fbcg8Vng.js";import"./usePreviousValue-DCRYaoGC.js";import"./inheritsLoose-CdLKJotq.js";import"./props-helper-BEn8ZzZM.js";import"./devtools-CW8YVWZC.js";import"./getNodeTextContent-CjFansOq.js";const M=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],S=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],N=t(e=>{const a=[];for(let o=0;o<e;o++)a.push(o);return a},"range"),O=t(e=>{const a=e&&{ownerName:S[Math.floor(Math.random()*S.length)],weight:Math.floor(Math.random()*40)},o={petType:M[Math.floor(Math.random()*M.length)],firstName:S[Math.floor(Math.random()*S.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...o,...a}:o},"newPet"),x=t(({rows:e,extraColumns:a})=>t((n=0)=>{const i=[e][n];return N(i).map(()=>({...O(a)}))},"makeDataLevel")(),"generateData");function b(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...E(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
...
}`,...C.parameters?.docs?.source}}};const ue=["dataSpreadsheet","largeDatasetSpreadsheet","largeDatasetSpreadsheetCustom","emptyWithCells","withManyColumns","withDifferentOptions","withDragDropCallback"];export{ue as __namedExportsOrder,u as dataSpreadsheet,ie as default,D as emptyWithCells,p as largeDatasetSpreadsheet,h as largeDatasetSpreadsheetCustom,w as withDifferentOptions,C as withDragDropCallback,g as withManyColumns};
//# sourceMappingURL=DataSpreadsheet.stories-rtT79bkW.js.map
