import{r as b,R as e}from"./index-BwDkhjyp.js";import{a as w}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{c as S,v as ce}from"./index-CO-HQMMN.js";import{D as F}from"./Dropdown-CIyg-5U1.js";import{F as pe}from"./FormGroup-C6KGJYle.js";import{u as Y}from"./uuidv4-BQrI85uz.js";import{a as B,e as U}from"./index-DkUr2NOz.js";import{T as me}from"./Toggle-Bqo8tFuJ.js";import{L as ue}from"./index-Y0d6iLU4.js";import{P as i}from"./index-Dk74W0Oi.js";import{g as ge}from"./devtools-7ohusRRR.js";import{p as Q}from"./settings-9_3hiHpE.js";import{u as he}from"./usePrefersReducedMotion-DeqUFceN.js";import{a as G}from"./bucket-10-DgP_ha3n.js";import{W as be,a as fe}from"./bucket-18-BI__9nmH.js";import"./_commonjsHelpers-BosuxZz1.js";import"./v4-CQkTLCs1.js";import"./index-BONylQH5.js";import"./index-Czv2bu3D.js";import"./extends-CCbyfPlC.js";import"./index-DcAOwtUU.js";import"./tslib.es6-B4_xh3D5.js";import"./FormContext-C7kRVu4t.js";import"./mergeRefs-CTUecegF.js";import"./bucket-2-Bt1jIBkN.js";import"./useControllableState-DwpxGhsf.js";import"./Text-DeIkfaUm.js";import"./LayerContext-DbU-6VX4.js";import"./index-CJvxHwuA.js";import"./events-OVwOsPzJ.js";import"./index-DQ9l4IMz.js";import"./useIsomorphicEffect-D7JMtAof.js";function Te({defaultValue:l,name:u="custom",onChange:o,value:a}){const[g,r]=b.useState(a??l),t=b.useRef(null);t.current===null&&(t.current=a!==void 0);function h(d){const p=typeof d=="function"?d(g):d;t.current===!1&&r(p),o&&o(p)}return b.useEffect(()=>{const d=a!==void 0;t.current,t.current},[u,a]),t.current===!0?[a,h]:[g,h]}const n=`${Q.prefix}--options-tile`,P="OptionsTile",ye={size:"lg"};let f=e.forwardRef(({children:l,className:u,enabled:o,invalid:a,invalidText:g,locked:r,lockedText:t,onChange:h,onToggle:d,open:p,size:X=ye.size,summary:Z,title:ee,titleId:ne,warn:x,warnText:te,...ie},ae)=>{const[le,se]=b.useState(p),[I,N]=b.useState(!1),[y,_]=Te({defaultValue:p||null,name:"OptionsTile",onChange:s=>h==null?void 0:h(s),value:p}),k=b.useRef(null),T=b.useRef(null),oe=Y(),$=ne??`${oe}-title`,re=l!==void 0,z=a,R=!z&&!(!z&&x)&&r,q=he();p!==le&&(y&&!p?L():!y&&p&&A(),se(p));function A(){if(k.current&&T.current&&!q){_(!0),k.current.open=!0;const{paddingTop:s,paddingBottom:m,height:c}=getComputedStyle(T.current);T.current.animate([{paddingTop:0,paddingBottom:0,height:0,opacity:0,overflow:"hidden"},{paddingTop:s,paddingBottom:m,height:c,opacity:1,overflow:"hidden"}],{duration:Number(B.replace("ms","")),easing:U.entrance.productive})}else _(!0)}function L(){if(T.current&&!q){N(!0);const{paddingTop:s,paddingBottom:m,height:c}=getComputedStyle(T.current),O=Number(B.replace("ms","")),C=T.current.animate([{paddingTop:s,paddingBottom:m,height:c,opacity:1},{paddingTop:0,paddingBottom:0,height:0,opacity:0}],{duration:O,easing:U.entrance.productive}),D=()=>{_(!1),N(!1)};setTimeout(()=>{D()},O*.9),C.oncancel=D}else _(!1)}function de(s){s.preventDefault(),y?L():A()}function W(){let s=null,m=Z;const c=[`${n}__summary`];I&&c.push(`${n}__summary--closing`),y&&c.push(`${n}__summary--open`),a?(s=be,m=g,c.push(`${n}__summary--invalid`)):x?(s=fe,m=te,c.push(`${n}__summary--warn`)):r&&(s=G,c.push(`${n}__summary--locked`),m||(m=t));const C=!(a||x||r)&&o===!1;return C&&c.push(`${n}__summary--hidden`),e.createElement("div",{className:`${n}__heading`},e.createElement("h6",{id:$,className:`${n}__title`},ee),m&&e.createElement("span",{className:S(c),"aria-hidden":C},s&&e.createElement(s,{size:16}),e.createElement("span",{className:`${n}__summary-text`},m)))}return e.createElement("div",{...ie,className:S(n,u,`${n}--${X}`,{[`${n}--closing`]:I}),ref:ae,...ge(P)},o!==void 0&&e.createElement("div",{className:`${n}__toggle-container`},e.createElement(me,{id:`${$}-toggle`,className:`${n}__toggle`,toggled:o,"aria-labelledby":$,hideLabel:!0,onToggle:d,size:"sm",disabled:R})),re?e.createElement("details",{open:y,ref:k},e.createElement("summary",{className:`${n}__header`,onClick:de},e.createElement(ce,{size:16,className:S(`${n}__chevron`,{[`${n}__chevron--open`]:y,[`${n}__chevron--closing`]:I})}),W()),e.createElement("div",{className:`${n}__content`,ref:T},e.createElement(ue,null,R&&e.createElement("p",{className:`${n}__locked-text`},e.createElement(G,{size:16}),t),l))):e.createElement("div",{className:`${n}__static-content`},W()))});f=Q.checkComponentEnabled(f,P);f.displayName=P;f.propTypes={children:i.node,className:i.string,enabled:i.bool,invalid:i.bool,invalidText:i.string,locked:i.bool,lockedText:i.string,onChange:i.func,onToggle:i.func,open:i.bool,size:i.oneOf(["lg","xl"]),summary:i.string,title:i.string.isRequired,titleId:i.string,warn:i.bool,warnText:i.string};f.__docgenInfo={description:"",methods:[],displayName:"OptionsTile",props:{children:{required:!1,tsType:{name:"ReactNode"},description:`Provide content to render as expandable OptionsTile. If no children
...
}`,...(M=(J=E.parameters)==null?void 0:J.docs)==null?void 0:M.source}}};const an=["optionsTile","staticOptionsTile"];export{an as __namedExportsOrder,tn as default,v as optionsTile,E as staticOptionsTile};
