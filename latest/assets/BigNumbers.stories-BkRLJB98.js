...
NB no need for a 'Playground' because all stories have all controls anyway.`,...(P=(F=i.parameters)==null?void 0:F.docs)==null?void 0:P.description}}};var A,X,R;m.parameters={...m.parameters,docs:{...(A=m.parameters)==null?void 0:A.docs,source:{originalSource:`args => {
  return <BigNumbers
  // TODO: handle events with action or local handler.
  // onTodo={action('onTodo log action')}
  {...args} />;
}`,...(R=(X=m.parameters)==null?void 0:X.docs)==null?void 0:R.source}}};const ze=["bigNumbers","withEditButton"];export{ze as __namedExportsOrder,i as bigNumbers,Ie as default,m as withEditButton};
