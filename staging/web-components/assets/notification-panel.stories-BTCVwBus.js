...
`,io=o=>class extends o{focus(){if(this.shadowRoot.delegatesFocus)super.focus();else{const e=this.shadowRoot.querySelector(gt)||this.querySelector(gt);e?e.focus():super.focus()}}};var no=xt([".cds--link{border:0;box-sizing:border-box;font-family:inherit;font-size:100%;margin:0;padding:0;vertical-align:baseline}.cds--link *,.cds--link :after,.cds--link :before{box-sizing:inherit}.cds--link{color:var(--cds-link-text-color,var(--cds-link-primary,#0f62fe));display:inline-flex;font-size:var(--cds-body-compact-01-font-size,.875rem);font-weight:var(--cds-body-compact-01-font-weight,400);letter-spacing:var(--cds-body-compact-01-letter-spacing,.16px);line-height:var(--cds-body-compact-01-line-height,1.28572);outline:none;text-decoration:none;transition:color 70ms cubic-bezier(.2,0,.38,.9)}.cds--link:hover{color:var(--cds-link-hover-text-color,var(--cds-link-primary-hover,#0043ce));text-decoration:underline}.cds--link:active:not(.cds--link--disabled),.cds--link:active:visited,.cds--link:active:visited:hover{outline:1px solid var(--cds-focus,#0f62fe)}@media screen and (prefers-contrast){.cds--link:active:not(.cds--link--disabled),.cds--link:active:visited,.cds--link:active:visited:hover{outline-style:dotted}}.cds--link:active:not(.cds--link--disabled),.cds--link:active:visited,.cds--link:active:visited:hover{color:var(--cds-link-text-color,var(--cds-link-primary,#0f62fe));outline-color:var(--cds-link-focus-text-color,var(--cds-focus,#0f62fe));text-decoration:underline}.cds--link:focus:not(.cds--link--disabled){outline:1px solid var(--cds-focus,#0f62fe)}@media screen and (prefers-contrast){.cds--link:focus:not(.cds--link--disabled){outline-style:dotted}}.cds--link:focus:not(.cds--link--disabled){outline-color:var(--cds-link-focus-text-color,var(--cds-focus,#0f62fe));text-decoration:underline}.cds--link:visited{color:var(--cds-link-text-color,var(--cds-link-primary,#0f62fe))}.cds--link:visited:hover{color:var(--cds-link-hover-text-color,var(--cds-link-primary-hover,#0043ce))}.cds--link--disabled,.cds--link--disabled:hover{border:0;box-sizing:border-box;font-family:inherit;font-size:100%;margin:0;padding:0;vertical-align:baseline}.cds--link--disabled *,.cds--link--disabled :after,.cds--link--disabled :before,.cds--link--disabled:hover *,.cds--link--disabled:hover :after,.cds--link--disabled:hover :before{box-sizing:inherit}.cds--link--disabled,.cds--link--disabled:hover{color:var(--cds-text-disabled,hsla(0,0%,9%,.25));cursor:not-allowed;font-size:var(--cds-body-compact-01-font-size,.875rem);font-weight:var(--cds-body-compact-01-font-weight,400);font-weight:400;letter-spacing:var(--cds-body-compact-01-letter-spacing,.16px);line-height:var(--cds-body-compact-01-line-height,1.28572);text-decoration:none}.cds--link.cds--link--visited,.cds--link.cds--link--visited:visited{color:var(--cds-link-visited-text-color,var(--cds-link-visited,#8a3ffc))}.cds--link.cds--link--visited:hover,.cds--link.cds--link--visited:visited:hover{color:var(--cds-link-hover-text-color,var(--cds-link-primary-hover,#0043ce))}.cds--link.cds--link--inline{display:inline;text-decoration:underline}.cds--link--disabled.cds--link--inline{text-decoration:underline}.cds--link--sm,.cds--link--sm.cds--link--disabled:hover{font-size:var(--cds-helper-text-01-font-size,.75rem);letter-spacing:var(--cds-helper-text-01-letter-spacing,.32px);line-height:var(--cds-helper-text-01-line-height,1.33333)}.cds--link--lg,.cds--link--lg.cds--link--disabled:hover{font-size:var(--cds-body-compact-02-font-size,1rem);font-weight:var(--cds-body-compact-02-font-weight,400);letter-spacing:var(--cds-body-compact-02-letter-spacing,0);line-height:var(--cds-body-compact-02-line-height,1.375)}.cds--link__icon{align-self:center;display:inline-flex;margin-inline-start:.5rem}:host(cds-link){outline:none}:host(cds-link) .cds--link--disabled{color:var(--cds-text-disabled,hsla(0,0%,9%,.25))}:host(cds-link) .cds--link__icon[hidden]{display:none}"]);const so=(o,e)=>{try{customElements.define(o,e)}catch{console.warn(`Attempting to re-define ${o}`)}return e},ao=(o,e)=>{const{kind:t,elements:i}=e;return{kind:t,elements:i,finisher(n){try{customElements.define(o,n)}catch{console.warn(`Attempting to re-define ${o}`)}}}},co=o=>e=>typeof e=="function"?so(o,e):ao(o,e),ro={MEDIUM:"md"};let x=class extends io(P){constructor(){super(...arguments),this._hasIcon=!1,this.disabled=!1,this.inline=!1,this.size=ro.MEDIUM,this.visited=!1}_handleSlotChange({target:e}){const{name:t}=e,i=e.assignedNodes().some(n=>n.nodeType!==Node.TEXT_NODE||n.textContent.trim());this[t==="icon"?"_hasIcon":""]=i,this.requestUpdate()}get _classes(){const{disabled:e,size:t,inline:i,visited:n,_hasIcon:a}=this;return k({[`${s}--link`]:!0,[`${s}--link--disabled`]:e,[`${s}--link--icon`]:a,[`${s}--link--inline`]:i,[`${s}--link--${t}`]:t,[`${s}--link--visited`]:n})}_handleClick(e){}_renderInner(){const{_hasIcon:e,_handleSlotChange:t}=this;return r`
    ...
    `}_renderLink(){const{download:e,href:t,hreflang:i,linkRole:n,ping:a,rel:c,target:z,type:u,_classes:g,_handleClick:E}=this;return r`
      <a
        tabindex="0"
        id="link"
        role="${C(n)}"
    ...
    `}render(){const{disabled:e}=this;return e?this._renderDisabledLink():this._renderLink()}};x.shadowRootOptions=Object.assign(Object.assign({},P.shadowRootOptions),{delegatesFocus:!0});x.styles=no;f([ft("#link")],x.prototype,"_linkNode",void 0);f([p({type:Boolean,reflect:!0})],x.prototype,"disabled",void 0);f([p({reflect:!0})],x.prototype,"download",void 0);f([p({reflect:!0})],x.prototype,"href",void 0);f([p({reflect:!0})],x.prototype,"hreflang",void 0);f([p({type:Boolean,reflect:!0})],x.prototype,"inline",void 0);f([p({attribute:"link-role"})],x.prototype,"linkRole",void 0);f([p({reflect:!0})],x.prototype,"ping",void 0);f([p({reflect:!0})],x.prototype,"rel",void 0);f([p({reflect:!0})],x.prototype,"size",void 0);f([p({reflect:!0})],x.prototype,"target",void 0);f([p({reflect:!0})],x.prototype,"type",void 0);f([p({type:Boolean,reflect:!0})],x.prototype,"visited",void 0);x=f([co(`${s}-link`)],x);let X;const po=new Uint8Array(16);function lo(){if(!X&&(X=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!X))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return X(po)}const _=[];for(let o=0;o<256;++o)_.push((o+256).toString(16).slice(1));function fo(o,e=0){return _[o[e+0]]+_[o[e+1]]+_[o[e+2]]+_[o[e+3]]+"-"+_[o[e+4]]+_[o[e+5]]+"-"+_[o[e+6]]+_[o[e+7]]+"-"+_[o[e+8]]+_[o[e+9]]+"-"+_[o[e+10]]+_[o[e+11]]+_[o[e+12]]+_[o[e+13]]+_[o[e+14]]+_[o[e+15]]}const vo=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),ut={randomUUID:vo};function I(o,e,t){if(ut.randomUUID&&!o)return ut.randomUUID();o=o||{};const i=o.random||(o.rng||lo)();return i[6]=i[6]&15|64,i[8]=i[8]&63|128,fo(i)}const{stablePrefix:ot}=U,ho=(o="light",e="large")=>{const t=I(),i=k({[`${ot}--empty-state__illustration`]:!0,[`${ot}--empty-state__illustration-error`]:!0,[`${ot}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
        ...
        `},{stablePrefix:et}=U,go=(o="light",e="large")=>{const t=I(),i=k({[`${et}--empty-state__illustration`]:!0,[`${et}--empty-state__illustration-noData`]:!0,[`${et}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:it}=U,uo=(o="light",e="large")=>{const t=I(),i=k({[`${it}--empty-state__illustration`]:!0,[`${it}--empty-state__illustration-noTags`]:!0,[`${it}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:nt}=U,_o=(o="light",e="large")=>{const t=I(),i=k({[`${nt}--empty-state__illustration`]:!0,[`${nt}--empty-state__illustration-notFound`]:!0,[`${nt}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:st}=U,bo=(o="light",e="large")=>{const t=I(),i=k({[`${st}--empty-state__illustration`]:!0,[`${st}--empty-state__illustration-notification`]:!0,[`${st}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:at}=U,mo=(o="light",e="lg")=>{const t=I(),i=k({[`${at}--empty-state__illustration`]:!0,[`${at}--empty-state__illustration-unauthorized`]:!0,[`${at}--empty-state__illustration--${e}`]:!0});return o==="dark"?r`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `};const{stablePrefix:Y}=U;function yo(o){const{title:e,subtitle:t,size:i,kind:n,illustrationTheme:a,hasIllustration:c}=o,z=k({[`${Y}--empty-state__header`]:!0,[`${Y}--empty-state__header--small`]:i==="sm"}),u=k({[`${Y}--empty-state___subtitle`]:!0,[`${Y}--empty-state__subtitle--small`]:i==="sm"});let g;if(!c)switch(n){case"error":g=ho(a,i);break;case"noData":g=go(a,i);break;case"noTags":g=uo(a,i);break;case"notFound":g=_o(a,i);break;case"notifications":g=bo(a,i);break;case"unauthorized":g=mo(a,i);break}return r`
...
`;function b(o=""){const e=t=>typeof crypto<"u"?crypto.getRandomValues(new Uint8Array(1))[0]&15>>t/4:Math.random()*16>>t/4;return`${o}${("10000000-1000-4000-8000"+-1e11).replace(/[018]/g,t=>(t^e(t)).toString(16))}`}const{action:m}=__STORYBOOK_MODULE_ACTIONS__,oe=new Date().getFullYear(),G=new Date(oe,0,1);let Tt=new Date(G);Tt.setDate(G.getDate()-1);let $=new Date(G);$.setDate(G.getDate()-2);const mt=6e4,ee=[{id:b(),type:"error",title:"LogDNA cannot be reached.",description:"Unable to communicate with LogDNA.",timestamp:new Date(new Date().getTime()-30*1e3),unread:!0,onNotificationClick:m("Clicked on notification")}],ie=[{id:b(),type:"error",title:"LogRhythm connection failure",description:"LogRhythm is failing to connect, check timeout.",timestamp:G,unread:!0,onNotificationClick:m("Clicked on notification")},{id:b(),type:"warning",title:"System alert",description:"Email classification was exported successfully.",timestamp:new Date(G.getTime()-11*mt),unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"success",title:"IBM Cloud Pak for Automation Success",description:"Successfully connected cartridge",timestamp:new Date(G.getTime()-120*mt),unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"success",title:"Successfully connected LogDNA",description:"App connection succeeded",timestamp:Tt,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"warning",title:"Cloud Foundry app memory",description:"Allocated app memory low",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"informational",title:"Logs are now being monitored",link:{text:"View logs",url:"https://www.carbondesignsystem.com"},timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:r`
      <p
    ...
    `,timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")},{id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:$,unread:!1,onNotificationClick:m("Clicked on notification")}],ne={id:b(),type:"error",title:"Cluster unreachable",description:"Not able to establish connection with provided cluster. Please check your logs and memory allocation to resolve this issue further.",timestamp:new Date(new Date().getTime()-30*1e3),unread:!0,onNotificationClick:m("Clicked on notification")},{action:yt}=__STORYBOOK_MODULE_ACTIONS__,q=`${y}--notifications-panel__notification`,R=`${y}--notifications-panel__story`,se=`${y}--notifications-panel`,ae={undefined:void 0,bg:"bg",cs:"cs","da-DK":"da-DK","de-CH":"de-CH",de:"de","en-AU":"en-AU","en-GB":"en-GB","en-US":"en-US","en-ZA":"en-ZA","es-ES":"es-ES",es:"es",et:"et",fi:"fi","fr-CA":"fr-CA","fr-CH":"fr-CH",fr:"fr",hu:"hu",it:"it",ja:"ja",lv:"lv","nl-BE":"nl-BE","nl-NL":"nl-NL",no:"no",pl:"pl","pt-BR":"pt-BR","pt-PT":"pt-PT","ru-UA":"ru-UA",ru:"ru",sk:"sk",sl:"sl",th:"th",tr:"tr","uk-UA":"uk-UA",vi:"vi"},Ut={args:{titleText:"Notifications",open:!0,todayText:"Today",previousText:"Previous",dismissAllLabel:"Dismiss all",emptyStateLabel:"You do not have any notifications",doNotDisturbLabel:"Do not disturb"},argTypes:{titleText:{control:"text",description:"Sets the Title for the Notification panel"},open:{description:"Determines whether the notifications panel should render or not"},todayText:{control:"text",description:"Sets the Today text for the Notification panel"},previousText:{control:"text",description:"Sets the Previous section title for the Notification panel"},dismissAllLabel:{control:"text",description:'Sets the label text for the "Dismiss all" button in the Notification panel'},emptyStateLabel:{control:"text",description:"Sets the empty state label text when there are no notifications"},doNotDisturbLabel:{control:"text",description:'Sets the label text for the "Do Not Disturb" toggle in the Notification panel'},dateTimeLocale:{control:"select",description:"The language for each notification's time stamp",options:ae}},render:function(e){const[t,i]=D([...ee]),[n,a]=D([...ie]),[c,z]=D(e.open),[u,g]=D(!1),[E,A]=D(!1),[Q,vt]=D(!1),Ot=document.querySelector("#trigger-button"),Lt=()=>{z(!c),A(!1),g(!1),setTimeout(()=>{vt(!1)},0)},Rt=()=>{i([]),a([])},Gt=()=>{i([ne,...t]),vt(!0)},ht=(l,J)=>{if(J==="today"){const B=t.filter(L=>L.id!==l);i([...B])}else{const B=n.filter(L=>L.id!==l);a([...B])}},At=l=>{z(!1);const J=t.map(L=>({...L,unread:!1})),B=n.map(L=>({...L,unread:!1}));i([...J]),a([...B])};return r`
      <style>
        ${Ao}
      </style>
      <cds-header aria-label="IBM Cloud Pak" class="${R}--header">
        ...
        <div class="${Dt}--header__global">
          <cds-header-global-action
            aria-label="User"
            tooltip-text="User"
            @click=${()=>{g(l=>!l)}}
          >
            ${u?S(tt,{slot:"icon"}):S(Vt,{slot:"icon"})}
          </cds-header-global-action>
          <cds-header-panel
            id="user-panel"
            .expanded="${u}"
          ...
          <cds-header-global-action
            ...
            @click="${Lt}"
          >
            ${c?S(tt,{slot:"icon"}):Q?te({slot:"icon"}):S(Ft,{slot:"icon"})}
          </cds-header-global-action>
          <cds-header-global-action
      ...
      >
        ${t.length>0?r`
              ${t.map(l=>r`
                  ...
                  >
                    <h4
                      class=${k({[`${q}-title`]:!0,[`${q}-title-unread`]:l.unread})}
                      slot="title"
                    >
                      ${l.title}
                    </h4>
    ...
    `}};async function ce(o,e){const t=document.querySelector(o);return await new Promise(i=>{const n=()=>{t&&t.shadowRoot?i(!0):requestAnimationFrame(n)};n()}),t.shadowRoot.querySelector(e)}const Oi={title:"Components/NotificationPanel"},V={...Ut},F={...Ut,play:async({userEvent:o})=>{const e=await ce("c4p-notification-panel",`.${se}__dismiss-button`);await o.click(e)}};V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
  ...defaultTemplate
...
}`,...F.parameters?.docs?.source}}};const Li=["Default","EmptyState"];export{V as Default,F as EmptyState,Li as __namedExportsOrder,Oi as default};
