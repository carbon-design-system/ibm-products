...
<Canvas>
  <Story of={PageHeaderStories.ContentWithContextualActionsAndPageActions} />
</Canvas>
...
<Canvas>
  <Story of={PageHeaderStories.ContentWithHeroImage} />
</Canvas>
...
<Canvas>
  <Story of={PageHeaderStories.TabBarWithTabsAndTags} />
</Canvas>
