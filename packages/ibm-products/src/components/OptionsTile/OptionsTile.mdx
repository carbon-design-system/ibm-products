  ...
  additionalActions={[
      {
        ...
        onClick: () => stackblitzPrefillConfig(stories.optionsTile, stories.default.component.displayName),
      },
    ]}>
</Canvas>
...
<Canvas
  ...
  additionalActions={[
      {
        title: 'Open in Stackblitz',
        onClick: () => stackblitzPrefillConfig(stories.staticOptionsTile, stories.default.component.displayName),
      },
    ]}>
</Canvas>
