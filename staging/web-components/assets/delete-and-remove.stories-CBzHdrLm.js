import{k as R,r as v,x as i,t as D,b as B,n as S}from"./iframe-CflQw5FD.js";import{r as a}from"./class-map-rvYMCB_X.js";import"./modal-label-2bZQyfEj.js";import"./toast-notification-DTC1L70K.js";import"./text-input-D1U9qo3W.js";import"./checkbox-2nlSrzED.js";import"./link-DUfYbXzM.js";import{s as O}from"./spread-CgNMLHME.js";import"./button-DU1j5wRX.js";import{s as M}from"./16-BLOyoxPI.js";const y=()=>{const e=new Date;let o=e.getHours();const n=e.getMinutes().toString().padStart(2,"0"),s=e.getSeconds().toString().padStart(2,"0"),t=o>=12?"PM":"AM";return o=o%12,o=o||12,`${o}:${n}:${s} ${t}`},z=":host cds-modal-body{padding-bottom:0}.no-bullets{list-style-type:none;padding-inline-start:2rem;margin:0}.notification{position:absolute;right:.75rem;top:.75rem}",w=R(z);var j=Object.defineProperty,T=Object.getOwnPropertyDescriptor,k=(e,o,n,s)=>{for(var t=s>1?void 0:s?T(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&j(o,n,t),t};let h=class extends v{constructor(){super(...arguments),this._open=!1,this._showNotification=!1,this._textInput="",this._enableDelete=!1}_close(){this._open=!1,this._textInput=""}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_setDeleteButtonState(){this._enableDelete=this._textInput==="Bx1001"}_onInputChange(e){this._textInput=e.target.value,this._setDeleteButtonState()}_onDelete(e){this._close(),this._showNotification=!0}render(){return i`
      <cds-button
        type="button"
        kind="danger"
        size="md"
 ...
 */function*I(e,o){if(e!==void 0){let n=0;for(const s of e)yield o(s,n++)}}const P=({children:e,...o}={})=>B`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${O(o)}" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16">${e}<path d="M13,14H3c-0.6,0-1-0.4-1-1V3c0-0.6,0.4-1,1-1h5v1H3v10h10V8h1v5C14,13.6,13.6,14,13,14z"></path><path d="M10 1L10 2 13.3 2 9 6.3 9.7 7 14 2.7 14 6 15 6 15 1z"></path></svg>`;var H=Object.defineProperty,A=Object.getOwnPropertyDescriptor,m=(e,o,n,s)=>{for(var t=s>1?void 0:s?A(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&H(o,n,t),t};let d=class extends v{constructor(){super(...arguments),this._open=!1,this._showNotification=!1,this._textInput="",this._enableDelete=!1,this._isCheckboxChecked=!1,this._connectedItems=[{name:"Route1_name"},{name:"Hpt-392-ser"},{name:"Route2_name"}]}_close(){this._open=!1,this._textInput="",this._isCheckboxChecked=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_setDeleteButtonState(){const e=this._textInput==="Bx1001";this._enableDelete=this._isCheckboxChecked&&e}_onInputChange(e){this._textInput=e.target.value,this._setDeleteButtonState()}_onCheckboxChange(e){this._isCheckboxChecked=e.detail.checked,this._setDeleteButtonState()}_onDelete(e){this._close(),this._showNotification=!0}render(){return i`
      ...
      ${this._showNotification?i`<cds-toast-notification
            ...
            @cds-notification-closed="${this._onNotificationClose}"
          ></cds-toast-notification>`:null}
    `}};d.styles=w;m([a()],d.prototype,"_open",2);m([a()],d.prototype,"_showNotification",2);m([a()],d.prototype,"_textInput",2);m([a()],d.prototype,"_enableDelete",2);m([a()],d.prototype,"_isCheckboxChecked",2);m([a()],d.prototype,"_connectedItems",2);d=m([D("delete-connected-items")],d);var V=Object.defineProperty,W=Object.getOwnPropertyDescriptor,u=(e,o,n,s)=>{for(var t=s>1?void 0:s?W(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&V(o,n,t),t};let r=class extends v{constructor(){super(...arguments),this._open=!1,this._showNotification=!1,this._enableDelete=!1,this._isCheckboxChecked=!1,this._batchItems=[{name:"Route1_name"},{name:"Hpt-392-ser"},{name:"Route2_name"}],this._protectedItems=[{name:"Route3_name"},{name:"Route4_name"}]}_close(){this._open=!1,this._isCheckboxChecked=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_setDeleteButtonState(){this._enableDelete=this._isCheckboxChecked}_onCheckboxChange(e){this._isCheckboxChecked=e.detail.checked,this._setDeleteButtonState()}_onDelete(e){this._close(),this._showNotification=!0}render(){return i`
      <cds-button
        type="button"
        kind="danger"
        size="md"
      ...
      ${this._showNotification?i`<cds-toast-notification
            ...
            @cds-notification-closed="${this._onNotificationClose}"
          ></cds-toast-notification>`:null}
    `}};r.styles=w;u([a()],r.prototype,"_open",2);u([a()],r.prototype,"_showNotification",2);u([a()],r.prototype,"_enableDelete",2);u([a()],r.prototype,"_isCheckboxChecked",2);u([a()],r.prototype,"_batchItems",2);u([a()],r.prototype,"_protectedItems",2);r=u([D("delete-batch")],r);var L=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,x=(e,o,n,s)=>{for(var t=s>1?void 0:s?Y(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&L(o,n,t),t};let p=class extends v{constructor(){super(...arguments),this._open=!1,this._showNotification=!1}_close(){this._open=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_onDelete(e){this._close(),this._showNotification=!0}render(){return i`
      <cds-button
        type="button"
        kind="danger"
        size="md"
      ...
      ${this._showNotification?i`<cds-toast-notification
            ...
            @cds-notification-closed="${this._onNotificationClose}"
          ></cds-toast-notification>`:null}
    `}};p.styles=w;x([S()],p.prototype,"action",2);x([a()],p.prototype,"_open",2);x([a()],p.prototype,"_showNotification",2);p=x([D("delete-remove-medium-impact")],p);const E=({children:e,...o}={})=>B`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${O(o)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${e}<path d="M16,4c6.6,0,12,5.4,12,12s-5.4,12-12,12S4,22.6,4,16S9.4,4,16,4 M16,2C8.3,2,2,8.3,2,16s6.3,14,14,14s14-6.3,14-14	S23.7,2,16,2z"></path><path d="M8 15H24V17H8z"></path></svg>`;var q=Object.defineProperty,F=Object.getOwnPropertyDescriptor,N=(e,o,n,s)=>{for(var t=s>1?void 0:s?F(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&q(o,n,t),t};let C=class extends v{constructor(){super(...arguments),this._showNotification=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._showNotification=!0}render(){return i`
      <cds-button
        type="button"
        kind="danger"
        size="md"
      ...
      >
        ${this.action==="delete"?"Delete":"Remove"}
        ${this.action==="delete"?i`${M({slot:"icon"})}`:i`${E({slot:"icon"})}`}
      </cds-button>
      ${this._showNotification?i`<cds-toast-notification
            class="notification"
            kind="success"
            ...
            @cds-notification-closed="${this._onNotificationClose}"
          ></cds-toast-notification>`:null}
    `}};C.styles=w;N([S()],C.prototype,"action",2);N([a()],C.prototype,"_showNotification",2);C=N([D("delete-remove-low-impact")],C);/**
 * @license
 *
...
}`,...g.parameters?.docs?.source}}};const J=["highImpactDeletion","deletionWithConnectedItems","batchDeletion","mediumImpactDeletion","lowImpactDeletion"],ie=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:J,batchDeletion:b,default:G,deletionWithConnectedItems:f,highImpactDeletion:_,lowImpactDeletion:g,mediumImpactDeletion:$},Symbol.toStringTag,{value:"Module"}));export{ie as D};
