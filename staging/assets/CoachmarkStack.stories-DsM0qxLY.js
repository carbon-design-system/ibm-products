import{r,e}from"./index-CPiZ6Cnx.js";import{c as $,P as a}from"./index-CXyjPnaX.js";import{L as V}from"./Link-EP4KkhUp.js";import{g as ce}from"./story-helper-U7E6Psyp.js";import{j as n}from"./jsx-runtime-Dc-z7RWI.js";import{useMDXComponents as Q}from"./index-CUO_02de.js";import"./chunk-NUUEMKO5-DAfSjhFL.js";import{al as me,aw as de,ak as he}from"./index-B_DdD064.js";import{r as Z}from"./index-BSHYryQu.js";import{g as ee}from"./devtools-CjVY-wQW.js";import{p as k,a as ue,B as z}from"./settings-iwZeeh4T.js";import{e as pe,b as fe,C as ke,a as ye,c as M,d as y}from"./CoachmarkOverlayElements-C7mWItLt.js";import{d as be}from"./props-helper-Dlg0HCIz.js";import{u as te}from"./useIsomorphicEffect-CqAX3nH-.js";import{S as ge}from"./SteppedAnimatedMedia-Br3UU9fE.js";import{I as Ce}from"./bucket-9-BSWQ2dSd.js";import{C as ve}from"./CoachmarkTagline-CuuRVT2v.js";import"./_commonjsHelpers-BosuxZz1.js";import"./tslib.es6-rrx6G-_s.js";import"./iframe-BFx4DPzL.js";import"../sb-preview/runtime.js";import"./react-18-C6q_qjn2.js";import"./index-Bsyy8W_U.js";import"./index-Df9so8jS.js";import"./index-DMCuvgYY.js";import"./index-DrFu-skq.js";import"./events-OVwOsPzJ.js";import"./index-DJK44odq.js";import"./uuidv4-BQrI85uz.js";import"./bucket-5-CJguTH3X.js";import"./lodash-CJO4g-jK.js";import"./Carousel-BahPB65p.js";import"./lottie-BZLE-Bwx.js";import"./clamp-DeQgleG0.js";import"./toNumber-CT-AZYiF.js";const N=`${k.prefix}--coachmark-stacked-home`,S=`${k.prefix}--coachmark-overlay`,I="CoachmarkStackHome";let O=r.forwardRef(({className:o,description:t,isOpen:E,media:i,renderMedia:q,navLinkLabels:j,onClickNavItem:w,onClose:P,portalTarget:L,closeButtonLabel:x,title:B,...R},A)=>{const l=r.useRef(null),[s,b]=r.useState(0),c=i||q;r.useEffect(()=>{setTimeout(()=>{E&&l.current&&l.current.focus()},100)},[E]);const m=r.useRef(null);if(te(()=>{m.current=L?(document==null?void 0:document.querySelector(L))??(document==null?void 0:document.querySelector("body")):document==null?void 0:document.querySelector("body")},[L]),!j)return ue.warn(`${I} is an Onboarding internal component and is not intended for general use.`);function d(u,p,H=null){return e.createElement("li",{key:u},e.createElement(z,{kind:"ghost",size:"sm",onClick:()=>{b(u),w(u+1)},ref:H},p))}return m!=null&&m.current?Z.createPortal(e.createElement("div",{...R,className:$(N,o),ref:A,...ee(I)},e.createElement(pe,{onClose:()=>{b(0),P()}}),e.createElement("div",{className:`${S}__body`},e.createElement("div",{className:`${S}-element`},!c&&e.createElement(Ce,{size:20,className:`${N}__icon-idea`}),c&&(i==null?void 0:i.render)&&i.render(),c&&(i==null?void 0:i.filePaths)&&e.createElement(ge,{className:`${N}__element-stepped-media`,filePaths:i.filePaths,playStep:0}),c&&q&&e.createElement("div",{className:`${N}__element-stepped-media`},q({playStep:0})),e.createElement("div",{className:`${S}-element__content`},B&&e.createElement("h2",{className:`${S}-element__title`},B),t&&e.createElement("p",{className:`${S}-element__body`},t)),e.createElement("ul",{className:`${N}__nav-links`},j.map((u,p)=>p===s?d(p,u,l):d(p,u))),x&&e.createElement("div",{className:`${S}__footer`},e.createElement(z,{size:"sm",onClick:()=>{b(0),P()}},x))))),m==null?void 0:m.current):null});O=k.checkComponentEnabled(O,I);O.displayName=I;O.propTypes={className:a.string,closeButtonLabel:a.string,description:a.node.isRequired,isOpen:a.bool.isRequired,media:be(a.oneOfType([a.shape({render:a.func}),a.shape({filePaths:a.arrayOf(a.string)})])),navLinkLabels:a.arrayOf(a.string.isRequired).isRequired,onClickNavItem:a.func.isRequired,onClose:a.func.isRequired,portalTarget:a.string,renderMedia:a.func,title:a.string.isRequired};O.__docgenInfo={description:`DO NOT USE. This component is for the exclusive use
...
NB no need for a 'Playground' because all stories have all controls anyway.`,...(J=(G=C.parameters)==null?void 0:G.docs)==null?void 0:J.description}}};const lt=["coachmarkStack"];export{lt as __namedExportsOrder,C as coachmarkStack,it as default};
