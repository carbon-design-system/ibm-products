import{k as o,x as a}from"./iframe-f5hh7K5H.js";import"./full-page-error-DBBLgBZX.js";const c=".full-page-error-stories__story-container{grid-template-rows:3rem 1fr;block-size:100vh;inline-size:100vw;display:grid;position:fixed;inset-block-start:0;inset-inline-start:0}.full-page-error-stories__story-header{background:var(--cds-background-inverse,#393939)}",i=o(c),t={kind:{control:{type:"select"},options:["403","404","custom"]}},r={args:{class:"custom-class",label:"Error ###",title:"[Error title]",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.",kind:"custom"},argTypes:t,render:e=>a`
      <style>
        ${i}
      </style>
