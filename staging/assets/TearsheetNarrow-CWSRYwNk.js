import{P as e}from"./index-C360Eztx.js";import{p as l,B as n}from"./settings-CFkY3W_8.js";import{T as p,t as c,p as d}from"./TearsheetShell-JEF80Hpr.js";import{e as a}from"./index-DtHxqM--.js";import{p as h,a as m}from"./props-helper-CSyPWdyB.js";import{g as f}from"./devtools-XPxnGn1y.js";import{A as u}from"./ActionSet-Du6AS19V.js";const o="TearsheetNarrow",y={verticalPosition:"lower"};let t=a.forwardRef(({verticalPosition:s=y.verticalPosition,...r},i)=>a.createElement(p,{...f(o),...h(r,c),verticalPosition:s,ref:i,size:"narrow"}));t=l.checkComponentEnabled(t,o);t.displayName=o;const g={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:m([u.validateActions(()=>"lg"),e.arrayOf(e.shape({...n.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:n.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string,description:e.node,hasCloseIcon:e.bool,label:e.node,onClose:e.func,open:e.bool,portalTarget:d,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...g};t.__docgenInfo={description:`A narrow tearsheet is a slimmer variant of the tearsheet, providing a dialog
