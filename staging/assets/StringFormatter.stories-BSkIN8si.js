...
`,t.jsx(D,{})]})}function I(o={}){const{wrapper:e}={...F(),...o.components};return e?t.jsx(e,{...o,children:t.jsx(b,{...o})}):b(o)}const B=".storyStringFormatter{font-size:var(--cds-body-01-font-size, .875rem);font-weight:var(--cds-body-01-font-weight, 400);line-height:var(--cds-body-01-line-height, 1.42857);letter-spacing:var(--cds-body-01-letter-spacing, .16px);margin:2rem;color:var(--cds-text-primary, #161616)}",le={title:"Experimental/Components/String formatter/StringFormatter",component:a,tags:["autodocs"],parameters:{styles:B,docs:{page:I},layout:"fullscreen"}},C=o=>c.createElement(a,{className:"storyStringFormatter",...o}),H="Buttons are used to initialize an action, either in the background or foreground of an experience. There are several kinds of buttons. Primary buttons should be used for the principle call to action on the page. Secondary buttons should be used for secondary actions on each page. Danger buttons should be used for a negative action (such as Delete) on the page. Modify the behavior of the button by changing its event properties. Small buttons may be used when there is not enough space for a regular sized button. This issue is most found in tables. Small button should have three words or less. When words are not enough, icons can be used in buttons to better communicate what the button does. Icons are always paired with text.",i=C.bind({});i.args={lines:1,truncate:!0,value:H,width:"200px",tooltipDirection:"bottom-left"};var O,v,y,x,_;i.parameters={...i.parameters,docs:{...(O=i.parameters)==null?void 0:O.docs,source:{originalSource:`args => {
...
NB no need for a 'Playground' because all stories have all controls anyway.`,...(_=(x=i.parameters)==null?void 0:x.docs)==null?void 0:_.description}}};const ce=["stringFormatter"];export{ce as __namedExportsOrder,le as default,i as stringFormatter};
