import{el as e,e as r}from"./iframe-HX3uP5rF.js";import{F as o,u as d}from"./index-D2lKpEPM.js";import{useMDXComponents as l}from"./index-BvpUgIFr.js";import{W as c}from"./index-DckS2hDR.js";import"./props-helper-BQIeo-gE.js";import"./index-DMCXImGW.js";import"./bucket-10-DxX4pcgn.js";import"./bucket-19-DB0RW10U.js";function s(a){const t={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...l(),...a.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`})})]})}function i(a={}){const{wrapper:t}={...l(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(s,{...a})}):s(a)}const F={title:"Experimental/FeatureFlags",component:o,tags:["autodocs"],parameters:{docs:{page:i}},decorators:[a=>r.createElement(c,{flags:{"enable-test-flag-a":!0}},r.createElement(a,null))]},u=()=>d("enable-test-flag-a")&&r.createElement("div",null,"I am a feature flagged component that has been enabled."),n=u.bind({});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
...
}`,...n.parameters?.docs?.source}}};const y=["exampleFeatureFlag"];export{y as __namedExportsOrder,F as default,n as exampleFeatureFlag};
