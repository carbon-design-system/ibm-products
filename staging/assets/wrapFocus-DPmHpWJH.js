import"./index-DzvNrmz8.js";import{p as d,D as b,U as u,V as N}from"./index-5As4T26e.js";const D=(t,e,n)=>{if(d(t,b))return(e+1)%n;if(d(t,u))return(e+n-1)%n},O=typeof Node<"u"&&Node.DOCUMENT_POSITION_PRECEDING|Node.DOCUMENT_POSITION_CONTAINS,p=typeof Node<"u"&&Node.DOCUMENT_POSITION_FOLLOWING|Node.DOCUMENT_POSITION_CONTAINED_BY,f=`
