  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        stackblitzPrefillConfig({
          ...
          customImports: [`import { Crossroads } from '@carbon/react/icons';`],
          styles: CoachmarkStories.default.parameters.styles,
        }),
    },
  ]}
...
[GitHub](https://github.com/carbon-design-system/carbon-for-ibm-products/edit/main/packages/ibm-products/src/components/Coachmark/next/Coachmark/Coachmark.mdx)
