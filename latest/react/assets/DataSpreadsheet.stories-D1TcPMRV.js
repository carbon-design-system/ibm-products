import{j as t,aA as y,aC as E,aB as H,r as n,e as s}from"./iframe-BbXUUjd_.js";import{useMDXComponents as b}from"./index-BoPKpxEO.js";import{O as v}from"./index-Bit37Dcs.js";import{O as A}from"./OverflowMenuItem-CKgNgQFP.js";import{D as d}from"./DataSpreadsheet-BF3H04U6.js";import"./preload-helper-PPVm8Dsz.js";import"./useAttachedMenu-kpO217Y9.js";import"./environment-DRRHKtsv.js";import"./mergeRefs-BZpmU3mx.js";import"./bucket-13-DpTpFo6N.js";import"./wrapFocus-Wym4UGgT.js";import"./useOutsideClick-DTSzTXra.js";import"./Text-Bbz3GFY2.js";import"./index.esm-PtBsoDXv.js";import"./uuidv4-BN2rGLQG.js";import"./usePreviousValue-CCx64fdl.js";import"./inheritsLoose-DHKJTbHM.js";import"./props-helper-DXuQWHiI.js";import"./devtools-c1cFm99f.js";import"./getNodeTextContent-C8IeKkUQ.js";const S=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],f=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],L=e=>{const a=[];for(let r=0;r<e;r++)a.push(r);return a},j=e=>{const a=e&&{ownerName:f[Math.floor(Math.random()*f.length)],weight:Math.floor(Math.random()*40)},r={petType:S[Math.floor(Math.random()*S.length)],firstName:f[Math.floor(Math.random()*f.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...r,...a}:r},w=({rows:e,extraColumns:a})=>((o=0)=>{const m=[e][o];return L(m).map(()=>({...j(a)}))})();function M(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...b(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
...
}`,...C.parameters?.docs?.source}}};const de=["dataSpreadsheet","largeDatasetSpreadsheet","largeDatasetSpreadsheetCustom","emptyWithCells","withManyColumns","withDifferentOptions","withDragDropCallback"];export{de as __namedExportsOrder,i as dataSpreadsheet,ce as default,h as emptyWithCells,u as largeDatasetSpreadsheet,p as largeDatasetSpreadsheetCustom,g as withDifferentOptions,C as withDragDropCallback,D as withManyColumns};
//# sourceMappingURL=DataSpreadsheet.stories-D1TcPMRV.js.map
