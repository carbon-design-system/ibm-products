...
import { CreateFullPageSectionPrototype } from './CreateFullPageSectionPrototype';
...
export const createFullPageWithToggle = prepareStory(TemplateWithToggle, {
  args: {
