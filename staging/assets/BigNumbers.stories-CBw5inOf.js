import{p as j,j as e,T as te,B as oe}from"./settings-DEdZ0TrD.js";import{c as g}from"./floating-ui.core.mjs-LzsX8FoD.js";import{useMDXComponents as X}from"./index-DlpNa54Y.js";import"./chunk-HLWAVYOI-ppvdP2zW.js";import{e as C,i as k,C as ne}from"./index-DUEQWFC3.js";import{R as M}from"./index-BwDkhjyp.js";import{P as n}from"./index-Dk74W0Oi.js";import{g as x}from"./devtools-BMJcATO0.js";import{S as $}from"./SkeletonText-CfIwLT9n.js";import{T as ae}from"./TooltipTrigger-98B6Xbeu.js";import{d as re}from"./bucket-9-CaYeOo1b.js";import{c as se}from"./bucket-0-DWSbtM9A.js";import{a as le}from"./bucket-6-COExmpDO.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-BwXSUnsA.js";import"./index-CtP8jiW9.js";import"./index-BONylQH5.js";import"./iframe-CsPi-Tl1.js";import"../sb-preview/runtime.js";import"./react-18-Dd3bHtks.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";const r={Default:"default",Large:"lg",XLarge:"xl"},L={Dash:"–",Slash:"/"},G="en-US",q=(o,t,c,d)=>t==null||typeof t!="number"?null:d?Intl.NumberFormat(o,{notation:"compact",minimumFractionDigits:0,maximumFractionDigits:Math.round(c)}).format(t):Intl.NumberFormat(o).format(t),ie=o=>{switch(o){case r.Large:return 20;case r.XLarge:return 24;default:return 16}},ce=o=>Intl.NumberFormat.supportedLocalesOf(o).length>0?o:G,a=`${j.prefix}--big-numbers`,m=`${j.prefix}--big-numbers-skeleton`,f="BigNumbers",s={forceShowTotal:!1,fractionDigits:1,loading:!1,locale:G,percentage:!1,size:r.Default,total:0,trending:!1,truncate:!0,value:null};let i=M.forwardRef(({className:o,forceShowTotal:t=s.forceShowTotal,fractionDigits:c=s.fractionDigits,iconButton:d,loading:b=s.loading,label:W,locale:Z=s.locale,percentage:N=s.percentage,size:h=s.size,tooltipDescription:w,total:v=s.total,trending:Q=s.trending,truncate:T=s.truncate,value:B=s.value,..._},S)=>{const Y=g(o,{[`${a}--lg`]:h===r.Large,[`${a}--xl`]:h===r.XLarge}),D=ce(Z),y=q(D,B,c,T)??L.Dash,O=q(D,v,c,T)??"Unknown",ee=!N&&v>B&&y!==O||t&&v>0;return b?e.jsx(H,{..._,ref:S,className:o,size:h,...x(f)}):e.jsxs("div",{..._,className:g(a,Y,o),ref:S,...x(f),children:[e.jsxs("span",{className:`${a}__row`,children:[e.jsx("h4",{className:`${a}__label`,children:W}),w&&e.jsx(te,{description:w,align:"right",className:`${a}__info`,children:e.jsx(ae,{className:`${a}__tooltip-trigger`,children:e.jsx(re,{size:16})})})]}),e.jsxs("span",{className:`${a}__row`,role:"math",children:[Q&&e.jsx(se,{className:`${a}__trend`,size:ie(h)}),e.jsx("span",{className:`${a}__value`,children:N?e.jsxs("div",{className:`${a}__percentage`,children:[y,e.jsx("span",{className:`${a}__percentage-mark`,children:"%"})]}):y}),ee&&e.jsx("span",{className:`${a}__total`,children:e.jsxs("span",{children:[L.Slash,O]})}),d]})]})});i=j.checkComponentEnabled(i,f);i.displayName=f;i.propTypes={className:n.string,forceShowTotal:n.bool,fractionDigits:n.number,iconButton:n.node,label:n.string.isRequired,loading:n.bool,locale:n.string,percentage:n.bool,size:n.oneOf(Object.values(r)),tooltipDescription:n.string,total:n.number,trending:n.bool,truncate:n.bool,value:n.number};let H=M.forwardRef(({className:o,size:t,...c},d)=>{const b=g(o,{[`${m}--lg`]:t===r.Large,[`${m}--xl`]:t===r.XLarge});return e.jsxs("div",{...c,className:g(o,m,b),ref:d,...x(f),children:[e.jsx($,{className:`${m}__label`}),e.jsx($,{heading:!0,className:`${m}__value`,width:"80%"})]})});H.propTypes={className:n.string,size:n.oneOf(Object.values(r))};i.__docgenInfo={description:`BigNumbers is used to display large values in a small area. The display of
...
@type string`,type:{name:"string"},required:!1}}};function E(o){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...X(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"bignumbers",children:"BigNumbers"}),`
