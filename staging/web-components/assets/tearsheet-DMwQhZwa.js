import{u as X,j as t,M as Z,A as z}from"./blocks-cZ5h9mXq.js";import{n as R,r as F,B as u,x as n,c as ee,z as te,E as O,A as J,G as se}from"./iframe-Be8Zv5F4.js";import{s as H}from"./tearsheet-summary-content-DDmucrHt.js";import{r as B}from"./state-yUR2oP26.js";import{o as ne}from"./index-DQuUfJx4.js";import{i as c}from"./icon-loader-CkFMeExi.js";import{_ as m,a as re,b as M}from"./32-gWGFBCOY.js";import"./progress-step-TkFSsGcp.js";import"./text-input-DJOAA_yF.js";import"./text-input-skeleton-EAebhCbN.js";import"./button-rtq4s5rI.js";import"./button-skeleton-DIbveJlF.js";import{S as ae}from"./step-group-CUzzOiDm.js";import{e as L,n as N}from"./ref-BeHtf_Xa.js";import{_ as I}from"./32-Dvc1-m7_.js";import"./definition-tooltip-BaiLMn_A.js";import"./tab-skeleton-bmQ2EG1O.js";import"./tabs-vertical-1aLioQaz.js";import"./progress-bar-CyUu11mF.js";import"./textarea-skeleton-CmvAmfhF.js";import"./slug-action-button-DpDYzAd0.js";import"./dropdown-skeleton-CKkmfJhQ.js";import"./toast-notification-DxJN0oN0.js";import"./actionable-notification-button-B7Eng9D9.js";import"./callout-notification-Cax2c2wu.js";var ie=Object.defineProperty,oe=Object.getOwnPropertyDescriptor,K=(s,e,a,o)=>{for(var r=o>1?void 0:o?oe(e,a):e,l=s.length-1,d;l>=0;l--)(d=s[l])&&(r=(o?d(e,a,r):d(r))||r);return o&&r&&ie(e,a,r),r};let P=class extends F{constructor(){super(...arguments),this.stackStepSize="lg",this._isActive=!1}connectedCallback(){super.connectedCallback(),H.setStackStepSize(this.stackStepSize),this._isActive=!0,this.dispatchEvent(new CustomEvent(`${u}-tearsheet-stack-connected`,{bubbles:!0,composed:!0,detail:{stackStepSize:this.stackStepSize}}))}disconnectedCallback(){super.disconnectedCallback(),this._isActive&&(H.reset(),this._isActive=!1)}updated(s){super.updated(s),s.has("stackStepSize")&&(H.setStackStepSize(this.stackStepSize),this.dispatchEvent(new CustomEvent(`${u}-tearsheet-stack-step-size-changed`,{bubbles:!0,composed:!0,detail:{stackStepSize:this.stackStepSize}})))}render(){return n`<slot></slot>`}};P.styles=[];K([R({type:String,attribute:"stack-step-size"})],P.prototype,"stackStepSize",2);P=K([ee(`${u}-tearsheet-stack`)],P);const ce="c4p-tearsheet-influencer,div[slot=main-content],c4p-tearsheet-summary-content{padding-block:2rem}.summaryPanelTrigger{position:absolute;inset-block-start:0;inset-inline-end:0}.influencerPanelTrigger{position:absolute;inset-block-start:0;inset-inline-start:0}@media(min-width:66rem)and (max-width:82rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}@media(min-width:42rem)and (max-width:66rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}@media(min-width:82rem)and (max-width:99rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}@media(min-width:99rem){c4p-preview-tearsheet:not([variant=narrow]) .summaryPanelTrigger,c4p-preview-tearsheet:not([variant=narrow]) .influencerPanelTrigger{display:none}}.summaryPanelHeading{font-size:var(--cds-heading-03-font-size, 1.25rem);font-weight:var(--cds-heading-03-font-weight, 400);line-height:var(--cds-heading-03-line-height, 1.4);letter-spacing:var(--cds-heading-03-letter-spacing, 0)}@media(min-width:20rem)and (max-width:42rem){.stackButtons{display:none}}@media(min-width:66rem)and (max-width:82rem){.smallScreenButton{display:none}}@media(min-width:42rem)and (max-width:66rem){.smallScreenButton{display:none}}@media(min-width:82rem)and (max-width:99rem){.smallScreenButton{display:none}}@media(min-width:99rem){.smallScreenButton{display:none}}.default__action-buttons{display:grid;grid-auto-rows:minmax(auto,auto);grid-template-columns:repeat(6,1fr)}.default__action-buttons>cds-button{inline-size:100%;max-inline-size:none}.default__action-buttons>cds-button:first-child{grid-column:span 4}",p=te(ce);var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,W=(s,e,a,o)=>{for(var r=o>1?void 0:o?de(e,a):e,l=s.length-1,d;l>=0;l--)(d=s[l])&&(r=(o?d(e,a,r):d(r))||r);return o&&r&&le(e,a,r),r};let C=class extends ne(F){constructor(){super(...arguments),this.horizontal=!1,this._open=!1,this._stepInfo=new ae}connectedCallback(){super.connectedCallback(),this._stepInfo.updateTotalStepCount=3}_onButtonClick(){this._open=!0}_handleCancelButton(){this._open=!1,this._stepInfo.reset()}_handleBackButton(){const{currentStep:s}=this._stepInfo.data;if(s!==0)return this._stepInfo.handlePrevious()}_handleNextButton(){const{currentStep:s,totalSteps:e}=this._stepInfo.data;if(s+1===e){console.log("Form submitted:",this._stepInfo.data.formState),this._handleCancelButton();return}return this._stepInfo.handleNext()}_handleEmailInput(s){const e=structuredClone(this._stepInfo.data.formState);e.email=s.target.value,this._stepInfo.updateFormState=e}_handleCityInput(s){const e=structuredClone(this._stepInfo.data.formState);e.city=s.target.value,this._stepInfo.updateFormState=e}_handleStateInput(s){const e=structuredClone(this._stepInfo.data.formState);e.state=s.target.value,this._stepInfo.updateFormState=e}_toggleInfluencerPanel(){const s=this.shadowRoot?.querySelector(`${u}-tearsheet-influencer`);s&&s.toggleAttribute("influencer-panel-open")}_getStepContent(){const{formState:s,currentStep:e}=this._stepInfo.data,a=s;switch(e){case 0:return n`
          <div>
            <cds-text-input
              label="Email"
              id="step-email-input"
      ...
      >
        <c4p-tearsheet-header ?hideCloseButton="${!1}">
          ...
          ${this.horizontal?n`<cds-progress-indicator>
                ...
                ></cds-progress-step>
              </cds-progress-indicator>`:O}
        </c4p-tearsheet-header>

        <!-- Influencer with Progress Indicator -->
        ${this.horizontal?O:n` <c4p-tearsheet-influencer>
    ...
    `}};C.styles=p;W([R({type:Boolean})],C.prototype,"horizontal",2);W([B()],C.prototype,"_open",2);C=W([J("step-tearsheet-preview")],C);var he=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,_=(s,e,a,o)=>{for(var r=o>1?void 0:o?pe(e,a):e,l=s.length-1,d;l>=0;l--)(d=s[l])&&(r=(o?d(e,a,r):d(r))||r);return o&&r&&he(e,a,r),r};let b=class extends F{constructor(){super(...arguments),this.tearsheetType="wide",this._open1=!1,this._open2=!1,this._open3=!1,this._launcherButtonRef1=L(),this._launcherButtonRef2=L(),this._launcherButtonRef3=L()}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}_toggleTearsheet1(){this._open1=!this._open1}_toggleTearsheet2(){this._open2=!this._open2}_toggleTearsheet3(){this._open3=!this._open3}render(){const s=n`
    ...
    `}};b.styles=p;_([R({type:String,attribute:"tearsheet-type"})],b.prototype,"tearsheetType",2);_([B()],b.prototype,"_open1",2);_([B()],b.prototype,"_open2",2);_([B()],b.prototype,"_open3",2);b=_([J("stacking-tearsheet-demo")],b);const i="tearsheet-preview-stories",E=(s="wide")=>{const e=`(max-width: ${se.md.width})`;return window.matchMedia(e).matches||s==="narrow"?"xl":"2xl"},A=s=>{if(s==="WITH_AI_LABEL")return n`
      ...
      `},h=()=>{document.querySelector(`${u}-preview-tearsheet`)?.toggleAttribute("open")},Q=()=>{const s=document.querySelector(`${u}-tearsheet-influencer`);s&&s.toggleAttribute("influencer-panel-open")},G=()=>{const s=document.querySelector(`${u}-tearsheet-summary-content`);s&&s.toggleAttribute("summary-panel-open")},T=n` <c4p-truncated-text
  slot="description"
  lines="2"
  type="expand"
...
></c4p-truncated-text>`,V=s=>n`<cds-progress-indicator ?vertical=${s} current-index="1">
    <cds-progress-step
    ...
    <cds-progress-step
      ...
      label="Fifth step"
    ></cds-progress-step>
  </cds-progress-indicator>`,ue=n` <cds-tabs value="tab-1">
...
</cds-tabs>`,be=n` <div class="tabs-demo">
...
</div>`,q=n`  <div class="rightDetailsBody">
 <Heading class="summaryPanelHeading">Summary Details</Heading>
  ...
  <div class="${i}textarea-container">
      ...
      >
        ...
        <c4p-tearsheet-body>
          ...
          ${s.showSummaryContent?n`<c4p-tearsheet-summary-content slot="summary-content"
                >${q}</c4p-tearsheet-summary-content
              >`:""}
        </c4p-tearsheet-body>
        <c4p-tearsheet-footer
          variant="${s.variant}"
    ...
    ${T}
      ...
      <div slot="header-actions">
            <cds-button size="sm" kind="tertiary" 
              >Primary action ${c(M,{slot:"icon"})}</cds-button
            >
          </div>
     </c4p-tearsheet-header-content>
      ...
      <c4p-tearsheet-influencer  >${V(!0)}</c4p-tearsheet-influencer>
       <c4p-tearsheet-body >
       <div  slot="main-content"> 
        <div class="influencerPanelTrigger">
              <cds-button
        ...
        ${D}</div>
       <c4p-tearsheet-summary-content   slot="summary-content">${q}</c4p-tearsheet-summary-content>
        </c4p-tearsheet-body>
        <c4p-tearsheet-footer
         variant="narrow"
         .actions="${[{kind:"ghost",label:"Cancel",onClick:h},{kind:"secondary",label:"Back"},{kind:"primary",label:"Submit"}]}"
    ...
    `},f={render:()=>n` <step-tearsheet-preview></step-tearsheet-preview> `},j={render:()=>n` <step-tearsheet-preview horizontal></step-tearsheet-preview> `},$={render:()=>n`
      <style>
        ${p}
      </style>
    ...
    `},me={title:"Preview/Tearsheet",parameters:{docs:{page:Y}},decorators:[s=>n` <style>
          #main-content {
            padding: 0;
          }
...
}`,...S.parameters?.docs?.source}}};const ve=["Default","WithInfluencer","WithTabs","narrowTearsheet","withSteps","withStepsAndHorizontalProgressIndicator","StackingTearsheets","StackingNarrowTearsheets","StackingWithDifferentSizes","WithCustomFooterActions"],ge=Object.freeze(Object.defineProperty({__proto__:null,Default:v,StackingNarrowTearsheets:w,StackingTearsheets:$,StackingWithDifferentSizes:k,WithCustomFooterActions:S,WithInfluencer:g,WithTabs:x,__namedExportsOrder:ve,default:me,narrowTearsheet:y,withSteps:f,withStepsAndHorizontalProgressIndicator:j},Symbol.toStringTag,{value:"Module"}));function U(s){const e={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...X(),...s.components};return t.jsxs(t.Fragment,{children:[t.jsx(Z,{of:ge}),`
...
`,t.jsxs(e.table,{children:[t.jsx(e.thead,{children:t.jsxs(e.tr,{children:[t.jsx(e.th,{children:"Slot"}),t.jsx(e.th,{children:"Description"})]})}),t.jsx(e.tbody,{children:t.jsxs(e.tr,{children:[t.jsx(e.td,{children:t.jsx(e.code,{children:"actions"})}),t.jsx(e.td,{children:"Action buttons (typically Cancel, Submit)"})]})})]})]})}function Y(s={}){const{wrapper:e}={...X(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(U,{...s})}):U(s)}const We=Object.freeze(Object.defineProperty({__proto__:null,default:Y},Symbol.toStringTag,{value:"Module"}));export{ge as T,We as t};
