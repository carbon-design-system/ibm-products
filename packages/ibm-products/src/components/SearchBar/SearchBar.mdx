...
<Canvas of={SearchBarStories.InitialValue} >
</Canvas>

### Scopes

<Canvas of={SearchBarStories.Scopes} >
</Canvas>

### Unsorted Scopes

<Canvas of={SearchBarStories.UnsortedScopes} >
</Canvas>

### Selected Scopes

<Canvas of={SearchBarStories.SelectedScopes} >
</Canvas>
