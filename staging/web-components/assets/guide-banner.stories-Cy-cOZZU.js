import{k as L,l as k,x as _}from"./iframe-DQyJnm4A.js";import{c as q}from"./repeat-9nn-acXU.js";import"./guide-banner-element-BK-le7JT.js";import{i as w}from"./icon-loader-D1vPuoPv.js";import{i as P,a as I}from"./20-CppOV_ea.js";const O=".body{color:var(--cds-text-primary,#161616)}.body-elm{inline-size:600px;padding-inline-start:3rem}.footer{justify-content:space-between;inline-size:100%;display:flex}.footer-left .guide-banner-story__toggle-button{margin-inline-start:2rem}",B=L(O),p=`${k}--snappy`,A=`${p}__elm`,c=`${p}__selection`;function D(e,n){const o=document.querySelector(e);if(!o)return;const t=document.createElement("style");t.textContent=`
  .${p} {
    display: flex;
    flex: none;
    overflow: scroll;
