# Carbon for IBM Products `UserAvatar` example
...
5. Review the changes made and restore/rectify the template TAGS typically in capitals. These are replaced as part of the build process. E.g. UserAvatar, 2024, import './config'
