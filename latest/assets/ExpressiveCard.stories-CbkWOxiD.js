import{j as n,p as ie}from"./settings-DDDiKwEV.js";import{a as ne,c as le,_ as ce,K as me}from"./floating-ui.react-BgNs4SA8.js";import{P as e}from"./index-Dk74W0Oi.js";import{R as de,r as ue}from"./index-BwDkhjyp.js";import{G as oe}from"./Grid-BKMg6DvV.js";import{C as re}from"./Column-EfHAxmlk.js";import{S as pe,a as ge}from"./index-C9z6BHTc.js";import{S as ye}from"./StoryDocsPage-CfmQO964.js";import{a as j}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as he}from"./devtools-C7Iu0rt6.js";import{p as fe}from"./props-helper-D2PZmIqz.js";import{C as Se}from"./Card-Dk9qopI-.js";import{b as xe,A as ve}from"./bucket-0-Cw-xsoio.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-Dp3Lalez.js";import"./index-BLdp044m.js";import"./index-BONylQH5.js";import"./index-BK1SMh4y.js";import"./bucket-17-B2E3mTyd.js";import"./index-Cfxh4ZWR.js";import"./iframe-D1NHqrr9.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./story-helper-BB2of0Wm.js";import"./tslib.es6-B4_xh3D5.js";import"./v4-CQkTLCs1.js";import"./index-D9ju4W2A.js";import"./Text-DpcC0Z3Y.js";import"./useAttachedMenu-Ba8a--1h.js";import"./mergeRefs-CTUecegF.js";import"./bucket-12-C33cLYA1.js";import"./wrapFocus-CuszVIVc.js";import"./index-Bd0eoXr0.js";import"./LayerContext-DbU-6VX4.js";import"./bucket-6-CS7rNrxx.js";import"./bucket-9-pcRs3_9u.js";const te=o=>{let{as:t="div",className:i,children:v,ratio:b="1x1",...l}=o;const c=ne(),C=le(i,`${c}--aspect-ratio`,`${c}--aspect-ratio--${b}`);return de.createElement(t,ce({className:C},l),v)};te.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let a=ue.forwardRef((o,t)=>{const i=fe(o,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.jsx(Se,{ref:t,...i,...he(z)})});a=ie.checkComponentEnabled(a,z);a.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),children:e.node,className:e.string,description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};a.displayName=z;a.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
...
}`,...(A=(G=g.parameters)==null?void 0:G.docs)==null?void 0:A.source}}};var D,W,K;y.parameters={...y.parameters,docs:{...(D=y.parameters)==null?void 0:D.docs,source:{originalSource:`opts => {
  const {
    children,
    columnSizeSm,
    columnSizeMd,
...
}`,...(K=(W=y.parameters)==null?void 0:W.docs)==null?void 0:K.source}}};var _,H,F;h.parameters={...h.parameters,docs:{...(_=h.parameters)==null?void 0:_.docs,source:{originalSource:`opts => {
  const {
    children,
    columnSizeSm,
    columnSizeMd,
...
}`,...(ee=(Z=x.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const dn=["Default","LabelOnly","WithCaption","WithMedia","WithActionIconHref","WithPictogram","WithSecondaryAction","Clickable","WithButtonHref","WithButtonIcon"];export{f as Clickable,m as Default,d as LabelOnly,g as WithActionIconHref,S as WithButtonHref,x as WithButtonIcon,u as WithCaption,p as WithMedia,y as WithPictogram,h as WithSecondaryAction,dn as __namedExportsOrder,mn as default};
