import{p as h,j as e,I as K,B as _}from"./settings-Bk-Ww79A.js";import{a as T}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{c as k,C as Q}from"./useMergedRefs-DoviDd4t.js";import{S as Z}from"./StoryDocsPage-D-hLaGzY.js";import{R as w,r as b}from"./index-BwDkhjyp.js";import{P as n}from"./index-Dk74W0Oi.js";import{g as v}from"./devtools-jK7s13u1.js";import{u as ee}from"./uuidv4-BQrI85uz.js";import{S as ne}from"./SteppedAnimatedMedia-ZdQsAcRy.js";import{a as te}from"./bucket-8-Wzu9_QkR.js";import{C as ie}from"./bucket-4-CVgtr9ST.js";import{L as oe}from"./Link-BwB-I-vI.js";import{e as se}from"./bucket-9-nWRGrQ7I.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-CiqBCP_Q.js";import"./index-8ToAQMOn.js";import"./index-BONylQH5.js";import"./v4-CQkTLCs1.js";import"./index-TffMvrPM.js";import"./iframe-DrDxz63W.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-BjQFKvNH.js";import"./isSymbol-BZYRlrjc.js";import"./index-DrFu-skq.js";import"./story-helper-Cn6RZn1q.js";import"./tslib.es6-B4_xh3D5.js";import"./lottie-D0UQuq7-.js";import"./clamp-DxEmERK6.js";import"./toNumber-DNhxxDfe.js";const C=i=>{var r;const s=((r=i==null?void 0:i.props)==null?void 0:r.children)||void 0;if(Array.isArray(i)){let a=[];return i.forEach(o=>{typeof o=="object"?a.push(C(o)):typeof o=="string"&&a.push(o)}),a.join(" ")}if(s===void 0)return typeof i=="string"?i:" ";if(typeof s=="object")return C(i.props.children);if(typeof s=="string")return i.props.children},t=`${h.prefix}--inline-tip`,j="InlineTip",c={closeIconDescription:"Close",collapsible:!1,collapseButtonLabel:"Read less",expandButtonLabel:"Read more",narrow:!1,withLeftGutter:!1,onClick:()=>{},onClose:()=>{},title:"Use case-specific heading"};let p=w.forwardRef(({action:i,children:s,className:r,closeIconDescription:a=c.closeIconDescription,collapsible:o=c.collapsible,collapseButtonLabel:I=c.collapseButtonLabel,expandButtonLabel:V=c.expandButtonLabel,media:l,narrow:g=c.narrow,onClick:G,onClose:O,tertiaryButtonLabel:x,title:F=c.title,withLeftGutter:X=c.withLeftGutter,...W},Y)=>{const[y,R]=b.useState(o),q=b.useRef(ee()).current,H=b.useMemo(()=>C(w.Children.toArray(s)),[s]);let B=s;return!l&&o&&y&&(B=e.jsx("p",{className:`${t}__preview-text`,children:H})),b.useEffect(()=>{R(o)},[o]),e.jsxs("div",{...W,"aria-labelledby":q,className:k(t,r,o&&`${t}__collapsible`,y&&`${t}__collapsible-collapsed`,l&&`${t}__has-media`,[g?`${t}__narrow`:`${t}__wide`],X&&!g&&`${t}__with-left-gutter`),ref:Y,role:"complementary",...v(j),children:[e.jsx("div",{className:`${t}__close-icon-wrapper`,children:e.jsx(K,{className:`${t}__close-icon`,kind:"ghost",label:a,onClick:O,size:"lg",children:e.jsx(Q,{size:16})})}),(!l&&g||!g)&&e.jsx("div",{className:`${t}__icon-idea`,tabIndex:-1,children:e.jsx(te,{size:16})}),e.jsxs("div",{className:`${t}__content`,children:[e.jsx("h6",{id:q,className:`${t}__title`,children:F}),e.jsxs("section",{className:`${t}__body`,children:[B,i&&(!o||o&&!y)&&e.jsx("div",{className:`${t}__secondary-btn`,children:i})]}),(o||x)&&e.jsxs("footer",{className:`${t}__footer`,children:[o&&!l&&e.jsx(_,{className:`${t}__toggle-btn`,kind:"ghost",size:"md",onClick:()=>{R(J=>!J)},children:y?V:I}),x&&e.jsx(_,{className:`${t}__close-btn`,size:"md",onClick:G,kind:"tertiary",renderIcon:()=>e.jsx(ie,{size:16}),children:x})]})]}),l&&(l.render?e.jsx("div",{className:`${t}__media`,children:l.render()}):e.jsx(ne,{className:`${t}__media`,filePaths:l.filePaths}))]})});p=h.checkComponentEnabled(p,j);p.displayName=j;p.propTypes={action:n.node,children:n.node.isRequired,className:n.string,closeIconDescription:n.string,collapseButtonLabel:n.string,collapsible:n.bool,expandButtonLabel:n.string,media:n.oneOfType([n.shape({render:n.func}),n.shape({filePaths:n.string})]),narrow:n.bool,onClick:n.func,onClose:n.func,tertiaryButtonLabel:n.string,title:n.string.isRequired,withLeftGutter:n.bool};p.__docgenInfo={description:`Inline tips are messages embedded within other components that
...
}`,...(U=(E=m.parameters)==null?void 0:E.docs)==null?void 0:U.source}}};const Oe=["inlineTip","inlineTipNarrow"];export{Oe as __namedExportsOrder,Ge as default,d as inlineTip,m as inlineTipNarrow};
