...
`,e.jsx(m,{children:e.jsx(u,{of:o})}),`
`,e.jsx(r.h2,{id:"example-usage",children:"Example usage"}),`
`,e.jsx(r.h3,{id:"with-sequence",children:"with Sequence"}),`
`,e.jsx(m,{children:e.jsx(u,{of:i})}),`
`,e.jsx(r.h3,{id:"with-media-and-pictogram",children:"with Media and Pictogram"}),`
`,e.jsx(m,{children:e.jsx(u,{of:s})}),`
`,e.jsx(r.h3,{id:"with-media-and-sequence",children:"with Media and Sequence"}),`
`,e.jsx(m,{children:e.jsx(u,{of:d})}),`
`,e.jsx(r.h2,{id:"code-sample",children:"Code sample"}),`
`,e.jsx(N,{exampleDirectory:"GetStartedCard"}),`
`,e.jsx(r.h2,{id:"component-api",children:"Component API"}),`
`,e.jsx(_,{})]})}function $(a={}){const{wrapper:r}={...D(),...a.components};return r?e.jsx(r,{...a,children:e.jsx(f,{...a})}):f(a)}const M=""+new URL("abstract-image-KeSi23KF.svg",import.meta.url).href,l={label:"Label",title:"Title",metadata:[{id:"1",icon:a=>e.jsx(F,{size:16,...a}),iconDescription:"2 mins"},{id:"2",icon:a=>e.jsx(K,{size:16,...a}),iconDescription:"Beginner"}],footerActionIcon:a=>e.jsx(U,{size:16,...a}),onClick:z("on click")},Me={title:"IBM Products/Onboarding/GetStartedCard",component:n,tags:["autodocs"],parameters:{docs:{page:$}},decorators:[a=>{const r=E();return e.jsx("div",{className:`${r}--grid`,children:a()})}]},p=a=>{const{children:r,...A}=a;return e.jsx(n,{label:"Prepare your data",title:"Generate synthetic Tabular data",...A,children:r})},o=p.bind({});o.args={...l,pictogram:a=>e.jsx(I,{size:32,...a})};const i=p.bind({});i.args={...l,sequence:3};const s=p.bind({});s.args={...l,pictogram:a=>e.jsx(I,{size:32,...a}),media:e.jsx("img",{src:M,alt:"abstract Image"})};const d=p.bind({});d.args={...l,sequence:3,media:e.jsx("img",{src:M,alt:"abstract Image"})};const c=p.bind({});c.args={...l,sequence:3,disabled:!0};var g,b,x;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`opts => {
  const {
    children,
    ...args
  } = opts;
...
}`,...(k=(O=c.parameters)==null?void 0:O.docs)==null?void 0:k.source}}};const Ae=["Default","withSequence","withMediaAndPictogram","withMediaAndSequence","withDisabled"];export{o as Default,Ae as __namedExportsOrder,Me as default,c as withDisabled,s as withMediaAndPictogram,d as withMediaAndSequence,i as withSequence};
