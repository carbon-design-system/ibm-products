...
`,t.jsxs(e.table,{children:[t.jsx(e.thead,{children:t.jsxs(e.tr,{children:[t.jsx(e.th,{children:"Slot"}),t.jsx(e.th,{children:"Description"})]})}),t.jsx(e.tbody,{children:t.jsxs(e.tr,{children:[t.jsx(e.td,{children:t.jsx(e.code,{children:"actions"})}),t.jsx(e.td,{children:"Action buttons (typically Cancel, Submit)"})]})})]})]})}function Q(s={}){const{wrapper:e}={...G(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(q,{...s})}):q(s)}const Me=Object.freeze(Object.defineProperty({__proto__:null,default:Q},Symbol.toStringTag,{value:"Module"}));export{me as T,Me as t};
