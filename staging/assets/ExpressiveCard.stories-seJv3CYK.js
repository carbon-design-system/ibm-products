import{j as n,p as ie}from"./settings-RejM0MIl.js";import{a as ne,c as le,_ as ce,L as me}from"./floating-ui.react-DMp4y4mM.js";import{P as e}from"./index-Dk74W0Oi.js";import{R as de,r as ue}from"./index-BwDkhjyp.js";import{G as oe}from"./Grid-B48mw25v.js";import{C as re}from"./Column-Ye7yCMUj.js";import{S as pe,a as ge}from"./index-CmlJpOw_.js";import{S as ye}from"./StoryDocsPage-D0ZlMQjf.js";import{a as j}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as he}from"./devtools-DM-SaWXd.js";import{p as fe}from"./props-helper-MxF4Ec7y.js";import{C as Se}from"./Card-DitTZeez.js";import{b as ve,A as xe}from"./bucket-0-BcfJCBD4.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-C3mJejkM.js";import"./index-CzgULgXp.js";import"./index-BONylQH5.js";import"./index-C8dDhlyb.js";import"./bucket-17-Ct9mOVQH.js";import"./index-D1h9ywnJ.js";import"./iframe-DoewZ_8I.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./story-helper-BJP0smTN.js";import"./tslib.es6-B4_xh3D5.js";import"./v4-CQkTLCs1.js";import"./index-CDqmW12E.js";import"./Text-DgK8TUAU.js";import"./useAttachedMenu-JDAsPBX5.js";import"./mergeRefs-CTUecegF.js";import"./bucket-12-jEhP6zSm.js";import"./wrapFocus-CuszVIVc.js";import"./index-DzDmuWYl.js";import"./LayerContext-DbU-6VX4.js";import"./bucket-6-W_rBHQkv.js";import"./bucket-9-BKm2PPAL.js";const te=o=>{let{as:t="div",className:i,children:x,ratio:b="1x1",...l}=o;const c=ne(),C=le(i,`${c}--aspect-ratio`,`${c}--aspect-ratio--${b}`);return de.createElement(t,ce({className:C},l),x)};te.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let a=ue.forwardRef((o,t)=>{const i=fe(o,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.jsx(Se,{ref:t,...i,...he(z)})});a=ie.checkComponentEnabled(a,z);a.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),children:e.node,className:e.string,description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};a.displayName=z;a.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
...
}`,...(N=(L=u.parameters)==null?void 0:L.docs)==null?void 0:N.source}}};var M,O,I;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`opts => {
  const {
    children,
    columnSizeSm,
    columnSizeMd,
...
}`,...(I=(O=p.parameters)==null?void 0:O.docs)==null?void 0:I.source}}};var P,G,A;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`opts => {
  const {
    children,
    columnSizeSm,
    columnSizeMd,
