...
```jsx
      ...
        <CreateTearsheetStep
          ...
          hasForm={false}
          >
          <fieldset className={`#{$pkg-prefix}--tearsheet-create__step--fieldset`}>
            <TextInput
              id="test-1"
              invalidText="A valid value is required"
              labelText="Topic name"
          ...
          <span className={`#{$pkg-prefix}--tearsheet-create__section--divider`} />
          <h4 className={`#{$pkg-prefix}--tearsheet-create__step--title`}>Required title</h4>
          <h6 className={`#{$pkg-prefix}--tearsheet-create__step--subtitle`}>
            Optional subtitle
          </h6>
          <p className={`#{$pkg-prefix}--tearsheet-create__step--description`}>
