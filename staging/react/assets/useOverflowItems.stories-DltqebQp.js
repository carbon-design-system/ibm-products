var w=Object.defineProperty;var i=(a,e)=>w(a,"name",{value:e,configurable:!0});import{u as p,j as n,aO as y,aU as I,r as o,R as s}from"./iframe-DQtlSwB0.js";import{u as O}from"./useOverflowItems-7KBEeWFA.js";import{T as h}from"./Tag-CpgNdznG.js";import{S as u}from"./Slider-DYICv0uH.js";import{A as R}from"./index-Bga74r8M.js";import{a as E}from"./bucket-7-DXZvdKTt.js";import"./preload-helper-Cc2_yIPf.js";import"./useResizeObserver-4UkoSMZU.js";import"./useIsomorphicEffect-CQiBpG0E.js";import"./Text-aeWWocZi.js";import"./DefinitionTooltip-Da2vOiUl.js";import"./index-HrSRrNhc.js";import"./index-DO9e1XXc.js";import"./bucket-19-BryqLv5V.js";import"./useNormalizedInputProps-c7o4VaT8.js";import"./bucket-20-BaUCyjiQ.js";import"./clamp-ekNJC_Xv.js";import"./bucket-11-D07ECrXB.js";function f(a){const e={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...p(),...a.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"useoverflowitems",children:"useOverflowItems"}),`
...
`]}),`
`]}),`
`]})]})}i(f,"_createMdxContent");function k(a={}){const{wrapper:e}={...p(),...a.components};return e?n.jsx(e,{...a,children:n.jsx(f,{...a})}):f(a)}i(k,"MDXContent");const K={title:"Utilities/useOverflowItems",parameters:{layout:"padded",docs:{page:k}},tags:["autodocs"]},H=i(()=>{const[a,e]=o.useState(500),[l,x]=o.useState(10),d=o.useRef(null),b=i(t=>Array(t).fill(null).map((m,c)=>({id:c,label:`Tag ${c+1}`})),"makeTags")(l),{visibleItems:g,hiddenItems:v,itemRefHandler:j}=O(b,d),T=i(t=>{e(t)},"widthHandler");return s.createElement("div",null,s.createElement(u,{className:"slider",max:1e3,min:200,value:a,onChange:i(({value:t})=>T(t),"onChange"),hideTextInput:!0,labelText:"Parent container width"}),s.createElement(u,{className:"slider",max:50,min:1,value:l,onChange:i(({value:t})=>x(t),"onChange"),hideTextInput:!0,labelText:"Number of total tags"}),s.createElement("div",{className:"parent",style:{width:`${a}px`}},s.createElement(R,{text:"Parent container",type:"layer",icon:E},s.createElement("div",{className:"child",ref:d},s.createElement("p",null,"Visible items:"),g.map(t=>s.createElement(h,{type:"blue",key:t.id,ref:i(m=>{j(t.id,m)},"ref")},t.label))),s.createElement("div",{className:"child"},s.createElement("p",null,"Hidden items:"),v.map(t=>s.createElement(h,{key:t.id,type:"blue"},t.label))))))},"Template"),r=H.bind({});r.args={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`() => {
...
}`,...r.parameters?.docs?.source}}};const Q=["Default"];export{r as Default,Q as __namedExportsOrder,K as default};
//# sourceMappingURL=useOverflowItems.stories-DltqebQp.js.map
