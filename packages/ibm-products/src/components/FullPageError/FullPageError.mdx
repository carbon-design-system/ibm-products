  ...
  additionalActions={[
    {
      ...
      onClick: () => stackblitzPrefillConfig(stories.fullPageError, [], [], stories.default.parameters.styles),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(stories.fullPageError403, [], [], stories.default.parameters.styles),
    },
  ]}
/>
...
<Canvas
  ...
  additionalActions={[
    {
      title: 'Open in Stackblitz',
      onClick: () => stackblitzPrefillConfig(stories.fullPageError404, [], [], stories.default.parameters.styles),
    },
  ]}
/>
