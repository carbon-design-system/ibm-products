import{p as u,a as ce,j as e,B as F}from"./settings-RejM0MIl.js";import{c as N}from"./floating-ui.react-DMp4y4mM.js";import{L as W}from"./Link-Gytx0Oe9.js";import{g as le}from"./story-helper-BJP0smTN.js";import{useMDXComponents as G}from"./index-DlpNa54Y.js";import"./chunk-HLWAVYOI-CqQ3qX2e.js";import{e as de,i as he,C as me}from"./index-BvMpw_97.js";import{r as a,R as ue}from"./index-BwDkhjyp.js";import{r as J}from"./index-BONylQH5.js";import{P as n}from"./index-Dk74W0Oi.js";import{g as Q}from"./devtools-DM-SaWXd.js";import{e as pe,b as fe,C as ke,a as ge,c as A,d as p}from"./CoachmarkOverlayElements-Yhgrzk-n.js";import{u as Z}from"./useIsomorphicEffect-D7JMtAof.js";import{S as ye}from"./SteppedAnimatedMedia-D3ovmKSK.js";import{I as be}from"./bucket-8-DE1gWGbL.js";import{C as xe}from"./CoachmarkTagline-BdDg6kcY.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJvxHwuA.js";import"./events-C3mJejkM.js";import"./index-CzgULgXp.js";import"./tslib.es6-B4_xh3D5.js";import"./iframe-Cx6l2hzy.js";import"../sb-preview/runtime.js";import"./react-18-Dd3bHtks.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./uuidv4-BQrI85uz.js";import"./bucket-5-CkJxodIN.js";import"./lodash-C6Eq4oiK.js";import"./Carousel-CKpjRqOI.js";import"./lottie-D0UQuq7-.js";import"./clamp-Bg2yowlN.js";import"./toNumber-DVQITUtX.js";const H=`${u.prefix}--coachmark-stacked-home`,y=`${u.prefix}--coachmark-overlay`,_="CoachmarkStackHome";let j=a.forwardRef(({className:s,description:t,isOpen:C,media:f,navLinkLabels:q,onClickNavItem:B,onClose:k,portalTarget:T,closeButtonLabel:L,title:v,...R},I)=>{const S=a.useRef(null),[d,r]=a.useState(0);a.useEffect(()=>{setTimeout(()=>{C&&S.current&&S.current.focus()},100)},[C]);const i=a.useRef(null);if(Z(()=>{i.current=T?(document==null?void 0:document.querySelector(T))??(document==null?void 0:document.querySelector("body")):document==null?void 0:document.querySelector("body")},[T]),!q)return ce.warn(`${_} is an Onboarding internal component and is not intended for general use.`);function h(l,o,O=null){return e.jsx("li",{children:e.jsx(F,{kind:"ghost",size:"sm",onClick:()=>{r(l),B(l+1)},ref:O,children:o})},l)}return i!=null&&i.current?J.createPortal(e.jsxs("div",{...R,className:N(H,s),ref:I,role:"main",...Q(_),children:[e.jsx(pe,{onClose:()=>{r(0),k()}}),e.jsx("div",{className:`${y}__body`,children:e.jsxs("div",{className:`${y}-element`,children:[!f&&e.jsx(be,{size:20,className:`${H}__icon-idea`}),f&&(f.render?f.render():e.jsx(ye,{className:`${y}__element-stepped-media`,filePaths:f.filePaths,playStep:0})),e.jsxs("div",{className:`${y}-element__content`,children:[v&&e.jsx("h2",{className:`${y}-element__title`,children:v}),t&&e.jsx("p",{className:`${y}-element__body`,children:t})]}),e.jsx("ul",{className:`${H}__nav-links`,children:q.map((l,o)=>o===d?h(o,l,S):h(o,l))}),L&&e.jsx("div",{className:`${y}__footer`,children:e.jsx(F,{size:"sm",onClick:()=>{r(0),k()},children:L})})]})})]}),i==null?void 0:i.current):null});j=u.checkComponentEnabled(j,_);j.displayName=_;j.propTypes={className:n.string,closeButtonLabel:n.string,description:n.node.isRequired,isOpen:n.bool.isRequired,media:n.oneOfType([n.shape({render:n.func}),n.shape({filePaths:n.arrayOf(n.string)})]),navLinkLabels:n.arrayOf(n.string.isRequired).isRequired,onClickNavItem:n.func.isRequired,onClose:n.func.isRequired,portalTarget:n.string,title:n.string.isRequired};j.__docgenInfo={description:`DO NOT USE. This component is for the exclusive use
