import{P as e}from"./index-5As4T26e.js";import{p as d,B as a}from"./settings-CP9zVSjJ.js";import{e as o}from"./index-DzvNrmz8.js";import{T as h,p as c}from"./TearsheetShell-BFzazQuq.js";import{a as m}from"./props-helper-DCsMHcG1.js";import{g as f}from"./devtools-B_dijMH7.js";import{A as u}from"./ActionSet-DdP2NI5x.js";const n="Tearsheet";let t=o.forwardRef(({influencerPosition:i="left",influencerWidth:r="narrow",children:s,...l},p)=>o.createElement(h,{...f(n),...l,influencerPosition:i,influencerWidth:r,ref:p,size:"wide"},s));t=d.checkComponentEnabled(t,n);t.displayName=n;const y={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:m([u.validateActions(()=>"2xl"),e.arrayOf(e.shape({...a.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:a.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string,description:e.node,hasCloseIcon:e.bool,headerActions:e.element,influencer:e.element,influencerPosition:e.oneOf(["left","right"]),influencerWidth:e.oneOf(["narrow","wide"]),label:e.node,launcherButtonRef:e.any,navigation:e.element,onClose:e.func,open:e.bool,portalTarget:c,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...y};t.__docgenInfo={description:`A tearsheet is a mostly full-screen type of dialog that keeps users
