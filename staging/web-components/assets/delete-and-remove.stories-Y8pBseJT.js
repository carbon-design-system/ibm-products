import{j as P,r as g,x as i,u as y,n as S}from"./iframe-DSdqiJWw.js";import{r as a}from"./state-EvD611k3.js";import"./modal-label-BaX0ssBB.js";import"./form-item-DOXYdbog.js";import"./text-input-DDgNtQUw.js";import{g as R}from"./16-CyTxh60K.js";import"./checkbox-BgZPK3uV.js";import"./link-DKS3H8bi.js";import{_ as O,a as j}from"./16-DxVvgUmP.js";import{i as x}from"./icon-loader-CMdg6y5C.js";import"./button-NKOdGHCg.js";const k=()=>{const e=new Date;let o=e.getHours();const n=e.getMinutes().toString().padStart(2,"0"),s=e.getSeconds().toString().padStart(2,"0"),t=o>=12?"PM":"AM";return o=o%12,o=o||12,`${o}:${n}:${s} ${t}`},T=":host cds-modal-body{padding-bottom:0}.no-bullets{list-style-type:none;padding-inline-start:2rem;margin:0}.notification{position:absolute;right:.75rem;top:.75rem}",v=P(T);var z=Object.defineProperty,M=Object.getOwnPropertyDescriptor,w=(e,o,n,s)=>{for(var t=s>1?void 0:s?M(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&z(o,n,t),t};let m=class extends g{constructor(){super(...arguments),this._open=!1,this._showNotification=!1,this._textInput="",this._enableDelete=!1}_close(){this._open=!1,this._textInput=""}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_setDeleteButtonState(){this._enableDelete=this._textInput==="Bx1001"}_onInputChange(e){this._textInput=e.target.value,this._setDeleteButtonState()}_onDelete(e){this._close(),this._showNotification=!0}render(){return i`
    ...
    `}};m.styles=v;w([a()],m.prototype,"_open",2);w([a()],m.prototype,"_showNotification",2);w([a()],m.prototype,"_textInput",2);w([a()],m.prototype,"_enableDelete",2);m=w([y("delete-high-impact")],m);/**
 * @license
 ...
 */function*I(e,o){if(e!==void 0){let n=0;for(const s of e)yield o(s,n++)}}var H=Object.defineProperty,W=Object.getOwnPropertyDescriptor,h=(e,o,n,s)=>{for(var t=s>1?void 0:s?W(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&H(o,n,t),t};let d=class extends g{constructor(){super(...arguments),this._open=!1,this._showNotification=!1,this._textInput="",this._enableDelete=!1,this._isCheckboxChecked=!1,this._connectedItems=[{name:"Route1_name"},{name:"Hpt-392-ser"},{name:"Route2_name"}]}_close(){this._open=!1,this._textInput="",this._isCheckboxChecked=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_setDeleteButtonState(){const e=this._textInput==="Bx1001";this._enableDelete=this._isCheckboxChecked&&e}_onInputChange(e){this._textInput=e.target.value,this._setDeleteButtonState()}_onCheckboxChange(e){this._isCheckboxChecked=e.detail.checked,this._setDeleteButtonState()}_onDelete(e){this._close(),this._showNotification=!0}render(){return i`
    ...
    `}};r.styles=v;u([a()],r.prototype,"_open",2);u([a()],r.prototype,"_showNotification",2);u([a()],r.prototype,"_enableDelete",2);u([a()],r.prototype,"_isCheckboxChecked",2);u([a()],r.prototype,"_batchItems",2);u([a()],r.prototype,"_protectedItems",2);r=u([y("delete-batch")],r);var E=Object.defineProperty,q=Object.getOwnPropertyDescriptor,N=(e,o,n,s)=>{for(var t=s>1?void 0:s?q(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&E(o,n,t),t};let p=class extends g{constructor(){super(...arguments),this._open=!1,this._showNotification=!1}_close(){this._open=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._open=!0,this._onNotificationClose()}_onDelete(e){this._close(),this._showNotification=!0}render(){return i`
      ...
      ${this._showNotification?i`<cds-toast-notification
            ...
            @cds-notification-closed="${this._onNotificationClose}"
          ></cds-toast-notification>`:null}
    `}};p.styles=v;N([S()],p.prototype,"action",2);N([a()],p.prototype,"_open",2);N([a()],p.prototype,"_showNotification",2);p=N([y("delete-remove-medium-impact")],p);var F=Object.defineProperty,G=Object.getOwnPropertyDescriptor,B=(e,o,n,s)=>{for(var t=s>1?void 0:s?G(o,n):o,c=e.length-1,l;c>=0;c--)(l=e[c])&&(t=(s?l(o,n,t):l(t))||t);return s&&t&&F(o,n,t),t};let C=class extends g{constructor(){super(...arguments),this._showNotification=!1}_onNotificationClose(){this._showNotification=!1}_onDeleteButtonClick(){this._showNotification=!0}render(){return i`
      <cds-button
        type="button"
        kind="danger"
        size="md"
      ...
      ${this._showNotification?i`<cds-toast-notification
            ...
            @cds-notification-closed="${this._onNotificationClose}"
          ></cds-toast-notification>`:null}
    `}};C.styles=v;B([S()],C.prototype,"action",2);B([a()],C.prototype,"_showNotification",2);C=B([y("delete-remove-low-impact")],C);/**
 * @license
 *
