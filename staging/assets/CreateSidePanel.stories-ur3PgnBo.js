...
>
  ...
                ...
                `}}]});V.__docgenInfo={description:"",methods:[],displayName:"DocsPage"};const M=`${S.prefix}--create-side-panel`,t="create-side-panel-stories__",w=e.createElement(ae,{className:"slug-container",size:"xs"},e.createElement(oe,null,e.createElement("div",null,e.createElement("p",{className:"secondary"},"AI Explained"),e.createElement("h1",null,"84%"),e.createElement("p",{className:"secondary bold"},"Confidence score"),e.createElement("p",{className:"secondary"},"This is not really Lorem Ipsum but the spell checker did not like the previous text with it's non-words which is why this unwieldy sentence, should one choose to call it that, here."),e.createElement("hr",null),e.createElement("p",{className:"secondary"},"Model type"),e.createElement("p",{className:"bold"},"Foundation model")))),q={title:"Create partitions",subtitle:"Specify the details of the partitions you're creating",formTitle:"Core configuration",formDescription:"We recommend you fill out and evaluate these details at a minimum before deploying your topic.",primaryButtonText:"Create",secondaryButtonText:"Cancel"},_=["Day(s)","Month(s)","Year(s)"],T=()=>e.createElement(ie,{render:()=>e.createElement(te,null,e.createElement(ne,{href:"/",prefix:"IBM"},"Cloud Pak"))}),ut={title:"IBM Products/Patterns/Create flows/CreateSidePanel",component:r,tags:["autodocs"],parameters:{layout:"fullscreen",styles:de,docs:{page:V}},argTypes:{slug:{control:{type:"select",labels:{0:"No AI slug",1:"with AI Slug"},default:0},options:[0,1]}},decorators:[pe(T,t)]},ue=({slug:l,...m},c)=>{const p=I(),[a,o]=f.useState(c.viewMode!=="docs");return e.createElement(e.Fragment,null,T(),e.createElement($,{id:"ibm-products-page-content"},e.createElement(P,{lg:{span:2,start:8}},e.createElement(E,{onClick:()=>o(!a)},a?"Close side panel":"Open side panel"))),e.createElement(r,{...m,open:a,onRequestClose:()=>o(!1),onRequestSubmit:()=>o(!1),selectorPrimaryFocus:`.${p}--text-input`,slug:l&&w},e.createElement(N,{id:"create-side-panel-topic-name-a",labelText:"Topic name",className:`${t}form-item`,placeholder:"Enter topic name"}),e.createElement(i,{id:"1",className:`${t}form-item`,label:"Partitions",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement(i,{id:"2",className:`${t}form-item`,label:"Replicas",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement(i,{id:"3",className:`${t}form-item`,label:"Minimum in-sync replicas",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement("div",{style:{display:"grid",alignItems:"flex-end",gridGap:"0.75rem",gridTemplateColumns:"1fr 1fr"}},e.createElement(i,{id:"4",className:`${t}form-item`,label:"Retention time",min:0,max:50,value:30,iconDescription:"Choose a number"}),e.createElement(v,{id:"create-side-panel-dropdown-options-a",items:_,initialSelectedItem:"Day(s)",label:"Options",titleText:"Options",className:`${t}form-item`})),e.createElement(i,{id:"5",className:`${t}form-item`,label:"Minimum in-sync replicas",min:0,max:50,value:1,iconDescription:"Choose a number"})))},fe=({slug:l,...m},c)=>{const p=I(),[a,o]=f.useState(c.viewMode!=="docs"),[s,d]=f.useState(""),[x,u]=f.useState(!1);return e.createElement(e.Fragment,null,T(),e.createElement($,{id:"ibm-products-page-content"},e.createElement(P,{lg:{span:2,start:8}},e.createElement(E,{onClick:()=>o(!a)},a?"Close side panel":"Open side panel"))),e.createElement(r,{...m,open:a,onRequestClose:()=>o(!1),onRequestSubmit:()=>o(!1),disableSubmit:!s.length,selectorPrimaryFocus:`.${p}--text-input`,slug:l&&w},e.createElement(N,{id:"create-side-panel-topic-name-b",labelText:"Topic name",className:`${t}form-item`,placeholder:"Enter topic name",onChange:g=>{d(g.target.value),u(!1)},onBlur:()=>{s.length===0&&u(!0)},invalid:x,invalidText:"This is a required field"}),e.createElement(i,{id:"1",className:`${t}form-item`,label:"Partitions",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement(i,{id:"2",className:`${t}form-item`,label:"Replicas",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement(i,{id:"3",className:`${t}form-item`,label:"Minimum in-sync replicas",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement("div",{className:`${t}example-container`},e.createElement(i,{id:"4",className:`${t}form-item`,label:"Retention time",min:0,max:50,value:30,iconDescription:"Choose a number"}),e.createElement(v,{id:"create-side-panel-dropdown-options-b","aria-label":"Dropdown",initialSelectedItem:"Day(s)",items:_,label:"Options",className:`${t}form-item`})),e.createElement(i,{id:"3",className:`${t}form-item`,label:"Minimum in-sync replicas",min:0,max:50,value:1,iconDescription:"Choose a number"})))},be=({slug:l,...m},c)=>{const p=I(),[a,o]=f.useState(c.viewMode!=="docs"),[s,d]=f.useState(""),[x,u]=f.useState(!1);return e.createElement(e.Fragment,null,T(),e.createElement($,{id:"ibm-products-page-content"},e.createElement(P,{lg:{span:2,start:8}},e.createElement(E,{onClick:()=>o(!a)},a?"Close side panel":"Open side panel"))),e.createElement(r,{...m,open:a,onRequestClose:()=>o(!1),onRequestSubmit:()=>o(!1),disableSubmit:!s.length,selectorPrimaryFocus:`.${p}--text-input`,slug:l&&w},e.createElement(F,{className:`${M}__form ${t}example-form-group`,legendText:"Personal information"},e.createElement(N,{id:"create-side-panel-first-name",labelText:"First name",className:`${t}form-item`,placeholder:"Enter topic name",onChange:g=>{d(g.target.value),u(!1)},onBlur:()=>{s.length===0&&u(!0)},invalid:x,invalidText:"This is a required field"}),e.createElement(v,{id:"create-side-panel-dropdown-bu",titleText:"Business unit","aria-label":"Dropdown",initialSelectedItem:"IBM Cloud platform",items:["IBM Cloud platform","AI Ops","Watson"],label:"Business unit",className:`${t}form-item`})),e.createElement(F,{className:`${M}__form ${t}example-form-group`,legendText:"Topic information"},e.createElement(N,{id:"create-side-panel-topic-name-c",labelText:"Topic name",className:`${t}form-item`,placeholder:"Enter topic name"}),e.createElement(i,{id:"1",className:`${t}form-item`,label:"Partitions",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement(i,{id:"2",className:`${t}form-item`,label:"Replicas",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement(i,{id:"3",className:`${t}form-item`,label:"Minimum in-sync replicas",min:0,max:50,value:1,iconDescription:"Choose a number"}),e.createElement("div",{className:`${t}example-container`},e.createElement(i,{id:"4",className:`${t}form-item`,label:"Retention time",min:0,max:50,value:30,iconDescription:"Choose a number"}),e.createElement(v,{id:"create-side-panel-dropdown-options-c","aria-label":"Dropdown",initialSelectedItem:"Day(s)",items:_,label:"Options",className:`${t}form-item`})),e.createElement(i,{id:"3",className:`${t}form-item`,label:"Minimum in-sync replicas",min:0,max:50,value:1,iconDescription:"Choose a number"}))))},h=ue.bind({});h.args={selectorPageContent:"#ibm-products-page-content",...q};const y=fe.bind({});y.args={selectorPageContent:"#ibm-products-page-content",...q};const C=be.bind({});C.args={selectorPageContent:"#ibm-products-page-content",...q};var B,k,A;h.parameters={...h.parameters,docs:{...(B=h.parameters)==null?void 0:B.docs,source:{originalSource:`({
  slug,
  ...args
}, context) => {
...
}`,...(A=(k=h.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var G,L,H;y.parameters={...y.parameters,docs:{...(G=y.parameters)==null?void 0:G.docs,source:{originalSource:`({
  slug,
  ...args
}, context) => {
  const carbonPrefix = usePrefix();
...
}`,...(H=(L=y.parameters)==null?void 0:L.docs)==null?void 0:H.source}}};var W,U,z;C.parameters={...C.parameters,docs:{...(W=C.parameters)==null?void 0:W.docs,source:{originalSource:`({
  slug,
  ...args
}, context) => {
  const carbonPrefix = usePrefix();
...
}`,...(z=(U=C.parameters)==null?void 0:U.docs)==null?void 0:z.source}}};const ft=["Default","WithFormValidation","WithMultipleForms"];export{h as Default,y as WithFormValidation,C as WithMultipleForms,ft as __namedExportsOrder,ut as default};
