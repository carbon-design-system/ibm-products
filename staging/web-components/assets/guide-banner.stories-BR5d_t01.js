import{z as M,B as D,x as b}from"./iframe-BQLtOjZL.js";import{c as F}from"./repeat-ZJ-E_PN7.js";import"./guide-banner-element-Wcqgz4vt.js";import{i as L}from"./icon-loader-B247QMV2.js";import{v as H,a as P}from"./index-DkSYGz6Z.js";import{_ as q}from"./16-B_l_7QwJ.js";const N=".body{color:var(--cds-text-primary, #161616)}.body-elm{inline-size:600px;padding-inline-start:3rem}.footer{display:flex;justify-content:space-between;inline-size:100%}.footer-left .guide-banner-story__toggle-button{margin-inline-start:2rem}",V=M(N),u=`${D}--snappy`,G=`${u}__elm`,l=`${u}__selection`;function z(e,s){const o=document.querySelector(e);if(!o)return;const t=document.createElement("style");t.textContent=`
  .${u} {
    display: flex;
    flex: none;
    overflow: scroll;
