var U=Object.defineProperty;var r=(a,e)=>U(a,"name",{value:e,configurable:!0});import{u as F,j as t,aP as z,R as n,r as c,c as L,p as P,C as M,P as B,B as p}from"./iframe-D_TgCArL.js";import{B as V}from"./ButtonSet-D4f8odRz.js";import{c as E}from"./clamp-BCozvAmP.js";import{S as H}from"./SelectableTag-DsWOjXR3.js";import{I as i,a as m}from"./InterstitialScreenView-CMeVk94n.js";import{A as R}from"./bucket-1-lBN47QRA.js";import"./preload-helper-Cc2_yIPf.js";import"./Text-dRt3vkhG.js";import"./mergeRefs-BH0-8uDG.js";import"./useControllableState-BjOxIYPS.js";import"./Tag-DwG5QxKI.js";import"./DefinitionTooltip-CCUESeVH.js";import"./index-rkIh3fWn.js";import"./index-ByjH8V_s.js";import"./bucket-19-DTdadaEd.js";import"./ComposedModal-BnfFN913.js";import"./index-C4I8n2OM.js";import"./LayerContext-cz8DORjj.js";import"./clamp-ekNJC_Xv.js";import"./isTopmostVisibleModal-BR-FkALa.js";import"./InlineLoading-BGCjZ4v_.js";import"./bucket-6-CXN0yrIs.js";import"./wrapFocus-ETscRDcT.js";import"./devtools-BGZqfd5Y.js";import"./ProgressIndicator-C7QsYgGL.js";import"./bucket-10-pwko2831.js";import"./bucket-20-I6CTYn6M.js";import"./chunk-DMEZ3h3f-CmcAf2VV.js";function N(a){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...F(),...a.components};return t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"interstitialscreen",children:"InterstitialScreen"}),`
...
@returns void`,type:{name:"func"}}}};const G="interstitial-stories",T=`${P.prefix}--interstitial-screen`,Ie={title:"Components/Onboarding/InterstitialScreen",component:i,tags:["autodocs","Onboarding"],subcomponents:{Header:i.Header,Body:i.Body,Footer:i.Footer,InterstitialScreenView:m},decorators:[a=>n.createElement("div",{className:`${G}__viewport`},a())],parameters:{styles:W,docs:{page:_}}},g={"carbon.progress-step.complete":"Terminé","carbon.progress-step.incomplete":"Partiel","carbon.progress-step.current":"Actuel","carbon.progress-step.invalid":"Non valide"},v=r(({handleGotoStep:a})=>n.createElement(n.Fragment,null,n.createElement(m,{stepTitle:"Step 1",translateWithId:r(e=>g[e]??e,"translateWithId")},n.createElement(u,{size:"md",title:"Use case-specific heading 1",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),n.createElement(m,{stepTitle:"Step 2",translateWithId:r(e=>g[e]??e,"translateWithId")},n.createElement(u,{size:"md",title:"Use case-specific heading 2",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),n.createElement(m,{stepTitle:"Step 3",translateWithId:r(e=>g[e]??e,"translateWithId")},n.createElement(u,{size:"md",title:"Use case-specific heading 3",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),n.createElement(m,{stepTitle:"Step 4",translateWithId:r(e=>g[e]??e,"translateWithId")},n.createElement(u,{size:"md",title:"Use case-specific heading 4",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."})),n.createElement(m,{stepTitle:"Step 5",translateWithId:r(e=>g[e]??e,"translateWithId")},n.createElement(u,{size:"md",title:"Use case-specific heading 5",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept."}))),"getMultipleContent"),A=r(({handleGotoStep:a,disableActionButton:e},s,o)=>n.createElement(n.Fragment,null,n.createElement(m,{stepTitle:"Step 1"},n.createElement(u,{className:o?"GenericView":"",title:"Use case-specific heading",description:"Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept. Use case-specific content that explains the concept.",disableActionButton:e}))),"getSingleContent"),l={headerTitle:"Use case-specific title",headerSubTitle:"Use case-specific sub title",ariaLabel:"Interstitial Screen"},b=r(()=>{const[a,e]=c.useState(!0),s=c.useRef(null);return n.createElement(n.Fragment,null,n.createElement(p,{onClick:r(()=>{e(!0)},"onClick"),ref:s},"Show Interstitial modal"),n.createElement(i,{open:a,onClose:r(()=>{e(!1)},"onClose"),ariaLabel:l.ariaLabel,launcherButtonRef:s},n.createElement(i.Header,{headerTitle:l.headerTitle,headerSubTitle:l.headerSubTitle,hideProgressIndicator:!0}),n.createElement(i.Body,{contentRenderer:r(o=>A(o),"contentRenderer")}),n.createElement(i.Footer,null)))},"Modal"),x=r(()=>{const[a,e]=c.useState(!0),s=c.useRef(null);return n.createElement(n.Fragment,null,n.createElement(p,{onClick:r(()=>{e(!0)},"onClick"),ref:s},"Show Interstitial modal"),n.createElement(i,{open:a,onClose:r(()=>{e(!1)},"onClose"),ariaLabel:l.ariaLabel,launcherButtonRef:s},n.createElement(i.Header,{headerTitle:l.headerTitle,headerSubTitle:l.headerSubTitle}),n.createElement(i.Body,{contentRenderer:r(o=>v(o),"contentRenderer")}),n.createElement(i.Footer,null)))},"ModalWithMultipleSteps"),I=r(()=>{const[a,e]=c.useState(!0),s=c.useRef(null);return n.createElement(n.Fragment,null,n.createElement(p,{onClick:r(()=>{e(!0)},"onClick"),ref:s},"Show Interstitial modal"),n.createElement(i,{open:a,onClose:r(()=>{e(!1)},"onClose"),ariaLabel:l.ariaLabel,launcherButtonRef:s},n.createElement(i.Header,{headerTitle:l.headerTitle,headerSubTitle:l.headerSubTitle}),n.createElement(i.Body,{contentRenderer:r(o=>v(o),"contentRenderer")}),n.createElement(i.Footer,{actionButtonRenderer:r(({handleGotoStep:o,progStep:d,stepCount:h})=>n.createElement(V,null,n.createElement(p,{className:`${T}--skip-btn`,kind:"ghost",size:"lg",title:"Explore on my own",onClick:r(()=>e(!1),"onClick")},"Explore on my own"),d>0&&n.createElement(p,{className:`${T}--prev-btn`,kind:"secondary",size:"lg",title:"Previous",onClick:r(()=>{const f=h-1,k=E(d-1,0,f);o(k)},"onClick")},"Previous"),d<h-1&&n.createElement(p,{className:`${T}--next-btn`,renderIcon:R,size:"lg",title:"Next",onClick:r(()=>{const f=h-1,k=E(d+1,0,f);o(k)},"onClick")},"Next"),d===h-1&&n.createElement(p,{className:`${T}--start-btn`,renderIcon:R,size:"lg",title:"Start",onClick:r(()=>e(!1),"onClick")},"Start")),"actionButtonRenderer")})))},"WithCustomActionButtons"),w=r(()=>{const[a,e]=c.useState(!0),s=c.useRef(null),o=r(async(d,h)=>{d!=="skip"&&await new Promise(S=>{setTimeout(()=>{S()},1500)})},"onAction");return n.createElement(n.Fragment,null,n.createElement(p,{onClick:r(()=>{e(!0)},"onClick"),ref:s},"Show Interstitial modal"),n.createElement(i,{open:a,onClose:r(()=>{e(!1)},"onClose"),ariaLabel:l.ariaLabel,launcherButtonRef:s},n.createElement(i.Header,{headerTitle:l.headerTitle,headerSubTitle:l.headerSubTitle}),n.createElement(i.Body,{contentRenderer:r(d=>v(d),"contentRenderer")}),n.createElement(i.Footer,{onAction:o})))},"WithAsynchronousActionCallback"),y=r(()=>{const[a,e]=c.useState(!0);c.useState(!0);const s=c.useRef(null);return n.createElement(n.Fragment,null,n.createElement(p,{onClick:r(()=>{e(!0)},"onClick"),ref:s},"Show Interstitial full screen"),n.createElement(i,{open:a,onClose:r(()=>{e(!1)},"onClose"),isFullScreen:!0,ariaLabel:l.ariaLabel,launcherButtonRef:s},n.createElement(i.Header,{headerTitle:l.headerTitle,headerSubTitle:l.headerSubTitle}),n.createElement(i.Body,{contentRenderer:r(o=>A(o,!0,!0),"contentRenderer")}),n.createElement(i.Footer,null)))},"fullScreen"),j=r(()=>{const[a,e]=c.useState(!0);c.useState(!0);const s=c.useRef(null);return n.createElement(n.Fragment,null,n.createElement(p,{onClick:r(()=>{e(!0)},"onClick"),ref:s},"Show Interstitial full screen"),n.createElement(i,{open:a,onClose:r(()=>{e(!1)},"onClose"),isFullScreen:!0,ariaLabel:l.ariaLabel,launcherButtonRef:s},n.createElement(i.Header,{headerTitle:l.headerTitle,headerSubTitle:l.headerSubTitle}),n.createElement(i.Body,{contentRenderer:r(o=>v(o),"contentRenderer")}),n.createElement(i.Footer,null)))},"fullScreenWithMultipleSteps");b.__docgenInfo={description:"",methods:[],displayName:"Modal"};x.__docgenInfo={description:"",methods:[],displayName:"ModalWithMultipleSteps"};I.__docgenInfo={description:"",methods:[],displayName:"WithCustomActionButtons"};w.__docgenInfo={description:"",methods:[],displayName:"WithAsynchronousActionCallback"};y.__docgenInfo={description:"",methods:[],displayName:"fullScreen"};j.__docgenInfo={description:"",methods:[],displayName:"fullScreenWithMultipleSteps"};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`() => {
...
}`,...j.parameters?.docs?.source}}};const we=["Modal","ModalWithMultipleSteps","WithCustomActionButtons","WithAsynchronousActionCallback","fullScreen","fullScreenWithMultipleSteps"];export{b as Modal,x as ModalWithMultipleSteps,w as WithAsynchronousActionCallback,I as WithCustomActionButtons,we as __namedExportsOrder,Ie as default,y as fullScreen,j as fullScreenWithMultipleSteps};
//# sourceMappingURL=InterstitialScreen.stories-BCLpderi.js.map
