import{el as t,em as E,eo as y,en as H,r as n,e as s}from"./iframe-C3VsvcP9.js";import{useMDXComponents as b}from"./index-C6IVAFFV.js";import{O as v}from"./index-DoFt_alO.js";import{O as A}from"./OverflowMenuItem-CzaFxSyE.js";import{D as m}from"./DataSpreadsheet-aC6lC-bD.js";import"./useAttachedMenu-BlxDu2aa.js";import"./mergeRefs-91-mP8KM.js";import"./bucket-12-DrtzkUGW.js";import"./wrapFocus-D809mY0y.js";import"./useOutsideClick-CD3FvkGX.js";import"./Text-Deo-qbq3.js";import"./index.esm-BYoO4Q4F.js";import"./uuidv4-BN2rGLQG.js";import"./usePreviousValue-Bc_HSeid.js";import"./inheritsLoose-DHKJTbHM.js";import"./props-helper-BrmPtLqI.js";import"./devtools-BjHf0isC.js";import"./getNodeTextContent-C8IeKkUQ.js";const S=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],f=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],L=e=>{const a=[];for(let r=0;r<e;r++)a.push(r);return a},j=e=>{const a=e&&{ownerName:f[Math.floor(Math.random()*f.length)],weight:Math.floor(Math.random()*40)},r={petType:S[Math.floor(Math.random()*S.length)],firstName:f[Math.floor(Math.random()*f.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...r,...a}:r},C=({rows:e,extraColumns:a})=>((o=0)=>{const d=[e][o];return L(d).map(()=>({...j(a)}))})();function M(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...b(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
...
`,t.jsx(H,{})]})}function N(e={}){const{wrapper:a}={...b(),...e.components};return a?t.jsx(a,{...e,children:t.jsx(M,{...e})}):M(e)}const O="div[data-story-title*=DataSpreadsheet] .docs-story>div:first-child>div:first-child{overflow:auto;inline-size:100%}",ne={title:"Experimental/DataSpreadsheet",component:m,tags:["autodocs"],argTypes:{onActiveCellChange:{action:"active cell change"},onColDrag:{action:"on column drag"},onSelectionAreaChange:{action:"selection area change"}},parameters:{styles:O,docs:{page:N}}},c=({value:e})=>s.createElement("span",{style:{display:"flex",justifyContent:"flex-end"}},e),W=[{Header:"Row Index",accessor:(e,a)=>a,Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right",width:275},{Header:"Pet type",accessor:"petType"},{Header:s.createElement("div",null,s.createElement("div",null,s.createElement("span",null,"First Name")," ",s.createElement("span",null,"(Pets)"))),accessor:"firstName",column_name:"First Name"},{Header:"Age",accessor:"age",Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right"},{Header:"Vet visits",accessor:"visits",Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right"},{Header:"Health",accessor:"health",Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right"}],x=[{Header:"Row index",accessor:(e,a)=>a,Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right",width:275},{Header:"Pet Type",accessor:"petType"},{Header:"First Name",accessor:"firstName"},{Header:"Age",accessor:"age",Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right"},{Header:"Vet visits",accessor:"visits",Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right"},{Header:"Health",accessor:"health",Cell:({cell:{value:e}})=>s.createElement(c,{value:e}),placement:"right"}],T=({...e})=>{const[a,r]=n.useState(()=>C({rows:16})),o=n.useMemo(()=>x,[]);return s.createElement(m,{columns:o,data:a,onDataUpdate:r,id:"spreadsheet--id",...e})},U=({...e})=>{const[a,r]=n.useState(()=>C({rows:1e5})),o=n.useMemo(()=>x,[]),l=d=>s.createElement(v,{style:{width:"32px",height:"32px",minWidth:"32px",minHeight:"32px"}},s.createElement(A,{itemText:`Test item ${d}`}));return s.createElement(m,{columns:o,data:a,onDataUpdate:r,renderRowHeaderDirection:"Left",renderRowHeader:l,id:"spreadsheet--id",...e})},R=({...e})=>{const[a,r]=n.useState(()=>C({rows:1e3})),o=n.useMemo(()=>x,[]);return s.createElement(m,{columns:o,data:a,onDataUpdate:r,id:"spreadsheet--id",...e})},k=({...e})=>{const[a,r]=n.useState([]),o=n.useMemo(()=>[...x.filter(d=>d.Header!=="Row Index")],[]),l=n.useMemo(()=>o,[o]);return s.createElement(m,{columns:l,data:a,onDataUpdate:r,id:"spreadsheet--id",...e})},P=({...e})=>{const[a,r]=n.useState(()=>C({rows:24,extraColumns:!0})),o=n.useMemo(()=>[...x,{Header:"Owner name",accessor:"ownerName"},{Header:"Weight",accessor:"weight"}],[]),l=n.useMemo(()=>o,[o]);return s.createElement(m,{columns:l,data:a,onDataUpdate:r,id:"spreadsheet--id",...e})},I=({...e})=>{const[a,r]=n.useState(()=>C({rows:24,extraColumns:!0})),o=n.useMemo(()=>[...x,{Header:"Owner name",accessor:"ownerName"},{Header:"Weight",accessor:"weight"}],[]),l=n.useMemo(()=>o,[o]);return s.createElement(m,{columns:l,data:a,onDataUpdate:r,id:"spreadsheet--id",...e})},_=({...e})=>{const[a,r]=n.useState(()=>C({rows:24,extraColumns:!0})),o=B=>{},l=n.useMemo(()=>[...W,{Header:"Owner name",accessor:"ownerName"},{Header:"Weight",accessor:"weight"}],[]),d=n.useMemo(()=>l,[l]);return s.createElement(m,{columns:d,data:a,onDataUpdate:r,onColDrag:o,id:"spreadsheet--id",...e})},i=T.bind({});i.storyName="Basic spreadsheet";i.args={selectAllAriaLabel:"Select all",spreadsheetAriaLabel:"Example data spreadsheet"};const u=R.bind({});u.storyName="Large dataset";u.args={cellSize:"lg",selectAllAriaLabel:"Select all",spreadsheetAriaLabel:"Example data spreadsheet"};const p=U.bind({});p.storyName="Large dataset with optional component";p.args={cellSize:"lg",selectAllAriaLabel:"Select all",spreadsheetAriaLabel:"Example data spreadsheet"};const h=k.bind({});h.storyName="Empty with cells";h.args={defaultEmptyRowCount:24,selectAllAriaLabel:"Select all",spreadsheetAriaLabel:"Example data spreadsheet"};const D=P.bind({});D.storyName="With many columns";D.args={selectAllAriaLabel:"Select all",spreadsheetAriaLabel:"Example data spreadsheet",totalVisibleColumns:5};const g=I.bind({});g.storyName="With different options";g.args={readOnlyTable:!1,disableColumnSwapping:!1,selectAllAriaLabel:"Select all",spreadsheetAriaLabel:"Example data spreadsheet",totalVisibleColumns:5};const w=_.bind({});w.storyName="With drag drop  callback";w.args={selectAllAriaLabel:"Select all",spreadsheetAriaLabel:"Example data spreadsheet",totalVisibleColumns:5};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`({
  ...args
}) => {
