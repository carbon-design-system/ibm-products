import{R as e,r as b}from"./index-BwDkhjyp.js";import{a as T}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{c as w,C as J}from"./floating-ui.dom.mjs-BB6krl5l.js";import{S as K}from"./StoryDocsPage-6b3Ekv3Y.js";import{p as h,I as Q,B as _}from"./settings-GP6q6PuD.js";import{P as n}from"./index-Dk74W0Oi.js";import{g as v}from"./devtools-TX7bKGcX.js";import{u as Z}from"./uuidv4-BQrI85uz.js";import{S as ee}from"./SteppedAnimatedMedia-CTRotJdz.js";import{I as ne}from"./bucket-8-BgepLnQN.js";import{C as te}from"./bucket-4-xb9OK7Di.js";import{L as ie}from"./Link-nkMjvGqf.js";import{e as ae}from"./bucket-9-CrVHodqy.js";import"./_commonjsHelpers-BosuxZz1.js";import"./v4-CQkTLCs1.js";import"./index-BONylQH5.js";import"./index-CRDEJUOW.js";import"./iframe-DGBkLKmo.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./story-helper-6_fmjwZ-.js";import"./tslib.es6-B4_xh3D5.js";import"./index-CJvxHwuA.js";import"./events-b0qlIvq_.js";import"./index-CmXP8YBY.js";import"./lottie-D0UQuq7-.js";import"./clamp-Bg2yowlN.js";import"./toNumber-DVQITUtX.js";const C=i=>{var s;const o=((s=i==null?void 0:i.props)==null?void 0:s.children)||void 0;if(Array.isArray(i)){let r=[];return i.forEach(a=>{typeof a=="object"?r.push(C(a)):typeof a=="string"&&r.push(a)}),r.join(" ")}if(o===void 0)return typeof i=="string"?i:" ";if(typeof o=="object")return C(i.props.children);if(typeof o=="string")return i.props.children},t=`${h.prefix}--inline-tip`,E="InlineTip",c={closeIconDescription:"Close",collapsible:!1,collapseButtonLabel:"Read less",expandButtonLabel:"Read more",narrow:!1,withLeftGutter:!1,onClick:()=>{},onClose:()=>{},title:"Use case-specific heading"};let p=e.forwardRef(({action:i,children:o,className:s,closeIconDescription:r=c.closeIconDescription,collapsible:a=c.collapsible,collapseButtonLabel:k=c.collapseButtonLabel,expandButtonLabel:M=c.expandButtonLabel,media:l,narrow:g=c.narrow,onClick:V,onClose:G,tertiaryButtonLabel:I,title:O=c.title,withLeftGutter:F=c.withLeftGutter,...X},W)=>{const[y,x]=b.useState(a),R=b.useRef(Z()).current,Y=b.useMemo(()=>C(e.Children.toArray(o)),[o]);let q=o;return!l&&a&&y&&(q=e.createElement("p",{className:`${t}__preview-text`},Y)),b.useEffect(()=>{x(a)},[a]),e.createElement("div",{...X,"aria-labelledby":R,className:w(t,s,a&&`${t}__collapsible`,y&&`${t}__collapsible-collapsed`,l&&`${t}__has-media`,[g?`${t}__narrow`:`${t}__wide`],F&&!g&&`${t}__with-left-gutter`),ref:W,role:"complementary",...v(E)},e.createElement("div",{className:`${t}__close-icon-wrapper`},e.createElement(Q,{className:`${t}__close-icon`,kind:"ghost",label:r,onClick:G,size:"lg"},e.createElement(J,{size:16}))),(!l&&g||!g)&&e.createElement("div",{className:`${t}__icon-idea`,tabIndex:-1},e.createElement(ne,{size:16})),e.createElement("div",{className:`${t}__content`},e.createElement("h6",{id:R,className:`${t}__title`},O),e.createElement("section",{className:`${t}__body`},q,i&&(!a||a&&!y)&&e.createElement("div",{className:`${t}__secondary-btn`},i)),(a||I)&&e.createElement("footer",{className:`${t}__footer`},a&&!l&&e.createElement(_,{className:`${t}__toggle-btn`,kind:"ghost",size:"md",onClick:()=>{x(H=>!H)}},y?M:k),I&&e.createElement(_,{className:`${t}__close-btn`,size:"md",onClick:V,kind:"tertiary",renderIcon:()=>e.createElement(te,{size:16})},I))),l&&(l.render?e.createElement("div",{className:`${t}__media`},l.render()):e.createElement(ee,{className:`${t}__media`,filePaths:l.filePaths})))});p=h.checkComponentEnabled(p,E);p.displayName=E;p.propTypes={action:n.node,children:n.node.isRequired,className:n.string,closeIconDescription:n.string,collapseButtonLabel:n.string,collapsible:n.bool,expandButtonLabel:n.string,media:n.oneOfType([n.shape({render:n.func}),n.shape({filePaths:n.string})]),narrow:n.bool,onClick:n.func,onClose:n.func,tertiaryButtonLabel:n.string,title:n.string.isRequired,withLeftGutter:n.bool};p.__docgenInfo={description:`Inline tips are messages embedded within other components that
...
}`,...(U=(D=m.parameters)==null?void 0:D.docs)==null?void 0:U.source}}};const Ve=["inlineTip","inlineTipNarrow"];export{Ve as __namedExportsOrder,Me as default,d as inlineTip,m as inlineTipNarrow};
