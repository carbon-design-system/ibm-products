import{R as n,r as se}from"./index-BwDkhjyp.js";import{b as ne,c as le,_ as ce,$ as me}from"./index-CO-HQMMN.js";import{P as e}from"./index-Dk74W0Oi.js";import{G as te}from"./Grid-CpAb88bR.js";import{C as oe}from"./Column-C2vw5Ugh.js";import{A as de,a as ue}from"./index-C5SNi40Q.js";import{S as pe}from"./StoryDocsPage-ohgCD2zx.js";import{a as E}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as ge}from"./devtools-7ohusRRR.js";import{p as ye}from"./settings-9_3hiHpE.js";import{p as fe}from"./props-helper-2oDpPmvU.js";import{C as he}from"./Card-DRz1cS-d.js";import{b as be,A as Se}from"./bucket-0-a_zZqU1p.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-BONylQH5.js";import"./index-DQ9l4IMz.js";import"./bucket-17-ClE8iwID.js";import"./index-CHtKUyL9.js";import"./iframe-BleUBiry.js";import"../sb-preview/runtime.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./index-C0xX6qoh.js";import"./index-DrFu-skq.js";import"./story-helper-6_fmjwZ-.js";import"./tslib.es6-B4_xh3D5.js";import"./v4-CQkTLCs1.js";import"./index-CJvxHwuA.js";import"./events-OVwOsPzJ.js";import"./index-Do3G8CTu.js";import"./Text-DeIkfaUm.js";import"./useAttachedMenu-CUrQfPQx.js";import"./mergeRefs-CTUecegF.js";import"./bucket-12-BR4Aca2V.js";import"./wrapFocus-gin0UG4f.js";import"./index-Y0d6iLU4.js";import"./LayerContext-DbU-6VX4.js";import"./bucket-6-DcTgwLU8.js";import"./bucket-9-CnK3eVdV.js";import"./bucket-2-Bt1jIBkN.js";const re=t=>{let{as:r="div",className:s,children:v,ratio:C="1x1",...l}=t;const c=ne(),x=le(s,`${c}--aspect-ratio`,`${c}--aspect-ratio--${C}`);return n.createElement(r,ce({className:x},l),v)};re.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let i=se.forwardRef((t,r)=>{const s=fe(t,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.createElement(he,{ref:r,...s,...ge(z)})});i=ye.checkComponentEnabled(i,z);i.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),aiLabel:e.oneOfType([e.node,e.bool]),children:e.node,className:e.string,description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};i.displayName=z;i.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
