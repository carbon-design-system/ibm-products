...
The `c4p-page-header-breadcrumb` component is used to render the breadcrumb navigation area within the Page header.
...
To render the Tabs zone, utilize the `c4p-page-header-tabs` component, passing in the `cds-tabs` and `cds-tab` components
