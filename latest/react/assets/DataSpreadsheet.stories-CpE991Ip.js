import{j as t,ej as y,el as E,ek as H,r as n,e as s}from"./iframe-CoewCovk.js";import{useMDXComponents as b}from"./index-C5QLMs-D.js";import{O as v}from"./index-Db7cgiYO.js";import{O as A}from"./OverflowMenuItem-AdOGI2xf.js";import{D as d}from"./DataSpreadsheet-BrgHBb38.js";import"./useAttachedMenu-DisMwIU8.js";import"./mergeRefs-D4pwfk3t.js";import"./bucket-13-kEbwoQWW.js";import"./wrapFocus-COQpSXAY.js";import"./useOutsideClick-BjkaPmco.js";import"./Text-Db5H-8py.js";import"./index.esm-D3tP9Ffl.js";import"./uuidv4-BN2rGLQG.js";import"./usePreviousValue-CF6xtt65.js";import"./inheritsLoose-DHKJTbHM.js";import"./props-helper-BRgWXp0Z.js";import"./devtools-9nvRWAoA.js";import"./getNodeTextContent-C8IeKkUQ.js";const S=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],f=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],j=e=>{const a=[];for(let r=0;r<e;r++)a.push(r);return a},L=e=>{const a=e&&{ownerName:f[Math.floor(Math.random()*f.length)],weight:Math.floor(Math.random()*40)},r={petType:S[Math.floor(Math.random()*S.length)],firstName:f[Math.floor(Math.random()*f.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...r,...a}:r},C=({rows:e,extraColumns:a})=>((o=0)=>{const m=[e][o];return j(m).map(()=>({...L(a)}))})();function M(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...b(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
