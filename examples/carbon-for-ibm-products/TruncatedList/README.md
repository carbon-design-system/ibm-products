# Carbon for IBM Products `TruncatedList` example
...
5. Review the changes made and restore/rectify the template TAGS typically in capitals. These are replaced as part of the build process. E.g. TruncatedList, 2024, import './config'
