import{P as e}from"./index-B_euquWE.js";import{p as l,B as s}from"./settings-0ThqPtR3.js";import{T as p,t as c,p as d,a as h}from"./TearsheetShell-DL71VJCc.js";import{e as r}from"./index-DxDX2vOa.js";import{p as m,a as u}from"./props-helper-DmbAnr2a.js";import{g as f}from"./devtools-BlxCaI1L.js";import{A as y}from"./ActionSet-0Lk-L5n-.js";const a="TearsheetNarrow",g={verticalPosition:"lower"};let t=r.forwardRef(({verticalPosition:o=g.verticalPosition,...n},i)=>r.createElement(p,{...f(a),...m(n,h),verticalPosition:o,ref:i,size:"narrow"}));t=l.checkComponentEnabled(t,a);t.displayName=a;const b={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:u([y.validateActions(()=>"lg"),e.arrayOf(e.shape({...s.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:s.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:o,hasCloseIcon:n})=>c(o,n)),description:e.node,hasCloseIcon:e.bool,label:e.node,onClose:e.func,open:e.bool,portalTarget:d,selectorPrimaryFocus:e.string,selectorsFloatingMenus:e.arrayOf(e.string),title:e.node,...b};t.__docgenInfo={description:`A narrow tearsheet is a slimmer variant of the tearsheet, providing a dialog
