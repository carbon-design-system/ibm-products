...
}`,...(L=(k=y.parameters)==null?void 0:k.docs)==null?void 0:L.source}}};var N,q,P;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`args => {
  const [statuses, setStatuses] = useState(['inactive', 'inactive', 'inactive', 'inactive']);
  useEffect(() => {
    const timer1 = setTimeout(() => {
...
}`,...(P=(q=f.parameters)==null?void 0:q.docs)==null?void 0:P.source}}};var U,W,B;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:`args => {
  const [isError, setIsError] = useState(false);
  const [statuses, setStatuses] = useState(['inactive', 'inactive', 'inactive', 'inactive']);
  const runDemo = () => {
    const timer1 = setTimeout(() => {
...
}`,...(B=(W=h.parameters)==null?void 0:W.docs)==null?void 0:B.source}}};const _e=["statusIndicator","success","fail","successAsync","failAsync"];export{_e as __namedExportsOrder,Ce as default,y as fail,h as failAsync,l as statusIndicator,v as success,f as successAsync};
