...
<WebTerminal>
  ...
</WebTerminal>`}},{description:"The default web terminal is one which opens and the terminal loads. Then if the user desires to dismiss it they can click the close icon on the top right corner of the component.",story:i},{story:s},{subTitle:"Help users with helpful documentation links",description:`Optionally you can pass documentation links to help point your users to useful
...
];`}},{story:n},{description:`Optionally you can add actions to the web terminal header bar. To add actions
...
>
  ...
</WebTerminal>`}}]});w.__docgenInfo={description:"",methods:[],displayName:"DocsPage"};const T=[{renderIcon:t=>e.createElement(C,{size:16,...t}),onClick:d("clicked on action"),iconDescription:"Create new deployment"},{renderIcon:t=>e.createElement(q,{size:16,...t}),onClick:d("clicked on action"),iconDescription:"Copy logs"}],o=t=>e.createElement(k,null,e.createElement(y,null),e.createElement(W,null,"This is where you would put content"),e.createElement(b,{...t},e.createElement("div",{className:"example-terminal"},e.createElement("p",null,"Connection successful."),e.createElement("p",null,"DISCLAIMER: This is not a real terminal, you would pass your own terminal component into the children of the WebTerminal component."),e.createElement("p",null,"Please see the docs of this component for more information."),e.createElement("p",null,"joebob:~$")))),i=o.bind({});i.args={documentationLinks:v,actions:T,isInitiallyOpen:!0,closeIconDescription:"Close terminal",documentationLinksIconDescription:"Show documentation links"};const s=o.bind({});s.args={documentationLinks:v,closeIconDescription:"Close terminal",isInitiallyOpen:!0,documentationLinksIconDescription:"Show documentation links"};const n=o.bind({});n.args={actions:T,isInitiallyOpen:!0,closeIconDescription:"Close terminal"};const we={title:"IBM Products/Patterns/Web terminal/WebTerminal",tags:["autodocs"],parameters:{layout:"fullscreen",styles:B,docs:{page:w}},component:b};var r,a,l;i.parameters={...i.parameters,docs:{...(r=i.parameters)==null?void 0:r.docs,source:{originalSource:`args => {
...
}`,...(l=(a=i.parameters)==null?void 0:a.docs)==null?void 0:l.source}}};var p,h,g;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`args => {
  return <WebTerminalProvider>
      <Navigation />
...
}`,...(g=(h=s.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var m,f,u;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`args => {
  return <WebTerminalProvider>
      <Navigation />
...
}`,...(u=(f=n.parameters)==null?void 0:f.docs)==null?void 0:u.source}}};const Te=["Default","WithDocumentationLinks","WithActions"];export{i as Default,n as WithActions,s as WithDocumentationLinks,Te as __namedExportsOrder,we as default};
