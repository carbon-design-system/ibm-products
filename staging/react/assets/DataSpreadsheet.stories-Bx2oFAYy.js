import{j as t,aA as y,aC as E,aB as H,r as n,e as s}from"./iframe-M250dlZ7.js";import{useMDXComponents as b}from"./index-WYgGephs.js";import{O as v}from"./index-C5YnOgUR.js";import{O as A}from"./OverflowMenuItem-C2SiIYIF.js";import{D as d}from"./DataSpreadsheet-CFnpV-ZP.js";import"./preload-helper-PPVm8Dsz.js";import"./useAttachedMenu-BO_Sauze.js";import"./mergeRefs-BZpmU3mx.js";import"./bucket-13-Dpze7R2Q.js";import"./wrapFocus-CKH4l4Wk.js";import"./useOutsideClick-BG0etdOe.js";import"./Text-WGIoVIHq.js";import"./index.esm-PrVTv73j.js";import"./uuidv4-BN2rGLQG.js";import"./usePreviousValue-anNy5oWh.js";import"./inheritsLoose-DHKJTbHM.js";import"./props-helper-dY4jIZff.js";import"./devtools-COwjwxDB.js";import"./getNodeTextContent-C8IeKkUQ.js";const S=["dog","cat","bird","lizard","frog","hamster","fish","rabbit","snake"],f=["Bruno","Willow","Kona","Heidi","Rusty","Bonnie","Cash","Gucci","Brody","Emma","Loki","Angel","Astro","Sherman","Layla","Peanut","Grace","Mickey","Sasha","Finn","Tucker","Bear","Mocha","Roscoe"],L=e=>{const a=[];for(let r=0;r<e;r++)a.push(r);return a},j=e=>{const a=e&&{ownerName:f[Math.floor(Math.random()*f.length)],weight:Math.floor(Math.random()*40)},r={petType:S[Math.floor(Math.random()*S.length)],firstName:f[Math.floor(Math.random()*f.length)],age:Math.floor(Math.random()*30),visits:Math.floor(Math.random()*40),health:Math.floor(Math.random()*100)};return e?{...r,...a}:r},w=({rows:e,extraColumns:a})=>((o=0)=>{const m=[e][o];return L(m).map(()=>({...j(a)}))})();function M(e){const a={a:"a",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...b(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(a.h1,{id:"dataspreadsheet",children:"DataSpreadsheet"}),`
...
//# sourceMappingURL=DataSpreadsheet.stories-Bx2oFAYy.js.map
