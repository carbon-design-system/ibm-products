import{e as c}from"./index-DxDX2vOa.js";import{aw as t,al as j,ax as R,ak as D}from"./index-CYHZTqqy.js";import{useMDXComponents as F}from"./index-BgI2kBcJ.js";import"./chunk-NUUEMKO5-B0W4kV8C.js";import{c as f,P as l}from"./index-B_euquWE.js";import{g as P}from"./devtools-BlxCaI1L.js";import{p as S}from"./settings-0ThqPtR3.js";import{D as A}from"./DefinitionTooltip-CFcrL78F.js";import{a as M}from"./props-helper-DmbAnr2a.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-Cku1tuHn.js";import"../sb-preview/runtime.js";import"./index-CaMJXrh2.js";import"./index-Df9so8jS.js";import"./index-CRUq0TYl.js";import"./index-DrFu-skq.js";import"./react-18-DcnmlX6h.js";import"./events-OVwOsPzJ.js";import"./index-YDq2Pj7F.js";const n={TOP:"top",TOP_LEFT:"top-left",TOP_RIGHT:"top-right",BOTTOM:"bottom",BOTTOM_LEFT:"bottom-left",BOTTOM_RIGHT:"bottom-right",LEFT:"left",LEFT_BOTTOM:"left-bottom",LEFT_TOP:"left-top",RIGHT:"right",RIGHT_BOTTOM:"right-bottom",RIGHT_TOP:"right-top"},r={TOP:"top",TOP_START:"top-start",TOP_END:"top-end",BOTTOM:"bottom",BOTTOM_START:"bottom-start",BOTTOM_END:"bottom-end",LEFT:"left",LEFT_END:"left-end",LEFT_START:"left-start",RIGHT:"right",RIGHT_END:"right-end",RIGHT_START:"right-start"},N=o=>({[n.TOP_LEFT]:r.TOP_START,[n.TOP_RIGHT]:r.TOP_END,[n.BOTTOM_LEFT]:r.BOTTOM_START,[n.BOTTOM_RIGHT]:r.BOTTOM_END,[n.LEFT_BOTTOM]:r.LEFT_END,[n.LEFT_TOP]:r.LEFT_START,[n.RIGHT_BOTTOM]:r.RIGHT_END,[n.RIGHT_START]:r.RIGHT_START})[o],d=`${S.prefix}--string-formatter`,h="StringFormatter",m={lines:1,tooltipDirection:r.BOTTOM_START,truncate:!1,width:null};let a=c.forwardRef(({className:o,lines:e=m.lines,tooltipDirection:u=m.tooltipDirection,truncate:s=m.truncate,width:T=m.width,value:p,...w},E)=>{const g=c.createElement("span",{className:f(`${d}--content`,{[`${d}--truncate`]:s}),style:{maxWidth:T,WebkitLineClamp:e}},p);return c.createElement("span",{...w,className:f(d,o),ref:E,...P(h)},s?c.createElement(A,{className:`${d}__tooltip`,align:u,definition:p,openOnHover:!0},g):g)});a=S.checkComponentEnabled(a,h);a.displayName=h;a.validateAlignment=()=>(o,e,u)=>{const s=o[e];if(Object.values(n).includes(s)){const p=N(s);console.warn(`"${s}" is a deprecated value for the "${e}" prop on the "${u}" component. Use "${p}" instead. Allowable values are: ${Object.values(r).join(", ")}.`)}};a.propTypes={className:l.string,lines:l.number,tooltipDirection:M([a.validateAlignment(),l.oneOf(Object.values(n),Object.values(r))]),truncate:l.bool,value:l.string.isRequired,width:l.string};a.__docgenInfo={description:`StringFormatter allows for truncating text while displaying a tooltip
...
NB no need for a 'Playground' because all stories have all controls anyway.`,...(_=(x=i.parameters)==null?void 0:x.docs)==null?void 0:_.description}}};const ae=["stringFormatter"];export{ae as __namedExportsOrder,ne as default,i as stringFormatter};
