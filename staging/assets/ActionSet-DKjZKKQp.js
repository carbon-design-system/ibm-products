import{c as T}from"./index-CQ0F2wkl.js";import{p as S,B as y}from"./settings-xiNX1vM3.js";import{B as E}from"./ButtonSet-UZItGUcq.js";import{I as q}from"./InlineLoading-Dllsw8qU.js";import{R as f}from"./index-BwDkhjyp.js";import{p as I,a as O}from"./props-helper-BS5A6Pu3.js";import{P as a}from"./index-Dk74W0Oi.js";const i=`${S.prefix}--action-set`,R="ActionSet",z=f.forwardRef(({className:t,disabled:r,kind:c,label:n,loading:u,isExpressive:d=!0,...o},e)=>f.createElement(y,{...o,isExpressive:d,className:T(t,[`${i}__action-button`,{[`${i}__action-button--ghost`]:c==="ghost"||c==="danger--ghost",[`${i}__action-button--expressive`]:d}]),disabled:r||u||!1,kind:c,ref:e},n,u&&f.createElement(q,null)));z.displayName="ActionSetButton";z.propTypes={...y.PropTypes,kind:a.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:a.string,loading:a.bool};const w="primary",k=(t,r)=>t==="sm"||t==="md"&&r>2,A={size:"md"},g=f.forwardRef(({actions:t,buttonSize:r,className:c,size:n=A.size,...u},d)=>{var s;const o=t&&((s=t.slice)==null?void 0:s.call(t,0))||[],e=k(n,o.length),p=l=>({ghost:1,"danger--ghost":2,danger:4,primary:5})[l]??3;return o.sort((l,m)=>(p(l.kind||w)-p(m.kind||w))*(e?-1:1)),f.createElement(E,{...u,className:T(i,c,{[`${i}--row-single`]:!e&&o.length===1,[`${i}--row-double`]:!e&&o.length===2,[`${i}--row-triple`]:!e&&o.length===3,[`${i}--row-quadruple`]:!e&&o.length>=4,[`${i}--stacking`]:e},`${i}--${n}`),ref:d,role:"presentation",stacked:e},o.map((l,m)=>{const h=I(l,["key"]);return f.createElement(z,{key:l.key||m,...h,size:r})}))});g.displayName=R;g.validateActions=t=>(r,c,n,u,d)=>{const o=d||c,e=r[o],p=e&&(e==null?void 0:e.length),s=[];if(p>0){const l=t?t(r):r.size||A.size,m=k(l,p),h=B=>e.filter(P=>(P.kind||w)===B).length,v=h("primary"),$=h("secondary"),x=h("danger"),b=h("ghost")+h("danger--ghost");m&&p>3&&s.push(`you cannot have more than three actions in this size of ${n}`),p>4&&s.push(`you cannot have more than four actions in a ${n}`),v>1&&s.push(`you cannot have more than one 'primary' action in a ${n}`),b>1&&s.push(`you cannot have more than one 'ghost' action in a ${n}`),m&&p>1&&b>0&&s.push(`you cannot have a 'ghost' button in conjunction with other action types in this size of ${n}`),p>v+$+x+b&&s.push(`you can only have 'primary', 'danger', 'secondary', 'ghost' and 'danger--ghost' buttons in a ${n}`)}return s.length>0?new Error(`Invalid ${u} \`${o}\` supplied to \`${n}\`: ${s.join(", and ")}.`):null};g.propTypes={actions:O([g.validateActions(),a.arrayOf(a.shape({...y.propTypes,kind:a.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:a.string,loading:a.bool,onClick:y.propTypes.onClick}))]),buttonSize:y.propTypes.size,className:a.string,size:a.oneOf(["sm","md","lg","xl","2xl"])};g.__docgenInfo={description:`An ActionSet presents a set of action buttons, constructed from bundles
