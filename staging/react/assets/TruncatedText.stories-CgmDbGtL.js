...
`,e.jsx(u,{})]})}function m(n={}){const{wrapper:t}={...i(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}const g="truncated-text-stories",c={align:"top",autoAlign:!1,collapseLabel:"View less",expandLabel:"View more",id:"example-id",lines:3,value:"Buttons are used to initialize an action, either in the background or foreground of an experience. There are several kinds of buttons. Primary buttons should be used for the principle call to action on the page. Secondary buttons should be used for secondary actions on each page. Danger buttons should be used for a negative action (such as Delete) on the page. Modify the behavior of the button by changing its event properties. Small buttons may be used when there is not enough space for a regular sized button. This issue is most found in tables. Small button should have three words or less. When words are not enough, icons can be used in buttons to better communicate what the button does. Icons are always paired with text.",type:"tooltip"},y={title:"Utilities/TruncatedText",component:l,tags:["autodocs"],parameters:{styles:x,layout:"centered",docs:{page:m}},argTypes:{align:{options:["top","top-left","top-right","bottom","bottom-left","bottom-right","left","left-bottom","left-top","right","right-bottom","right-top"],control:{type:"select"}}}},d=n=>r.createElement("div",{className:`${g}__viewport`},r.createElement(l,{...n})),o=d.bind({});o.args={...c};const s=d.bind({});s.args={...c,type:"expand"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`args => {
