...
```
      ...
        <CreateFullPageStep
          ...
          <Row>
            <Column xlg={5} lg={5} md={4} sm={4}>
              <fieldset className={`exp--create-full-page__step-fieldset`}>
                <TextInput
                  id="test-1"
                  invalidText="A valid value is required"
                  labelText="Topic name"
          ...
          <span className={`exp--create-full-page__section-divider`} />
          <h5 className={`exp--create-full-page__step-title`}>Required title</h5>
          <h6 className={`exp--create-full-page__step-subtitle`}>
            Optional subtitle
          </h6>
          <p className={`exp--create-full-page__step-description`}>
...
[<img alt="Edit on CodeSandbox" src="https://codesandbox.io/static/img/play-codesandbox.svg" />](https://codesandbox.io/s/createfullpage-example-nj798)
