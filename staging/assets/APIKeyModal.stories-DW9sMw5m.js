import{r as s,e}from"./index-CPiZ6Cnx.js";import{P as t,F as _t,c as Bt,l as Kt}from"./index-BPCFiO9b.js";import{p as H,B as q,e as Ft}from"./settings-41bnSjHp.js";import{F as at}from"./Form-qGY1F0CA.js";import{F as ye}from"./FormGroup-BF7c02p3.js";import{I as he}from"./InlineLoading-Cst7O9Fk.js";import{R as fe}from"./RadioButton-CQKVrHNr.js";import{R as Lt}from"./RadioButtonGroup-DgAqhidy.js";import{T as Ht}from"./Toggle-BulcM5ZS.js";import{P as Gt,T as ne}from"./TextInput-d19WJcLV.js";import{a as be}from"./index-B-lxVbXh.js";import{w as oe}from"./wait-CTNFjQS8.js";import{S as Ot}from"./StoryDocsPage-vEZJbmBv.js";import{C as $t,M as Mt,a as Dt,b as Wt}from"./ComposedModal-CgRKyN5W.js";import{u as jt}from"./usePortalTarget-DAnmNO4S.js";import{g as Vt}from"./devtools-Ca6Wku6c.js";import{i as ve}from"./props-helper-C4WGU-Xx.js";import{u as Ke}from"./uuidv4-BN2rGLQG.js";import{u as zt,c as Jt}from"./useFocus-C3l_bJTO.js";import{u as Ut}from"./usePreviousValue-CSEZflXC.js";import{E as Xt}from"./bucket-6-CO2LLwKX.js";import{d as Qt}from"./bucket-9-qDf-0NK_.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-B83en7q5.js";import"./index-ZKO_qc5e.js";import"./events-OVwOsPzJ.js";import"./index-H2wBg9na.js";import"./mergeRefs-CTUecegF.js";import"./Text-DJS5NTiV.js";import"./bucket-18-CAzey7tD.js";import"./useControllableState-uQXf5Mu5.js";import"./useNormalizedInputProps-CqoVIYpB.js";import"./FormContext-CgeSXHS1.js";import"./useAnnouncer-Dwt0jqXi.js";import"./v4-CtRu48qb.js";import"./index-DblCLej2.js";import"./iframe-DG_HeTRT.js";import"./index-Dytf1aFS.js";import"./index-DrFu-skq.js";import"./story-helper-C7pmvIin.js";import"./index-C_tB4MqD.js";import"./LayerContext-BGhaVt7n.js";import"./ButtonSet-BTIAcY4e.js";import"./requiredIfGivenPropIsTruthy-CU7JwK8h.js";import"./wrapFocus-Dfrp1CCV.js";import"./feature-flags-CMZHtsao.js";import"./index-BI1fCQHV.js";const Yt="APIKeyDownloader",ae=({apiKey:n,body:o,fileName:i,fileType:r,linkText:u,downloadLinkLabel:l})=>{const[p,g]=s.useState({});return s.useEffect(()=>{(async()=>{const a=r==="txt"?n:JSON.stringify({apiKey:n}),T=new Blob([a],{type:r==="txt"?"text/plain":"application/json"}),h=await URL.createObjectURL(T),c=`${i||"apikey"}.${r}`;g({href:h,download:c})})()},[n,i,r]),e.createElement("div",{className:`${H.prefix}--apikey-modal__download-container`},e.createElement("p",{className:`${H.prefix}--apikey-modal__messaging-text`},o," ",e.createElement("a",{...p,className:`${H.prefix}--apikey-modal__download-link`,"aria-label":l??u,role:"button"},l??u)))};ae.displayName=Yt;ae.propTypes={apiKey:t.string.isRequired,body:t.string,downloadLinkLabel:t.string,fileName:t.string.isRequired,fileType:t.oneOf(["txt","json"]).isRequired,linkText:t.string.isRequired};ae.__docgenInfo={description:"",methods:[],displayName:"APIKeyDownloader",props:{apiKey:{description:"the api key that's displayed to the user when a request to create is fulfilled.",type:{name:"string"},required:!0},body:{description:"body content for the downloader",type:{name:"string"},required:!1},downloadLinkLabel:{description:"aria-label for the download link",type:{name:"string"},required:!1},fileName:{description:"designates the name of downloadable json file with the key. if not specified will default to 'apikey'",type:{name:"string"},required:!0},fileType:{description:"designates the file type for the downloadable key",type:{name:"enum",value:[{value:"'txt'",computed:!1},{value:"'json'",computed:!1}]},required:!0},linkText:{description:"anchor text for the download link",type:{name:"string"},required:!0}}};const Te="APIKeyModal",Fe={apiKeyName:"",customSteps:[]};let x=s.forwardRef(({apiKey:n,apiKeyLabel:o,apiKeyName:i=Fe.apiKeyName,body:r,className:u,closeButtonText:l,copyButtonText:p,copyErrorText:g,copyIconDescription:v,customSteps:a=Fe.customSteps,downloadBodyText:T,downloadFileName:h,downloadFileType:c,downloadLinkText:k,downloadLinkLabel:P=k,editButtonText:C,editSuccess:_,editSuccessTitle:G,editSuccessMessage:O,editing:m,error:U,errorText:$,generateButtonText:M,generateSuccessBody:X,generateSuccessTitle:Q,generateSuccessMessage:B,generateTitle:K,hasAPIKeyVisibilityToggle:Y,hasDownloadLink:re,hideAPIKeyLabel:ie,launcherButtonRef:y,loading:D,loadingText:dt,modalLabel:ke,nameHelperText:ut,nameLabel:pt,namePlaceholder:mt,nameRequired:le,nextStepButtonText:yt,onClose:ce,onCopy:Re,onRequestEdit:de,onRequestGenerate:ue,open:S,portalTarget:ft,previousStepButtonText:gt,showAPIKeyLabel:ht,helperText:bt,...vt},Tt)=>{var Be;const[xe,Z]=s.useState(null),[we,Pe]=s.useState(null),[Se,kt]=s.useState(!1),[ee,Ee]=s.useState(i),[w,pe]=s.useState(0),me=s.useRef(void 0),W=s.useRef(Ke()),Rt=s.useRef(Ke()),xt=jt(ft),E=!!a.length,f=n&&!D,Ae=E&&w<a.length-1,Ie=E&&w!==0,wt={renderIcon:b=>e.createElement(Ft,{size:16,...b}),iconDescription:v,ref:me},d=`${H.prefix}--apikey-modal`,Pt=s.useRef(void 0),A=s.useRef(null),te=Tt||Pt,{firstElement:qe,keyDownListener:St}=zt(te),Ne=Ut(S);s.useEffect(()=>{me.current&&S&&f&&me.current.focus(),A!=null&&A.current&&(A==null||A.current.setAttribute("readOnly","true"))},[S,f]),s.useEffect(()=>{S&&Jt(qe,te,`#${CSS.escape(W==null?void 0:W.current)}`)},[qe,te,S]),s.useEffect(()=>{Ne&&!S&&y&&setTimeout(()=>{y.current.focus()},0)},[y,S,Ne]);const Et=()=>{var b;return D?!0:E&&"valid"in((a==null?void 0:a[w])||[])?!((b=a[w])!=null&&b.valid):!!(!E&&le&&!ee)},At=()=>Ae?yt:f?p:m?C:M,It=()=>Ie&&!f?gt:l;s.useEffect(()=>{var b;m&&_?(Z(K),Pe(O??G)):f?(Z(K),Pe(B??Q)):Z(E?(b=a[w])==null?void 0:b.title:K)},[f,D,m,_,G,O,E,Q,B,K,w,a]);const qt=b=>{Ee(b.target.value)},Ce=()=>{Ee(""),pe(0),ce==null||ce()},_e=async b=>{if(b.preventDefault(),Ae)pe(w+1);else if(f)if(Re)Re(n);else try{await navigator.clipboard.writeText(n)}catch(Ct){console.error(Ct),kt(!0)}else m?de==null||de(ee):ue==null||ue(ee)},Nt=()=>{Ie&&!f?pe(w-1):Ce()};return xt(e.createElement(_t,{enableExperimentalFocusWrapWithoutSentinels:!0},e.createElement($t,{...vt,open:S,...Vt(Te),ref:te,onKeyDown:St,className:Bt(u,d),onClose:Ce,size:"sm","aria-label":ke,preventCloseOnClickOutside:!0},e.createElement(Mt,{className:`${d}__header`,title:xe,label:ke}),e.createElement(Dt,{className:`${d}__body-container`},E&&!f?(Be=a[w])==null?void 0:Be.content:e.createElement(e.Fragment,null,r&&e.createElement("p",{className:`${d}__body`},r),!m&&n&&Y&&e.createElement(Gt,{value:n,labelText:o,id:W.current,showPasswordLabel:ht,hidePasswordLabel:ie,tooltipPosition:"left",helperText:bt,ref:A}),!m&&n&&!Y&&e.createElement(ne,{value:n,labelText:o,id:W.current}),(m||!f&&le)&&e.createElement(at,{onSubmit:_e,"aria-label":xe??void 0},e.createElement(ne,{helperText:ut,placeholder:mt,labelText:pt,onChange:qt,value:ee,id:Rt.current,disabled:D,required:le,"data-modal-primary-focus":!0})),D&&e.createElement(he,{description:dt,className:`${d}__loader`}),(Se||U)&&e.createElement("div",{className:`${d}__messaging`},e.createElement("div",{className:`${d}__error-icon`},e.createElement(Xt,{size:16})),e.createElement("p",{className:`${d}__messaging-text`,role:"alert","aria-live":"assertive"},Se?g:$)),f&&e.createElement("div",{className:`${d}__messaging`},e.createElement(Qt,{size:16}),re?e.createElement(ae,{apiKey:n,body:T,fileName:h,linkText:k,fileType:c,downloadLinkLabel:P}):e.createElement("div",{className:`${d}__messaging-text`,role:"alert","aria-live":"assertive"},X)),(_||f&&we)&&e.createElement("div",{className:`${d}__messaging`},e.createElement(Kt,{size:16,className:`${d}__checkmark-icon`}),e.createElement("p",{className:`${d}__messaging-text`,role:"alert","aria-live":"assertive"},we)))),e.createElement(Wt,{className:`${d}__footer`},e.createElement(q,{type:"button",kind:"secondary",onClick:Nt},It()),e.createElement(q,{...f&&wt,type:"submit",kind:"primary",onClick:_e,disabled:Et()},At())))))});const Le=n=>ve(n,({customSteps:o})=>o&&o.length>1),ge=n=>ve(n,({editing:o})=>o),se=n=>ve(n,({hasDownloadLink:o})=>o);x=H.checkComponentEnabled(x,Te);const Zt={editSuccessTitle:t.string,generateSuccessTitle:t.string};x.propTypes={apiKey:t.string,apiKeyLabel:t.string,apiKeyName:t.string,body:t.string,className:t.string,closeButtonText:t.string,copyButtonText:t.string,copyErrorText:t.string,copyIconDescription:t.string,customSteps:t.arrayOf(t.shape({valid:t.bool,content:t.node,title:t.string})),downloadBodyText:t.string,downloadFileName:se(t.string),downloadFileType:se(t.oneOf(["txt","json"])),downloadLinkLabel:se(t.string),downloadLinkText:se(t.string),editButtonText:ge(t.string),editSuccess:ge(t.bool),editSuccessMessage:ge(t.string),editing:t.bool,error:t.bool,errorText:t.string,generateButtonText:t.string,generateSuccessBody:t.node,generateSuccessMessage:t.string,generateTitle:t.string,hasAPIKeyVisibilityToggle:t.bool,hasDownloadLink:t.bool,helperText:t.string,hideAPIKeyLabel:t.string,launcherButtonRef:t.any,loading:t.bool,loadingText:t.string,modalLabel:t.string,nameHelperText:t.string,nameLabel:t.string,namePlaceholder:t.string,nameRequired:t.bool,nextStepButtonText:Le(t.string),onClose:t.func,onCopy:t.func,onRequestEdit:t.func,onRequestGenerate:t.func,open:t.bool.isRequired,portalTarget:t.node,previousStepButtonText:Le(t.string),selectorPrimaryFocus:t.string,showAPIKeyLabel:t.string,...Zt};x.displayName=Te;x.__docgenInfo={description:"",methods:[],displayName:"APIKeyModal",props:{apiKey:{required:!1,tsType:{name:"string"},description:"the api key that's displayed to the user when a request to create is fulfilled.",type:{name:"string"}},apiKeyLabel:{required:!1,tsType:{name:"string"},description:"label for the text input that holds the api key.",type:{name:"string"}},apiKeyName:{required:!1,tsType:{name:"string"},description:"the name of the api key. should only be supplied in edit mode.",defaultValue:{value:"''",computed:!1},type:{name:"string"}},body:{required:!1,tsType:{name:"string"},description:"body content for the modal",type:{name:"string"}},className:{required:!1,tsType:{name:"string"},description:"optional class name",type:{name:"string"}},closeButtonText:{required:!1,tsType:{name:"string"},description:"text for the close button",type:{name:"string"}},copyButtonText:{required:!1,tsType:{name:"string"},description:"text for the copy button",type:{name:"string"}},copyErrorText:{required:!1,tsType:{name:"string"},description:"Error message for when the copy function fails",type:{name:"string"}},copyIconDescription:{required:!1,tsType:{name:"string"},description:"text description for the copy button icon",type:{name:"string"}},customSteps:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  valid?: boolean;
  content?: ReactNode;
  title?: string;
...
}`,...(ot=(nt=I.parameters)==null?void 0:nt.docs)==null?void 0:ot.source}}};const Xs=["Generate","GenerateWithError","InstantGenerate","CustomGenerate","Edit","EditWithError","CustomEdit"];export{I as CustomEdit,F as CustomGenerate,L as Edit,J as EditWithError,j as Generate,V as GenerateWithError,z as InstantGenerate,Xs as __namedExportsOrder,Us as default};
