import{x as c}from"./iframe-BSerOd4r.js";import"./action-set-C-E9okLr.js";import"./button-BCfvtfcs.js";import"./button-skeleton-Cr5pY24u.js";import"./preload-helper-PPVm8Dsz.js";import"./class-map-C13EjW-N.js";import"./state-C8U7RqRN.js";import"./ref-BvQaoC2g.js";const u={"Small (sm)":"sm","Medium (md)":"md","Large (lg)":"lg","Extra Large (xl)":"xl","2XL (2xl)":"2xl"},g={"Default (use size)":"","Small (sm)":"sm","Medium (md)":"md","Large (lg)":"lg","Extra Large (xl)":"xl","2XL (2xl)":"2xl"},p={"Two buttons":2,"Three buttons":3,"Four buttons":4},b={"No ghost button":!1,"Include ghost button":!0},A={title:"Utilities/ActionSet",argTypes:{size:{control:"select",options:u,description:"The size of the action set"},buttonSize:{control:"select",options:g,description:"Override button size (optional)"},disableStacking:{control:"boolean",description:"Prevent automatic stacking of buttons"},numberOfButtons:{control:"select",options:p,description:"Number of buttons to display"},includeGhost:{control:"select",options:b,description:"Include a ghost button"}},parameters:{docs:{description:{component:`
...
- Support for multiple sizes (sm, md, lg, xl, 2xl)
  ...
  \`
}`,...a.parameters?.docs?.source}}};const $=["Default","WithSlottedButtons","DifferentSizes","FourActions"];export{o as Default,s as DifferentSizes,a as FourActions,i as WithSlottedButtons,$ as __namedExportsOrder,A as default};
