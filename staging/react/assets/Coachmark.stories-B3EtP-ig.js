import{el as e,ev as x,em as s,eo as c,en as u,r as m,eu as f,e as o,cO as b}from"./iframe-Cbdf71kV.js";import{d as k,e as C,B as j,b as y}from"./CoachmarkOverlayElements-CIQ9_Ysn.js";import{useMDXComponents as h}from"./index-Bz9OSaUz.js";import{C as i,a as v}from"./CoachmarkBeacon-BKO9-R_8.js";import{C as E}from"./CoachmarkButton-DbFqniQl.js";import"./uuidv4-BN2rGLQG.js";import"./devtools-BsT0_Owc.js";import"./bucket-6-BiOweKob.js";import"./useIsomorphicEffect-BHn7yZvq.js";import"./clamp-CsXXRQhr.js";import"./Carousel-CuNgyfm0.js";function d(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...h(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(x,{title:"Coachmark",component:i}),`
...
`,e.jsx(u,{})]})}function w(t={}){const{wrapper:n}={...h(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(d,{...t})}):d(t)}const O=".CoachmarkBaseExampleUsage{position:relative;display:inline-block;box-sizing:border-box;padding:1rem;margin-inline-start:50%;max-block-size:100%;transform:translate(-50%)}",L={title:"Experimental/Onboarding/Coachmark/Coachmark",component:i,tags:["autodocs","Onboarding"],argTypes:{theme:{control:{type:null}},target:{control:{type:null}},children:{control:{type:null}},onClose:{control:{type:null}},overlayKind:{control:{type:null}},overlayRef:{control:{type:null}},portalTarget:{control:{type:null}},overlayClassName:{control:{type:null}},align:{options:["top","top-left","top-right","bottom","bottom-left","bottom-right","left","left-bottom","left-top","right","right-bottom","right-top"],control:{type:"select"}},className:{control:{type:null}}},parameters:{styles:O,docs:{page:w}}},p=t=>{const n=m.useRef(void 0);m.useEffect(()=>{n?.current?.scrollIntoView({block:"center",inline:"center"})});const g=f(),l=o.createElement(i,{...t,theme:g},o.createElement(k,{closeButtonLabel:"Done"},o.createElement(C,{title:"Hello World",description:"this is a description test"})));return["fixed","floating","stacked"].includes(t.overlayKind)?l:o.createElement("div",{style:{width:"4000px",height:"2000px"}},o.createElement("div",{style:{position:"absolute",top:"1000px",left:"2000px"},ref:n},l))},a=p.bind({});a.args={theme:"dark",align:"bottom",positionTune:{x:0,y:0},target:o.createElement(v,{label:"Show information",kind:j.DEFAULT})};const r=p.bind({});r.args={theme:"dark",align:"bottom",overlayKind:y.FLOATING,target:o.createElement(E,{kind:"tertiary",size:"md",label:"Show information",renderIcon:b},"Click Me")};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
