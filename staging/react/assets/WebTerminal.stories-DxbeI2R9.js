...
<WebTerminal>
  ...
</WebTerminal>`}},{description:"The default web terminal is one which opens and the terminal loads. Then if the user desires to dismiss it they can click the close icon on the top right corner of the component.",story:s},{story:i},{subTitle:"Help users with helpful documentation links",description:`Optionally you can pass documentation links to help point your users to useful
...
>
  ...
</WebTerminal>`}}]});p.__docgenInfo={description:"",methods:[],displayName:"DocsPage"};const{action:o}=__STORYBOOK_MODULE_ACTIONS__,h=[{renderIcon:t=>e.createElement(m,{size:16,...t}),onClick:o("clicked on action"),iconDescription:"Create new deployment"},{renderIcon:t=>e.createElement(f,{size:16,...t}),onClick:o("clicked on action"),iconDescription:"Copy logs"}],d=t=>e.createElement(b,null,e.createElement(a,null),e.createElement(y,null,"This is where you would put content"),e.createElement(r,{...t},e.createElement("div",{className:"example-terminal"},e.createElement("p",null,"Connection successful."),e.createElement("p",null,"DISCLAIMER: This is not a real terminal, you would pass your own terminal component into the children of the WebTerminal component."),e.createElement("p",null,"Please see the docs of this component for more information."),e.createElement("p",null,"joebob:~$")))),s=d.bind({});s.args={documentationLinks:l,actions:h,isInitiallyOpen:!0,closeIconDescription:"Close terminal",documentationLinksIconDescription:"Show documentation links"};const i=d.bind({});i.args={documentationLinks:l,closeIconDescription:"Close terminal",isInitiallyOpen:!0,documentationLinksIconDescription:"Show documentation links"};const n=d.bind({});n.args={actions:h,isInitiallyOpen:!0,closeIconDescription:"Close terminal"};const J={title:"Patterns/Prebuilt patterns/WebTerminal",tags:["autodocs"],parameters:{layout:"fullscreen",styles:z,docs:{page:p}},component:r};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`args => {
...
}`,...n.parameters?.docs?.source}}};const Q=["Default","WithDocumentationLinks","WithActions"];export{s as Default,n as WithActions,i as WithDocumentationLinks,Q as __namedExportsOrder,J as default};
