import{j as L,_ as S,n as k,c as z,p as a,t as M,x as e,l as x}from"./iframe-B2dGZ3uq.js";import{S as s,a as I}from"./side-panel-CdS99xCL.js";import{B as o}from"./button-DVr7o_tG.js";import"./button-skeleton-D8YftpuT.js";import"./text-input-DrYX0fj-.js";import"./text-input-skeleton-sk_J7Wnv.js";import"./textarea-skeleton-DVvia02K.js";import{I as H}from"./icon-button-BjUtidcR.js";import{f as B,g as G}from"./16-PO2M8t47.js";import{_ as W}from"./16-CVWqvXKz.js";import{i as A}from"./icon-loader-Cf7p-8D_.js";import"./breadcrumb-skeleton-C6vf6Tz6.js";import{s as F,C as Y,i as X}from"./actionable-notification-button-BIWpFHKg.js";const j=".side-panel-stories__body-content{display:flex;flex-direction:column;padding:1rem;gap:1rem}.side-panel-stories__text-inputs{display:flex;gap:1rem}.side-panel-stories__text-inputs>*{flex-basis:50%}.side-panel-stories__story-container{position:fixed;display:grid;block-size:100vh;grid-template-rows:3rem 1fr;inline-size:100vw;inset-block-start:0;inset-inline-start:0}.side-panel-stories__story-header{background:var(--cds-background-inverse, #393939)}.side-panel-stories__story-content{position:relative;display:flex;align-items:center;justify-content:center}.side-panel-stories__custom-header-content{margin-block-end:.5rem}",f=L(j);let T=class extends Y{constructor(){super(...arguments),this.titleId="",this.kind=B.INFO}_renderIcon(){const{statusIconDescription:c,kind:l}=this,{[l]:h}=X;return h?h({class:`${a}--inline-notification__icon`,children:c?M`<title>${c}</title>`:void 0}):void 0}_renderText(){const{subtitle:c,title:l,titleId:h,_type:v}=this;return e`
    ...
    `}_renderButton(){return e``}connectedCallback(){super.connectedCallback(),this.removeAttribute("role")}updated(c){super.updated(c);const l=this.querySelector(this.constructor.selectorActionButton);l&&(l.setAttribute("kind","ghost"),this.titleId&&l.setAttribute("aria-describedby",this.titleId))}};T.styles=F;S([k({type:String,reflect:!0,attribute:"title-id"})],T.prototype,"titleId",void 0);S([k({reflect:!0})],T.prototype,"kind",void 0);T=S([z(`${a}-callout-notification`)],T);const i="side-panel-stories__",_=t=>{switch(t){case 1:return e`
      ...
      </cds-slug>`;default:return null}},q=t=>{switch(t){case 1:return e` <style>
          ${f}
        </style>
