import{e,r as d}from"./index-BOZkNhcz.js";import{a as S}from"./chunk-D5ZWXAHU-DlerbUHg.js";import{j as a,a as K,h as G,C as H}from"./index-CKePA1sA.js";import{useMDXComponents as O}from"./index-aaDvWpb8.js";import"./DocsRenderer-CFRXHY34-CAZB0tDV.js";import{s as J,S as l}from"./_storybook-styles-C6VZV7kb.js";import{A as Q}from"./index-RATG_uWP.js";import{c as Y,P as v}from"./index-Cd8snwnz.js";import{g as Z}from"./devtools-Bjt2CwRv.js";import{p as X,B as ee}from"./settings-DqneCnpo.js";import{R as te}from"./bucket-14-B-58TyUV.js";import"./_commonjsHelpers-BosuxZz1.js";import"./v4-CtRu48qb.js";import"./iframe-BLi-C7G1.js";import"./index-hBZdtWkn.js";import"./index-2uioG_CI.js";import"./index-CO8sV34W.js";import"./index-ogSvIofg.js";import"./react-18-Cs6RDBhU.js";import"./InlineLoading-82KDAKCf.js";import"./bucket-6-Bh7P8rIU.js";import"./bucket-2-BRYD7UVO.js";import"./bucket-9-0Zx3G2i3.js";import"./bucket-18-D95sPjw6.js";import"./events-OVwOsPzJ.js";import"./index-CN8ymWyE.js";const y=`${X.prefix}--status-indicator`,R="StatusIndicator",M={retryLabel:"Retry",showRetry:!1};let m=e.forwardRef(({children:t,className:i,onRetry:r,retryLabel:c=M.retryLabel,showRetry:s=M.showRetry,title:u,...n},o)=>e.createElement("div",{...n,className:Y(y,i),ref:o,...Z(R)},u&&e.createElement("h1",{className:`${y}__title`},u),e.createElement("ul",{className:`${y}__list`},t),s&&r&&c&&e.createElement(ee,{className:`${y}__button`,kind:"ghost",onClick:r,onKeyUp:r,renderIcon:()=>e.createElement(te,{size:16})},c)));m.deprecated={level:"warn",details:"This component is deprecated"};m=X.checkComponentEnabled(m,R);m.displayName=R;m.propTypes={children:v.node.isRequired,className:v.string,onRetry:v.func,retryLabel:v.string,showRetry:v.bool,title:v.node};m.__docgenInfo={description:`A list of icon/description pairs used to show multiple states of progress.
...
}`,...($=(B=T.parameters)==null?void 0:B.docs)==null?void 0:$.source}}};const _e=["statusIndicator","success","fail","successAsync","failAsync"];export{_e as __namedExportsOrder,Ce as default,g as fail,T as failAsync,p as statusIndicator,f as success,h as successAsync};
