import{z as f,x as t,B as c}from"./iframe-WhcWw8do.js";import"./about-modal-DCH2O1e8.js";import"./button-_YZ9mRAH.js";import"./button-skeleton-BmyT_GNI.js";import"./link-DOe75MWA.js";const b=".about-modal-stories__body-content{display:flex;flex-direction:column;padding:1rem;gap:1rem}.about-modal-stories__story-container{position:fixed;display:grid;block-size:100vh;grid-template-rows:3rem 1fr;inline-size:100vw;inset-block-start:0;inset-inline-start:0}.about-modal-stories__story-content{position:relative;display:flex;align-items:center;justify-content:center}",d=f(b),p="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20width='157px'%20height='157px'%20viewBox='0%200%20157%20157'%20version='1.1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3e%3c!--%20Generator:%20Sketch%2055.2%20(78181)%20-%20https://sketchapp.com%20--%3e%3ctitle%3eGroup%3c/title%3e%3cdesc%3eCreated%20with%20Sketch.%3c/desc%3e%3cdefs%3e%3clinearGradient%20x1='-9.94443222%25'%20y1='50%25'%20x2='106.211488%25'%20y2='50%25'%20id='linearGradient-1'%3e%3cstop%20stop-color='%23BE95FF'%20offset='0%25'%3e%3c/stop%3e%3cstop%20stop-color='%234589FF'%20offset='100%25'%3e%3c/stop%3e%3c/linearGradient%3e%3ccircle%20id='path-2'%20cx='86'%20cy='86'%20r='71'%3e%3c/circle%3e%3c/defs%3e%3cg%20id='Page-1'%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%3e%3cg%20id='Group'%3e%3cg%20id='Oval'%3e%3cuse%20fill='%23D8D8D8'%20xlink:href='%23path-2'%3e%3c/use%3e%3cuse%20fill='url(%23linearGradient-1)'%20xlink:href='%23path-2'%3e%3c/use%3e%3c/g%3e%3ccircle%20id='Oval'%20fill='%23FFFFFF'%20cx='39.5'%20cy='39.5'%20r='39.5'%3e%3c/circle%3e%3c/g%3e%3c/g%3e%3c/svg%3e",v=""+new URL("ansible-logo-BeWJOVvw.svg",import.meta.url).href,$=""+new URL("grafana-logo-DTeNT9pu.svg",import.meta.url).href,w=""+new URL("js-logo-BmNxJwIE.svg",import.meta.url).href,a=c+"--about-modal",m=e=>{switch(e){case 0:return t`IBM Product name`;case 1:return t`IBM Product name example that is longer than one line`;case 2:return t`IBM <span style="font-weight: 600">Product name</span>`;default:return null}},h=e=>e===1?t`
        <p class=${`${a}__footer-label`}>Powered by</p>
        <img
          src=${$}
          alt="Grafana"
          class=${`${a}__footer--tech-logo`}
        />
        <img
          src=${v}
          alt="Ansible"
        ...
        <img
          ...
          class=${`${a}__footer--tech-logo`}
        />
      `:null,u=e=>{switch(e){case 1:return t`This Web site contains proprietary notices and copyright
      ...
      <c4p-about-modal
        ...
        .title=${m(e.title)}
        .version=${e.version}
        .additionalInfo=${h(e.additionalInfo)}
        .content=${u(e.content)}
        .links=${y(e.links)}
        aria-label=${e.modalAriaLabel}
      ></c4p-about-modal>
    `},r={args:{closeIconDescription:"close",copyrightText:"Copyright © IBM Corp. 2020, 2023",title:2,version:"Version 0.0.0",additionalInfo:1,content:2,links:3,modalAriaLabel:""},argTypes:g,render:e=>t`
      <style>
        ${d}
      </style>
      <div class="${n}story-container">
      ...
      <c4p-about-modal
        ...
        aria-label=${e.modalAriaLabel}
      ></c4p-about-modal>
    `},x={title:"Components/AboutModal"};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...r.parameters?.docs?.source}}};const k=["Default","AboutModalWithAllPropsSet"],L=Object.freeze(Object.defineProperty({__proto__:null,AboutModalWithAllPropsSet:r,Default:i,__namedExportsOrder:k,default:x},Symbol.toStringTag,{value:"Module"}));export{L as A,i as D,r as a};
