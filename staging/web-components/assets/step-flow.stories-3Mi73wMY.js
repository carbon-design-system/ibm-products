import{z as x,r as $,E as l,x as a,n as k,A as w}from"./iframe-Be8Zv5F4.js";import{o as I}from"./index-DQuUfJx4.js";import{S as C}from"./step-group-CUzzOiDm.js";import{r as n}from"./state-yUR2oP26.js";import"./progress-step-TkFSsGcp.js";import"./stack-DtZPiy66.js";import"./code-snippet-skeleton-DC0MnCPD.js";import"./tearsheet-ULxXAdgs.js";import{r as F,t as P}from"./manageFocusTrap-yFljgwsZ.js";import"./button-rtq4s5rI.js";import"./button-skeleton-DIbveJlF.js";import"./grid-C43cfP2m.js";import"./side-panel-BgZr9gR8.js";import"./text-input-DJOAA_yF.js";import"./text-input-skeleton-EAebhCbN.js";import"./preload-helper-PPVm8Dsz.js";import"./collection-helpers-Cnsts1JG.js";import"./icon-loader-CkFMeExi.js";import"./class-map-CeOJ8zB9.js";import"./skeleton-text-CR65bYap.js";import"./16-Ci-Iy0jC.js";import"./16-D3CzXAJU.js";import"./icon-button-DgGbN1I-.js";import"./definition-tooltip-BaiLMn_A.js";import"./host-listener-DN1-XIwx.js";import"./popover-content-Ds-WnFXt.js";import"./floating-controller-O5_OP1Uj.js";import"./query-D0jTsbLw.js";import"./16-iEvmxbCa.js";import"./style-map-GwMfzukW.js";import"./16-D0aIqdwb.js";import"./query-assigned-elements-CblsR2sJ.js";import"./layer-DVX_2kQs.js";import"./modal-label-C98mCXAp.js";import"./inline-loading-DI4M25ll.js";import"./16-DSuDh1sQ.js";import"./20-CvqWH37X.js";import"./consume-DI2TaawZ.js";import"./16-803qFA73.js";import"./16-D5maUdCH.js";import"./resizer-panel-Dk_YWRVk.js";import"./tslib.es6-Cdhlq9ds.js";import"./action-set-JnO6Bpc5.js";import"./ref-BeHtf_Xa.js";import"./form-BTpacr1I.js";import"./validity-CzEiVmrf.js";import"./if-non-empty-D5Byj5A3.js";import"./16-C1hWzIbz.js";import"./16-B8NH1ntc.js";const z="#storybook-root #main-content{padding:0}",S=x(z);var O=Object.defineProperty,T=Object.getOwnPropertyDescriptor,h=(e,t,s,r)=>{for(var o=r>1?void 0:r?T(t,s):t,i=e.length-1,p;i>=0;i--)(p=e[i])&&(o=(r?p(t,s,o):p(o))||o);return r&&o&&O(t,s,o),o};let c=class extends I($){constructor(){super(...arguments),this.narrow=!1,this._open=!1,this._email="",this._city="",this._state="",this._trapFocusAPI=null,this._stepInfo=new C}_onButtonClick(){this._open=!0}_handleCancelButton(){this._open=!1,this._stepInfo.reset()}_handleBackButton(){const{currentStep:e}=this._stepInfo.data;if(e!==0)return this._stepInfo.handlePrevious()}_handleNextButton(){const{currentStep:e,totalSteps:t}=this._stepInfo.data;if(e+1===t){this._open=!1,this._stepInfo.reset();return}return this._stepInfo.handleNext()}_handleEmailInput(e){const t=structuredClone(this._stepInfo.data.formState);t.email=e.target.value,this._stepInfo.updateFormState=t}_handleCityInput(e){const t=structuredClone(this._stepInfo.data.formState);t.city=e.target.value,this._stepInfo.updateFormState=t}_handleStateInput(e){const t=structuredClone(this._stepInfo.data.formState);t.state=e.target.value,this._stepInfo.updateFormState=t}connectedCallback(){super.connectedCallback(),this._stepInfo.updateTotalStepCount=3}disconnectedCallback(){this._trapFocusAPI?.cleanup()}firstUpdated(e){F(this.shadowRoot?.querySelector("c4p-tearsheet"))}updated(e){e.has("_open")&&this._open&&(this._trapFocusAPI=P())}render(){const{formState:e,totalSteps:t,currentStep:s}=this._stepInfo.data;return a` <cds-button
        type="button"
        size="md"
...
`,g={args:{},render:B,name:"Tearsheet"},b={args:{narrow:!0},render:B,name:"Tearsheet narrow"},v={args:{},render:q,name:"Full page"},y={args:{},render:R,name:"SidePanel"},Ht={title:"Utilities/Step flows"};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {},
  ...
  name: 'SidePanel'
}`,...y.parameters?.docs?.source}}};const Jt=["Tearsheet","TearsheetNarrow","FullPage","SidePanel"];export{v as FullPage,y as SidePanel,g as Tearsheet,b as TearsheetNarrow,Jt as __namedExportsOrder,Ht as default};
