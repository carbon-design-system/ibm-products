import{z as k,r as b,B as a,E as S,x as d,n as f,c as y}from"./iframe-DHAVyDJv.js";import{u as w,c as I}from"./coachmark-beacon-C1rJPXIj.js";import"./button-gsziNLQW.js";import"./button-skeleton-CIMd3CJt.js";import{H as $}from"./host-listener-DN1-XIwx.js";import{_ as P}from"./16-D5maUdCH.js";import{_ as z}from"./16-BJ-s22c-.js";import{e as v}from"./index-txi5hca0.js";import{i as m}from"./icon-loader-HWfIkuxn.js";import{P as c}from"./popover-content-CqB4plNj.js";import{_ as H}from"./16-B_l_7QwJ.js";const B=":host(c4p-coachmark-header){display:flex;justify-content:flex-end}:host(c4p-coachmark-header) .c4p--coachmark-header-drag-handle{margin-inline-end:auto}:host(c4p-coachmark-header) .c4p--coachmark-header-drag-icon{fill:var(--cds-background, #ffffff)}:host(c4p-coachmark-header) .c4p--coachmark-header-close-icon{fill:var(--cds-background, #ffffff)}",E=k(B);var F=Object.defineProperty,j=Object.getOwnPropertyDescriptor,u=(o,e,n,r)=>{for(var t=r>1?void 0:r?j(e,n):e,s=o.length-1,i;s>=0;s--)(i=o[s])&&(t=(r?i(e,n,t):i(t))||t);return r&&t&&F(e,n,t),t};let p=class extends v($(b)){constructor(){super(...arguments),this.closeIconDescription="",this.dragIconDescription="",this._handleClick=o=>{o.stopPropagation();const e=this.closest(`${a}-coachmark`);e&&(e.dispatchEvent(new CustomEvent(`${a}-coachmark-request-close`,{bubbles:!0,composed:!0,cancelable:!0,detail:{source:"header-close-button"}})),e.open=!1),w({name:"open",detail:!1})}}render(){const{floating:o}=I.get();return d`
      ${o?d`
            <cds-button
              kind="ghost"
              size="sm"
    ...
    `},G={title:"Components/Onboarding/Coachmark"};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    ...args,
    open: true,
    highContrast: true,
